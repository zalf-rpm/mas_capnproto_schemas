...
$Python.module("mas.schema.climate");

using Go = import "/capnp/go.capnp";
$Go.package("climate");
$Go.import("github.com/zalf-rpm/mas_capnproto_schemas/gen/go/climate");

using Persistent = import "/persistence/persistence.capnp".Persistent;
using Restorer = import "/persistence/persistence.capnp".Restorer;
using Common = import "/common/common.capnp";
using Model = import "/model/model.capnp";

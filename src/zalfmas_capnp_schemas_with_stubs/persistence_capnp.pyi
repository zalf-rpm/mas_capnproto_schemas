...
class VatIdBuilder(VatId):
    ...
    @staticmethod
    def from_dict(dictionary: dict) -> VatIdBuilder: ...
...
class Address:
    ...
    class Ip6Builder(Address.Ip6):
        ...
        @staticmethod
        def from_dict(dictionary: dict) -> Address.Ip6Builder: ...
    ...
    def new_message(
        num_first_segment_words: int | None = None,
        allocate_seg_callable: Any = None,
        ip6: Address.Ip6Builder | None = None,
        port: int | None = None,
        host: str | None = None,
    ) -> AddressBuilder: ...
    @staticmethod
...
class AddressBuilder(Address):
    ...
    @ip6.setter
    def ip6(
        self, value: Address.Ip6 | Address.Ip6Builder | Address.Ip6Reader
    ) -> None: ...
    @property
    def port(self) -> int: ...
    @port.setter
...
class VatPath:
    ...
    def new_message(
        num_first_segment_words: int | None = None,
        allocate_seg_callable: Any = None,
        id: VatIdBuilder | None = None,
        address: AddressBuilder | None = None,
    ) -> VatPathBuilder: ...
    @staticmethod
    def read(
        file: BinaryIO,
...
class VatPathBuilder(VatPath):
    ...
    @id.setter
    def id(self, value: VatId | VatIdBuilder | VatIdReader) -> None: ...
    @property
    def address(self) -> AddressBuilder: ...
    @address.setter
    def address(self, value: Address | AddressBuilder | AddressReader) -> None: ...
    @staticmethod
    def from_dict(dictionary: dict) -> VatPathBuilder: ...
    @overload
...
class SturdyRef:
    ...
    class OwnerBuilder(SturdyRef.Owner):
        ...
        @staticmethod
        def from_dict(dictionary: dict) -> SturdyRef.OwnerBuilder: ...
    ...
    class TokenBuilder(SturdyRef.Token):
        ...
        @staticmethod
        def from_dict(dictionary: dict) -> SturdyRef.TokenBuilder: ...
    ...
    def new_message(
        num_first_segment_words: int | None = None,
        allocate_seg_callable: Any = None,
        vat: VatPathBuilder | None = None,
        localRef: SturdyRef.TokenBuilder | None = None,
    ) -> SturdyRefBuilder: ...
    @staticmethod
    def read(
        file: BinaryIO,
...
class SturdyRefBuilder(SturdyRef):
    ...
    @vat.setter
    def vat(self, value: VatPath | VatPathBuilder | VatPathReader) -> None: ...
    @property
    def localRef(self) -> SturdyRef.TokenBuilder: ...
    @localRef.setter
    def localRef(
        self, value: SturdyRef.Token | SturdyRef.TokenBuilder | SturdyRef.TokenReader
    ) -> None: ...
    @staticmethod
    def from_dict(dictionary: dict) -> SturdyRefBuilder: ...
    @overload
...
class Persistent(Protocol):
    class SaveParams:
        ...
        def new_message(
            num_first_segment_words: int | None = None,
            allocate_seg_callable: Any = None,
            sealFor: SturdyRef.OwnerBuilder | None = None,
    ...
    class SaveParamsBuilder(Persistent.SaveParams):
        ...
        def sealFor(
            self,
            value: SturdyRef.Owner | SturdyRef.OwnerBuilder | SturdyRef.OwnerReader,
        ) -> None: ...
        @staticmethod
    ...
    class SaveResults:
        ...
        def new_message(
            ...
            unsaveSR: SturdyRefBuilder | None = None,
    ...
    class SaveResultsBuilder(Persistent.SaveResults):
        ...
        @sturdyRef.setter
        def sturdyRef(
            self, value: SturdyRef | SturdyRefBuilder | SturdyRefReader
        ) -> None: ...
        @property
    ...
    def save(self, sealFor: SturdyRef.Owner | dict[str, Any]) -> SaveResult: ...
...
class Restorer(Protocol):
    class RestoreParams:
        ...
        def new_message(
            ...
            allocate_seg_callable: Any = None,
            localRef: SturdyRef.TokenBuilder | None = None,
            sealedBy: SturdyRef.OwnerBuilder | None = None,
    ...
    class RestoreParamsBuilder(Restorer.RestoreParams):
        ...
        def localRef(
            self,
            value: SturdyRef.Token | SturdyRef.TokenBuilder | SturdyRef.TokenReader,
        ) -> None: ...
        @property
        ...
        @staticmethod
        def from_dict(dictionary: dict) -> Restorer.RestoreParamsBuilder: ...
        @overload
        def init(self: Any, name: Literal["localRef"]) -> SturdyRef.TokenBuilder: ...
        @overload
...
class Gateway(Identifiable, Restorer, Protocol):
    ...
    class RegResultsBuilder(Gateway.RegResults):
        ...
        @staticmethod
        def from_dict(dictionary: dict) -> Gateway.RegResultsBuilder: ...
        def init(self: Any, name: Literal["sturdyRef"]) -> SturdyRefBuilder: ...
    ...
    def register(self, cap: Any) -> RegisterResult: ...
    class RegisterRequest(Protocol):
        cap: Any

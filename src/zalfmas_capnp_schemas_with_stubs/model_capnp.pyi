...
class XYResultBuilder(XYResult):
    ...
    @staticmethod
    def from_dict(dictionary: dict) -> XYResultBuilder: ...
    @overload
    def init(
...
class StatBuilder(Stat):
    ...
    @staticmethod
    def from_dict(dictionary: dict) -> StatBuilder: ...
    def init(
...
class XYPlusResult:
    ...
    def new_message(
        num_first_segment_words: int | None = None,
        allocate_seg_callable: Any = None,
        xy: XYResultBuilder | None = None,
        stats: Sequence[StatBuilder] | None = None,
    ) -> XYPlusResultBuilder: ...
    @staticmethod
    def read(
        file: BinaryIO,
...
class XYPlusResultBuilder(XYPlusResult):
    ...
    @xy.setter
    def xy(self, value: XYResult | XYResultBuilder | XYResultReader) -> None: ...
    @property
    def stats(self) -> Sequence[StatBuilder]: ...
    @stats.setter
    def stats(self, value: Sequence[Stat | StatBuilder | StatReader]) -> None: ...
    @staticmethod
    def from_dict(dictionary: dict) -> XYPlusResultBuilder: ...
    @overload
...
class Env(Generic[_RestInput]):
    ...
    def new_message(
        ...
        mgmtEvents: Sequence[EventBuilder] | None = None,
    ) -> EnvBuilder: ...
    @staticmethod
    def read(
        file: BinaryIO,
...
class EnvBuilder(Env, Generic[_RestInput]):
    ...
    @mgmtEvents.setter
    def mgmtEvents(
        self, value: Sequence[Event | EventBuilder | EventReader]
    ) -> None: ...
    @staticmethod
    def from_dict(dictionary: dict) -> EnvBuilder: ...
    def init(

...
class Grid(Identifiable, Persistent, Protocol):
    ...
    class ValueBuilder(Grid.Value):
        ...
        @staticmethod
        def from_dict(dictionary: dict) -> Grid.ValueBuilder: ...
    ...
    class ResolutionBuilder(Grid.Resolution):
        ...
        @staticmethod
        def from_dict(dictionary: dict) -> Grid.ResolutionBuilder: ...
    ...
    class RowColBuilder(Grid.RowCol):
        ...
        @staticmethod
        def from_dict(dictionary: dict) -> Grid.RowColBuilder: ...
    ...
    class AggregationPart:
        ...
        def new_message(
            num_first_segment_words: int | None = None,
            allocate_seg_callable: Any = None,
            value: Grid.ValueBuilder | None = None,
            rowCol: Grid.RowColBuilder | None = None,
    ...
    class AggregationPartBuilder(Grid.AggregationPart):
        ...
        @value.setter
        def value(
            self, value: Grid.Value | Grid.ValueBuilder | Grid.ValueReader
        ) -> None: ...
        @property
        def rowCol(self) -> Grid.RowColBuilder: ...
        @rowCol.setter
        def rowCol(
            self, value: Grid.RowCol | Grid.RowColBuilder | Grid.RowColReader
        ) -> None: ...
        @property
        def areaFrac(self) -> float: ...
        @areaFrac.setter
        ...
        @staticmethod
        def from_dict(dictionary: dict) -> Grid.AggregationPartBuilder: ...
        @overload
    ...
    class LocationBuilder(Grid.Location):
        ...
        @staticmethod
        def from_dict(dictionary: dict) -> Grid.LocationBuilder: ...
        @overload

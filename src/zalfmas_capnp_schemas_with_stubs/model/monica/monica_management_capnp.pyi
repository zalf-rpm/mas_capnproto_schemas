...
class ILRDates:
    ...
    def new_message(
        ...
        sowing: DateBuilder | None = None,
        earliestSowing: DateBuilder | None = None,
        latestSowing: DateBuilder | None = None,
        harvest: DateBuilder | None = None,
        latestHarvest: DateBuilder | None = None,
    ) -> ILRDatesBuilder: ...
    @staticmethod
    def read(
        file: BinaryIO,
...
class ILRDatesBuilder(ILRDates):
    ...
    @sowing.setter
    def sowing(self, value: Date | DateBuilder | DateReader) -> None: ...
    @property
    def earliestSowing(self) -> DateBuilder: ...
    @earliestSowing.setter
    def earliestSowing(self, value: Date | DateBuilder | DateReader) -> None: ...
    @property
    def latestSowing(self) -> DateBuilder: ...
    @latestSowing.setter
    def latestSowing(self, value: Date | DateBuilder | DateReader) -> None: ...
    @property
    def harvest(self) -> DateBuilder: ...
    @harvest.setter
    def harvest(self, value: Date | DateBuilder | DateReader) -> None: ...
    @property
    def latestHarvest(self) -> DateBuilder: ...
    @latestHarvest.setter
    def latestHarvest(self, value: Date | DateBuilder | DateReader) -> None: ...
    @staticmethod
    def from_dict(dictionary: dict) -> ILRDatesBuilder: ...
    @overload
...
class Event:
    ...
    class TypeBuilder(Event.Type):
        ...
        @staticmethod
        def from_dict(dictionary: dict) -> Event.TypeBuilder: ...
    ...
    class AtBuilder(Event.At):
        ...
        @staticmethod
        def from_dict(dictionary: dict) -> Event.AtBuilder: ...
    ...
    class Between:
        ...
        def new_message(
            num_first_segment_words: int | None = None,
            allocate_seg_callable: Any = None,
            earliest: DateBuilder | None = None,
            latest: DateBuilder | None = None,
    ...
    class BetweenBuilder(Event.Between):
        ...
        @earliest.setter
        def earliest(self, value: Date | DateBuilder | DateReader) -> None: ...
        @property
        def latest(self) -> DateBuilder: ...
        @latest.setter
        def latest(self, value: Date | DateBuilder | DateReader) -> None: ...
        @staticmethod
        def from_dict(dictionary: dict) -> Event.BetweenBuilder: ...
        @overload
    ...
    class After:
        ...
        def new_message(
            num_first_segment_words: int | None = None,
            allocate_seg_callable: Any = None,
            event: Event.TypeBuilder | None = None,
            days: int | None = None,
        ) -> Event.AfterBuilder: ...
        @staticmethod
        def read(
    ...
    class AfterBuilder(Event.After):
        ...
        @event.setter
        def event(
            self, value: Event.Type | Event.TypeBuilder | Event.TypeReader
        ) -> None: ...
        @property
        def days(self) -> int: ...
        @days.setter
        ...
        @staticmethod
        def from_dict(dictionary: dict) -> Event.AfterBuilder: ...
        def init(self: Any, name: Literal["event"]) -> Event.TypeBuilder: ...
    ...
    def new_message(
        ...
        | None = None,
        info: IdInformationBuilder | None = None,
        at: Event.AtBuilder | None = None,
        between: Event.BetweenBuilder | None = None,
        after: Event.AfterBuilder | None = None,
...
class EventBuilder(Event):
    ...
    @at.setter
    def at(self, value: Event.At | Event.AtBuilder | Event.AtReader) -> None: ...
    @property
    def between(self) -> Event.BetweenBuilder: ...
    @between.setter
    def between(
        self, value: Event.Between | Event.BetweenBuilder | Event.BetweenReader
    ) -> None: ...
    @property
    def after(self) -> Event.AfterBuilder: ...
    @after.setter
    def after(
        self, value: Event.After | Event.AfterBuilder | Event.AfterReader
    ) -> None: ...
    @property
    def params(self) -> Any: ...
    @params.setter
...
class Params:
    class DailyWeather:
        ...
        class KVBuilder(Params.DailyWeather.KV):
            ...
            @staticmethod
            def from_dict(dictionary: dict) -> Params.DailyWeather.KVBuilder: ...
        ...
        def new_message(
            num_first_segment_words: int | None = None,
            allocate_seg_callable: Any = None,
            data: Sequence[Params.DailyWeather.KVBuilder] | None = None,
    ...
    class DailyWeatherBuilder(Params.DailyWeather):
        ...
        @staticmethod
        def from_dict(dictionary: dict) -> Params.DailyWeatherBuilder: ...
        def init(
    ...
    class SowingBuilder(Params.Sowing):
        ...
        @staticmethod
        def from_dict(dictionary: dict) -> Params.SowingBuilder: ...
    ...
    class AutomaticSowing:
        ...
        def new_message(
            ...
            avgSoilTemp: Params.AutomaticSowing.AvgSoilTempBuilder | None = None,
            sowing: Params.SowingBuilder | None = None,
    ...
    class AutomaticSowingBuilder(Params.AutomaticSowing):
        ...
        @sowing.setter
        def sowing(
            self, value: Params.Sowing | Params.SowingBuilder | Params.SowingReader
        ) -> None: ...
        @staticmethod
        def from_dict(dictionary: dict) -> Params.AutomaticSowingBuilder: ...
        @overload
        def init(
    ...
    class Harvest:
        ...
        def new_message(
            ...
            optCarbMgmtData: Params.Harvest.OptCarbonMgmtDataBuilder | None = None,
    ...
    class HarvestBuilder(Params.Harvest):
        ...
        @staticmethod
        def from_dict(dictionary: dict) -> Params.HarvestBuilder: ...
        def init(
            self: Any, name: Literal["optCarbMgmtData"]
        ) -> Params.Harvest.OptCarbonMgmtDataBuilder: ...
    ...
    class AutomaticHarvest:
        ...
        def new_message(
            ...
            | Literal["emergence", "flowering", "anthesis", "maturity"]
            | None = None,
            harvest: Params.HarvestBuilder | None = None,
    ...
    class AutomaticHarvestBuilder(Params.AutomaticHarvest):
        ...
        @harvest.setter
        def harvest(
            self, value: Params.Harvest | Params.HarvestBuilder | Params.HarvestReader
        ) -> None: ...
        @staticmethod
        def from_dict(dictionary: dict) -> Params.AutomaticHarvestBuilder: ...
        def init(self: Any, name: Literal["harvest"]) -> Params.HarvestBuilder: ...
    ...
    class Cutting:
        ...
        class SpecBuilder(Params.Cutting.Spec):
            ...
            @staticmethod
            def from_dict(dictionary: dict) -> Params.Cutting.SpecBuilder: ...
        ...
        def new_message(
            num_first_segment_words: int | None = None,
            allocate_seg_callable: Any = None,
            cuttingSpec: Sequence[Params.Cutting.SpecBuilder] | None = None,
    ...
    class CuttingBuilder(Params.Cutting):
        ...
        @staticmethod
        def from_dict(dictionary: dict) -> Params.CuttingBuilder: ...
        def init(
            self: Any, name: Literal["cuttingSpec"], size: int = ...
    ...
    class MineralFertilization:
        ...
        def new_message(
            num_first_segment_words: int | None = None,
            allocate_seg_callable: Any = None,
            partition: Params.MineralFertilization.ParametersBuilder | None = None,
    ...
    class MineralFertilizationBuilder(Params.MineralFertilization):
        ...
        @staticmethod
        def from_dict(dictionary: dict) -> Params.MineralFertilizationBuilder: ...
        def init(
            self: Any, name: Literal["partition"]
        ) -> Params.MineralFertilization.ParametersBuilder: ...
    ...
    class NDemandFertilizationBuilder(Params.NDemandFertilization):
        ...
        @staticmethod
        def from_dict(dictionary: dict) -> Params.NDemandFertilizationBuilder: ...
        def init(
            self: Any, name: Literal["partition"]
        ) -> Params.MineralFertilization.ParametersBuilder: ...
    ...
    class OrganicFertilization:
        ...
        def new_message(
            num_first_segment_words: int | None = None,
            allocate_seg_callable: Any = None,
            params: Params.OrganicFertilization.ParametersBuilder | None = None,
            amount: float | None = None,
    ...
    class OrganicFertilizationBuilder(Params.OrganicFertilization):
        ...
        @staticmethod
        def from_dict(dictionary: dict) -> Params.OrganicFertilizationBuilder: ...
        def init(
            self: Any, name: Literal["params"]
        ) -> Params.OrganicFertilization.ParametersBuilder: ...
    ...
    class TillageBuilder(Params.Tillage):
        ...
        def depth(self, value: float) -> None: ...
        @staticmethod
        def from_dict(dictionary: dict) -> Params.TillageBuilder: ...
    ...
    class Irrigation:
        ...
        class ParametersBuilder(Params.Irrigation.Parameters):
            ...
            @staticmethod
            def from_dict(dictionary: dict) -> Params.Irrigation.ParametersBuilder: ...
    ...
    class IrrigationBuilder(Params.Irrigation):
        ...
        @staticmethod
        def from_dict(dictionary: dict) -> Params.IrrigationBuilder: ...
        def init(
            self: Any, name: Literal["params"]
        ) -> Params.Irrigation.ParametersBuilder: ...
    ...
    class SaveStateBuilder(Params.SaveState):
        ...
        @staticmethod
        def from_dict(dictionary: dict) -> Params.SaveStateBuilder: ...
...
class ParamsBuilder(Params):
    @staticmethod
    def from_dict(dictionary: dict) -> ParamsBuilder: ...
...
class Service(Identifiable, Protocol):
    ...
    class Server(Identifiable.Server):
        def managementAt(
            self, lat: float, lon: float, **kwargs

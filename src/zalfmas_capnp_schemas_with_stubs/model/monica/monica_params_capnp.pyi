...
class CultivarParametersBuilder(CultivarParameters):
    ...
    @property
    def organIdsForPrimaryYield(self) -> _DynamicListBuilder[YieldComponentBuilder]: ...
    ...
    @property
    def organIdsForCutting(self) -> _DynamicListBuilder[YieldComponentBuilder]: ...
...
class SiteParametersBuilder(SiteParameters):
    ...
    @property
    def soilParameters(self) -> _DynamicListBuilder[SoilParametersBuilder]: ...

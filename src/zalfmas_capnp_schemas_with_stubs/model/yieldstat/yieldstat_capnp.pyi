...
class RestInputBuilder(RestInput):
    ...
    @staticmethod
    def from_dict(dictionary: dict) -> RestInputBuilder: ...
...
class Result:
    ...
    class ResultToValueBuilder(Result.ResultToValue):
        ...
        @staticmethod
        def from_dict(dictionary: dict) -> Result.ResultToValueBuilder: ...
    ...
    def new_message(
        ...
        values: Sequence[Result.ResultToValueBuilder] | None = None,
    ) -> ResultBuilder: ...
    @staticmethod
    def read(
        file: BinaryIO,
...
class ResultBuilder(Result):
    ...
    def init(
        self: Any, name: Literal["values"], size: int = ...
...
class Output:
    ...
    class YearToResultBuilder(Output.YearToResult):
        ...
        @result.setter
        def result(self, value: Result | ResultBuilder | ResultReader) -> None: ...
        @staticmethod
        def from_dict(dictionary: dict) -> Output.YearToResultBuilder: ...
        def init(self: Any, name: Literal["result"]) -> ResultBuilder: ...
    ...
    def new_message(
        ...
        results: Sequence[Output.YearToResultBuilder] | None = None,
    ) -> OutputBuilder: ...
    @staticmethod
    def read(
        file: BinaryIO,
...
class OutputBuilder(Output):
    ...
    @staticmethod
    def from_dict(dictionary: dict) -> OutputBuilder: ...
    def init(
        self: Any, name: Literal["results"], size: int = ...

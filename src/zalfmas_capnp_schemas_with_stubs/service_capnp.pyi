...
class Admin(Identifiable, Protocol):
    ...
    class Server(Identifiable.Server):
        def heartbeat(self, **kwargs) -> Awaitable[None]: ...
        def setTimeout(self, seconds: int, **kwargs) -> Awaitable[None]: ...
        def stop(self, **kwargs) -> Awaitable[None]: ...
        def identities(self, **kwargs) -> Awaitable[Any]: ...
        def updateIdentity(
            self, oldId: str, newInfo: Any, **kwargs
        ) -> Awaitable[None]: ...
...
class Factory(Identifiable, Protocol):
    ...
    class CreateParamsBuilder(Factory.CreateParams, Generic[Factory_Payload]):
        ...
        @property
        def interfaceNameToRegistrySR(self) -> _DynamicListBuilder[PairBuilder]: ...

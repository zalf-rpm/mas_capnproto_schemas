...
class WeatherStationBuilder(WeatherStation):
    ...
    @staticmethod
    def from_dict(dictionary: dict) -> WeatherStationBuilder: ...
...
class SoilMetadataBuilder(SoilMetadata):
    ...
    @staticmethod
    def from_dict(dictionary: dict) -> SoilMetadataBuilder: ...
...
class FieldBuilder(Field):
    ...
    def notes(self, value: str) -> None: ...
    @staticmethod
    def from_dict(dictionary: dict) -> FieldBuilder: ...
...
class CultivarBuilder(Cultivar):
    ...
    def notes(self, value: str) -> None: ...
    @staticmethod
    def from_dict(dictionary: dict) -> CultivarBuilder: ...
...
class Plot:
    ...
    def new_message(
        ...
        allocate_seg_callable: Any = None,
        id: str | None = None,
        cultivar: CultivarBuilder | None = None,
        soil: SoilMetadataBuilder | None = None,
...
class PlotBuilder(Plot):
    ...
    @cultivar.setter
    def cultivar(self, value: Cultivar | CultivarBuilder | CultivarReader) -> None: ...
    @property
    def soil(self) -> SoilMetadataBuilder: ...
    @soil.setter
    def soil(
        self, value: SoilMetadata | SoilMetadataBuilder | SoilMetadataReader
    ) -> None: ...
    @property
    def blockNumber(self) -> int: ...
    @blockNumber.setter
    ...
    @staticmethod
    def from_dict(dictionary: dict) -> PlotBuilder: ...
    @overload
...
class Residue:
    ...
    def new_message(
        num_first_segment_words: int | None = None,
        allocate_seg_callable: Any = None,
        initialMeasureDate: DateBuilder | None = None,
...
class ResidueBuilder(Residue):
    ...
    def initialMeasureDate(self, value: Date | DateBuilder | DateReader) -> None: ...
    @property
    def incorporationDepth(self) -> int: ...
    ...
    def treatmentId(self, value: str) -> None: ...
    @staticmethod
    def from_dict(dictionary: dict) -> ResidueBuilder: ...
    def init(self: Any, name: Literal["initialMeasureDate"]) -> DateBuilder: ...
...
class InitialConditionsLayerBuilder(InitialConditionsLayer):
    ...
    def treatmentId(self, value: str) -> None: ...
    @staticmethod
    def from_dict(dictionary: dict) -> InitialConditionsLayerBuilder: ...
...
class PlantingEvent:
    ...
    def new_message(
        ...
        plantingDate: DateBuilder | None = None,
        plantPopulationAtPlantingInNoPerM2: int | None = None,
        averageEmergenceDate: DateBuilder | None = None,
...
class PlantingEventBuilder(PlantingEvent):
    ...
    @plantingDate.setter
    def plantingDate(self, value: Date | DateBuilder | DateReader) -> None: ...
    @property
    def plantPopulationAtPlantingInNoPerM2(self) -> int: ...
    ...
    def averageEmergenceDate(self, value: Date | DateBuilder | DateReader) -> None: ...
    @property
    def averagePlantPopulationAtEmergenceInNoPerM2(self) -> int: ...
    ...
    def treatmentId(self, value: str) -> None: ...
    @staticmethod
    def from_dict(dictionary: dict) -> PlantingEventBuilder: ...
    @overload
...
class HarvestEventBuilder(HarvestEvent):
    ...
    def treatmentId(self, value: str) -> None: ...
    @staticmethod
    def from_dict(dictionary: dict) -> HarvestEventBuilder: ...
    def init(self: Any, name: Literal["date"]) -> DateBuilder: ...
...
class IrrigationEventBuilder(IrrigationEvent):
    ...
    def treatmentId(self, value: str) -> None: ...
    @staticmethod
    def from_dict(dictionary: dict) -> IrrigationEventBuilder: ...
    def init(self: Any, name: Literal["date"]) -> DateBuilder: ...
...
class FertilizerEventBuilder(FertilizerEvent):
    ...
    def treatmentId(self, value: str) -> None: ...
    @staticmethod
    def from_dict(dictionary: dict) -> FertilizerEventBuilder: ...
    def init(self: Any, name: Literal["date"]) -> DateBuilder: ...
...
class EnvironmentModificationBuilder(EnvironmentModification):
    ...
    def treatmentId(self, value: str) -> None: ...
    @staticmethod
    def from_dict(dictionary: dict) -> EnvironmentModificationBuilder: ...
    def init(self: Any, name: Literal["date"]) -> DateBuilder: ...
...
class Treatment:
    ...
    def new_message(
        ...
        allocate_seg_callable: Any = None,
        id: str | None = None,
        field: FieldBuilder | None = None,
        weatherStation: WeatherStationBuilder | None = None,
        weatherStationTimeseries: TimeSeries | TimeSeries.Server | None = None,
        name: str | None = None,
        simulationStartDate: DateBuilder | None = None,
        simulationEndDate: DateBuilder | None = None,
        ...
        notes: str | None = None,
        plots: Sequence[PlotBuilder] | None = None,
        residue: ResidueBuilder | None = None,
        initialConditionsLayers: Sequence[InitialConditionsLayerBuilder] | None = None,
        plantingEvents: Sequence[PlantingEventBuilder] | None = None,
        harvestEvents: Sequence[HarvestEventBuilder] | None = None,
        irrigationEvents: Sequence[IrrigationEventBuilder] | None = None,
        fertilizerEvents: Sequence[FertilizerEventBuilder] | None = None,
...
class TreatmentBuilder(Treatment):
    ...
    @field.setter
    def field(self, value: Field | FieldBuilder | FieldReader) -> None: ...
    @property
    def weatherStation(self) -> WeatherStationBuilder: ...
    @weatherStation.setter
    def weatherStation(
        self, value: WeatherStation | WeatherStationBuilder | WeatherStationReader
    ) -> None: ...
    @property
    def weatherStationTimeseries(self) -> TimeSeries: ...
    ...
    def simulationStartDate(self, value: Date | DateBuilder | DateReader) -> None: ...
    @property
    def simulationEndDate(self) -> DateBuilder: ...
    @simulationEndDate.setter
    def simulationEndDate(self, value: Date | DateBuilder | DateReader) -> None: ...
    @property
    def irrigationApplied(self) -> bool: ...
    ...
    @plots.setter
    def plots(self, value: Sequence[Plot | PlotBuilder | PlotReader]) -> None: ...
    @property
    def residue(self) -> ResidueBuilder: ...
    @residue.setter
    def residue(self, value: Residue | ResidueBuilder | ResidueReader) -> None: ...
    @property
    ...
    def harvestEvents(
        self, value: Sequence[HarvestEvent | HarvestEventBuilder | HarvestEventReader]
    ) -> None: ...
    @property
    ...
    @staticmethod
    def from_dict(dictionary: dict) -> TreatmentBuilder: ...
    @overload
...
class ExperimentDescription:
    ...
    def new_message(
        ...
        notes: str | None = None,
        treatments: Sequence[TreatmentBuilder] | None = None,
...
class ExperimentDescriptionBuilder(ExperimentDescription):
    ...
    @treatments.setter
    def treatments(
        self, value: Sequence[Treatment | TreatmentBuilder | TreatmentReader]
    ) -> None: ...
    @staticmethod
    def from_dict(dictionary: dict) -> ExperimentDescriptionBuilder: ...
    def init(
        self: Any, name: Literal["treatments"], size: int = ...

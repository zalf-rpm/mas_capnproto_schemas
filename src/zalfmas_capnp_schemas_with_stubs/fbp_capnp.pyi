...
class IP:
    ...
    class KVBuilder(IP.KV):
        ...
        @staticmethod
        def from_dict(dictionary: dict) -> IP.KVBuilder: ...
    ...
    def new_message(
        num_first_segment_words: int | None = None,
        allocate_seg_callable: Any = None,
        attributes: Sequence[IP.KVBuilder] | None = None,
...
class IPBuilder(IP):
    ...
    @attributes.setter
    def attributes(
        self, value: Sequence[IP.KV | IP.KVBuilder | IP.KVReader]
    ) -> None: ...
    @property
    def content(self) -> Any: ...
    @content.setter
    ...
    @staticmethod
    def from_dict(dictionary: dict) -> IPBuilder: ...
    def init(
...
class IIPBuilder(IIP):
    ...
    def content(self, value: Any) -> None: ...
    @staticmethod
    def from_dict(dictionary: dict) -> IIPBuilder: ...
...
class Channel(Identifiable, Persistent, Protocol):
    ...
    class MsgBuilder(Channel.Msg, Generic[Channel_V]):
        ...
        @staticmethod
        def from_dict(dictionary: dict) -> Channel.MsgBuilder: ...
    ...
    class Writer(Identifiable, Persistent, Protocol):
        def write(self, value: Any, done: None, noMsg: None) -> None: ...
        ...
        class Server(Identifiable.Server, Persistent.Server):
            def write(self, value: Any, done: None, noMsg: None, **kwargs) -> None: ...
            def close(self, **kwargs) -> None: ...
            def writeIfSpace(
    ...
    class StartupInfoBuilder(Channel.StartupInfo):
        ...
        @staticmethod
        def from_dict(dictionary: dict) -> Channel.StartupInfoBuilder: ...
        @overload
        def init(
    ...
    def close(self, waitForEmptyBuffer: bool) -> None: ...
    class CloseRequest(Protocol):
    ...
    def close_request(self) -> CloseRequest: ...
    class Server(Identifiable.Server, Persistent.Server):
        def setBufferSize(self, size: int, **kwargs) -> None: ...
        def reader(
            self, **kwargs
        ...
        def close(self, waitForEmptyBuffer: bool, **kwargs) -> None: ...
...
class StartChannelsService(Identifiable, Protocol):
    ...
    class ParamsBuilder(StartChannelsService.Params):
        ...
        def bufferSize(self, value: int) -> None: ...
        @staticmethod
        def from_dict(dictionary: dict) -> StartChannelsService.ParamsBuilder: ...
        @overload
        def init(
...
class PortInfos:
    ...
    class NameAndSRBuilder(PortInfos.NameAndSR):
        ...
        @staticmethod
        def from_dict(dictionary: dict) -> PortInfos.NameAndSRBuilder: ...
        def init(
    ...
    def new_message(
        num_first_segment_words: int | None = None,
        allocate_seg_callable: Any = None,
        inPorts: Sequence[PortInfos.NameAndSRBuilder] | None = None,
        outPorts: Sequence[PortInfos.NameAndSRBuilder] | None = None,
    ) -> PortInfosBuilder: ...
    @staticmethod
    def read(
        file: BinaryIO,
...
class PortInfosBuilder(PortInfos):
    ...
    @staticmethod
    def from_dict(dictionary: dict) -> PortInfosBuilder: ...
    @overload
    def init(
...
class Component:
    ...
    class PortBuilder(Component.Port):
        ...
        @staticmethod
        def from_dict(dictionary: dict) -> Component.PortBuilder: ...
    ...
    def new_message(
        ...
        | None = None,
        inPorts: Sequence[Component.PortBuilder] | None = None,
        outPorts: Sequence[Component.PortBuilder] | None = None,
...
class ComponentBuilder(Component):
    ...
    @staticmethod
    def from_dict(dictionary: dict) -> ComponentBuilder: ...
    @overload

...
class Layer:
    ...
    class PropertyBuilder(Layer.Property):
        ...
        @staticmethod
        def from_dict(dictionary: dict) -> Layer.PropertyBuilder: ...
    ...
    def new_message(
        num_first_segment_words: int | None = None,
        allocate_seg_callable: Any = None,
        properties: Sequence[Layer.PropertyBuilder] | None = None,
...
class LayerBuilder(Layer):
    ...
    @staticmethod
    def from_dict(dictionary: dict) -> LayerBuilder: ...
    def init(
...
class Query:
    ...
    class ResultBuilder(Query.Result):
        ...
        @staticmethod
        def from_dict(dictionary: dict) -> Query.ResultBuilder: ...
        @overload
        def init(
...
class QueryBuilder(Query):
    ...
    @staticmethod
    def from_dict(dictionary: dict) -> QueryBuilder: ...
    @overload
    def init(
        self: Any, name: Literal["mandatory"], size: int = ...
    ) -> _DynamicListBuilder[PropertyName]: ...
...
class ProfileData:
    ...
    def new_message(
        num_first_segment_words: int | None = None,
        allocate_seg_callable: Any = None,
        layers: Sequence[LayerBuilder] | None = None,
...
class ProfileDataBuilder(ProfileData):
    ...
    @layers.setter
    def layers(self, value: Sequence[Layer | LayerBuilder | LayerReader]) -> None: ...
    @property
    def percentageOfArea(self) -> float: ...
    @percentageOfArea.setter
    def percentageOfArea(self, value: float) -> None: ...
    @staticmethod
    def from_dict(dictionary: dict) -> ProfileDataBuilder: ...
    def init(

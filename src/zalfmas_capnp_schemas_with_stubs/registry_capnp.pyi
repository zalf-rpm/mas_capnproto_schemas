...
class Registry(Identifiable, Protocol):
    ...
    class EntryBuilder(Registry.Entry):
        ...
        @staticmethod
        def from_dict(dictionary: dict) -> Registry.EntryBuilder: ...
...
class Registrar(Identifiable, Protocol):
    ...
    class CrossDomainRestoreBuilder(Registrar.CrossDomainRestore):
        ...
        @vatId.setter
        def vatId(self, value: VatId | VatIdBuilder | VatIdReader) -> None: ...
        @property
        def restorer(self) -> Restorer: ...
        @restorer.setter
        def restorer(self, value: Restorer | Restorer.Server) -> None: ...
        @staticmethod
        def from_dict(dictionary: dict) -> Registrar.CrossDomainRestoreBuilder: ...
    ...
    class RegParams:
        ...
        def new_message(
            ...
            categoryId: str | None = None,
            xDomain: Registrar.CrossDomainRestoreBuilder | None = None,
    ...
    class RegParamsBuilder(Registrar.RegParams):
        ...
        @staticmethod
        def from_dict(dictionary: dict) -> Registrar.RegParamsBuilder: ...
        def init(

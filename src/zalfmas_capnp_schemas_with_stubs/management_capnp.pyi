...
class Fertilizer(Identifiable, Persistent, Protocol):
    ...
    class Server(Identifiable.Server, Persistent.Server):
        def nutrients(self, **kwargs) -> Awaitable[Sequence[Nutrient]]: ...
...
class NutrientBuilder(Nutrient):
    ...
    @staticmethod
    def from_dict(dictionary: dict) -> NutrientBuilder: ...
...
class Params:
    ...
    class Irrigation:
        ...
        def new_message(
            ...
            allocate_seg_callable: Any = None,
            amount: float | None = None,
            nutrientConcentrations: Sequence[NutrientBuilder] | None = None,
    ...
    class IrrigationBuilder(Params.Irrigation):
        ...
        def nutrientConcentrations(
            self, value: Sequence[Nutrient | NutrientBuilder | NutrientReader]
        ) -> None: ...
        @staticmethod
        def from_dict(dictionary: dict) -> Params.IrrigationBuilder: ...
        def init(
            self: Any, name: Literal["nutrientConcentrations"], size: int = ...

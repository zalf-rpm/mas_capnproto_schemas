...
class Persistent(Protocol):
    ...
    class SaveParamsBuilder(Persistent.SaveParams, Generic[Persistent_Owner]):
        ...
        @staticmethod
        def from_dict(dictionary: dict) -> Persistent.SaveParamsBuilder: ...
    ...
    class SaveResultsBuilder(Persistent.SaveResults, Generic[Persistent_SturdyRef]):
        ...
        @staticmethod
        def from_dict(dictionary: dict) -> Persistent.SaveResultsBuilder: ...
    ...
    def save(self, sealFor: Any) -> SaveResult: ...
    ...
    class Server:
        def save(self, sealFor: Any, **kwargs) -> Awaitable[Persistent.SaveResults]: ...

...
class Store(Identifiable, Persistent, Protocol):
    class Container(Identifiable, Persistent, Protocol):
        ...
        class KeyAndEntryBuilder(Store.Container.KeyAndEntry):
            ...
            @staticmethod
            def from_dict(dictionary: dict) -> Store.Container.KeyAndEntryBuilder: ...
    ...
    class InfoAndContainerBuilder(Store.InfoAndContainer):
        ...
        @staticmethod
        def from_dict(dictionary: dict) -> Store.InfoAndContainerBuilder: ...
    ...
    class ImportExportData:
        ...
        def new_message(
            ...
            entries: Sequence[PairBuilder] | None = None,
    ...
    class ImportExportDataBuilder(Store.ImportExportData):
        ...
        @entries.setter
        def entries(self, value: Sequence[Pair | PairBuilder | PairReader]) -> None: ...
        @property
        def isAnyValue(self) -> Sequence[bool]: ...
        @isAnyValue.setter
        def isAnyValue(self, value: Sequence[bool]) -> None: ...
        @staticmethod
        def from_dict(dictionary: dict) -> Store.ImportExportDataBuilder: ...
        @overload

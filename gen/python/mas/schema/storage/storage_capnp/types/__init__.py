"""Runtime placeholder package for typing helpers of `storage.capnp`."""
...
if TYPE_CHECKING:
    ...
    from mas.schema.storage.storage_capnp.types import enums as enums
    ...
    from mas.schema.storage.storage_capnp.types import results as results

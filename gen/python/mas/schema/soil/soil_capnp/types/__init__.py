"""Runtime placeholder package for typing helpers of `soil.capnp`."""
...
if TYPE_CHECKING:
    ...
    from mas.schema.soil.soil_capnp.types import common as common
    ...
    from mas.schema.soil.soil_capnp.types import results as results

"""Runtime placeholder package for typing helpers of `monica_management.capnp`."""
...
if TYPE_CHECKING:
    ...
    from mas.schema.model.monica.monica_management_capnp.types import results as results
    from mas.schema.model.monica.monica_management_capnp.types import schemas as schemas
    from mas.schema.model.monica.monica_management_capnp.types import servers as servers

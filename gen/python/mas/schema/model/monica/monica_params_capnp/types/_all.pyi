...
class CultivarParametersBuilder(_DynamicStructBuilder):
    ...
    def organIdsForPrimaryYield(
        self,
        value: YieldComponentListBuilder | YieldComponentListReader | dict[str, Any],
    ) -> None: ...
    @property
...
class AutomaticHarvestParametersBuilder(_DynamicStructBuilder):
    ...
    def harvestTime(self) -> AutomaticHarvestParametersHarvestTimeEnum: ...
    @harvestTime.setter
    def harvestTime(self, value: AutomaticHarvestParametersHarvestTimeEnum) -> None: ...
    @property
    def latestHarvestDOY(self) -> int: ...
    @latestHarvestDOY.setter
    def latestHarvestDOY(self, value: int) -> None: ...
...
class SiteParametersBuilder(_DynamicStructBuilder):
    ...
    def soilParameters(
        self,
        value: SoilParametersListBuilder | SoilParametersListReader | dict[str, Any],
    ) -> None: ...
    @override
    def init(
        self,
...
class EnvironmentParametersBuilder(_DynamicStructBuilder):
    ...
    def atmosphericCO2s(
        self,
        value: YearToValueListBuilder | YearToValueListReader | dict[str, Any],
    ) -> None: ...
    @property
    def atmosphericO3(self) -> float: ...
...
class MeasuredGroundwaterTableInformationBuilder(_DynamicStructBuilder):
    ...
    def groundwaterInfo(
        self,
        value: DateToValueListBuilder | DateToValueListReader | dict[str, Any],
    ) -> None: ...
    @override
    def init(
        self,
...
class SoilOrganicModuleParametersBuilder(_DynamicStructBuilder):
    ...
    def sticsParams(
        self,
        value: SticsParametersBuilder | SticsParametersReader | dict[str, Any],
    ) -> None: ...
    @override
    def init(
        self,
...
class LeafEmissionTBuilder(_DynamicStructBuilder):
    ...
    def pho(
        self,
        value: PhotosynthTBuilder | PhotosynthTReader | dict[str, Any],
    ) -> None: ...
    @property

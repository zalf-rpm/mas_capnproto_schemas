"""Runtime placeholder package for typing helpers of `grid.capnp`."""
...
if TYPE_CHECKING:
    ...
    from mas.schema.grid.grid_capnp.types import common as common
    ...
    from mas.schema.grid.grid_capnp.types import results as results

"""Runtime placeholder package for typing helpers of `service.capnp`."""
...
if TYPE_CHECKING:
    ...
    from mas.schema.service.service_capnp.types import enums as enums
    ...
    from mas.schema.service.service_capnp.types import results as results
    from mas.schema.service.service_capnp.types import schemas as schemas
    from mas.schema.service.service_capnp.types import servers as servers

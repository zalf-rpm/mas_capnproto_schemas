...
class MimeTypesBuilder(_DynamicStructBuilder):
    @override
    def as_reader(self) -> readers.MimeTypesReader: ...

class BlobBuilder(_DynamicStructBuilder):
    @property
    ...
    @override
    def as_reader(self) -> readers.BlobReader: ...

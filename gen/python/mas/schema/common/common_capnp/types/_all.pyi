...
class _IdentifiableInterfaceModule(_InterfaceModule):
    @override
    def _new_client(self, server: _DynamicCapabilityServer) -> IdentifiableClient: ...
    class Server(_DynamicCapabilityServer):
        def info(
            self,
            _context: InfoCallContext,
            **kwargs: object,
        ) -> Awaitable[InfoResultTuple | None]: ...
        def info_context(self, context: InfoCallContext) -> Awaitable[None]: ...

class InfoRequest(Protocol):
    def send(self) -> InfoResult: ...
...
class ValueBuilder(_DynamicStructBuilder):
    ...
    @li8.setter
    def li8(self, value: Int8ListBuilder | Int8ListReader | dict[str, Any]) -> None: ...
    @property
    ...
    @lb.setter
    def lb(self, value: BoolListBuilder | BoolListReader | dict[str, Any]) -> None: ...
    @property
    def lt(self) -> TextListBuilder: ...
    @lt.setter
    def lt(self, value: TextListBuilder | TextListReader | dict[str, Any]) -> None: ...
    @property
    def ld(self) -> DataListBuilder: ...
    @ld.setter
    def ld(self, value: DataListBuilder | DataListReader | dict[str, Any]) -> None: ...
    @property
...
class _FactoryInterfaceModule(_IdentifiableInterfaceModule):
    ...
    class Server(_IdentifiableInterfaceModule.Server):
        def create(
            ...
            **kwargs: object,
        ) -> Awaitable[AnyPointer | CreateResultTuple | None]: ...
...
class _IOFactoryInterfaceModule(_IdentifiableInterfaceModule):
    @override
    def _new_client(self, server: _DynamicCapabilityServer) -> IOFactoryClient: ...
    class Server(_IdentifiableInterfaceModule.Server):
        def produce(
            self,
            in_: AnyPointer,
            _context: ProduceCallContext,
            **kwargs: object,
        ) -> Awaitable[AnyPointer | ProduceResultTuple | None]: ...
        def produce_context(self, context: ProduceCallContext) -> Awaitable[None]: ...

class ProduceRequest(Protocol):
    in_: AnyPointer
    def send(self) -> ProduceResult: ...
...
class ProduceCallContext(Protocol):
    ...
    @property
    def results(self) -> ProduceServerResult: ...

class ProduceResultTuple(NamedTuple):
    out: AnyPointer

class IOFactoryClient(IdentifiableClient):
    def produce(self, in_: AnyPointer | None = None) -> ProduceResult: ...
    def produce_request(self, in_: AnyPointer | None = None) -> ProduceRequest: ...

IOFactory: _IOFactoryInterfaceModule

class _HolderInterfaceModule(_InterfaceModule):
    @override
    def _new_client(self, server: _DynamicCapabilityServer) -> HolderClient: ...
    class Server(_DynamicCapabilityServer):
        def value(
            self,
...
HolderServer = _HolderInterfaceModule.Server
IOFactoryServer = _IOFactoryInterfaceModule.Server
IdentifiableHolderServer = _IdentifiableHolderInterfaceModule.Server
IdentifiableServer = _IdentifiableInterfaceModule.Server

"""Runtime placeholder package for typing helpers of `registry.capnp`."""
...
if TYPE_CHECKING:
    ...
    from mas.schema.registry.registry_capnp.types import common as common
    from mas.schema.registry.registry_capnp.types import contexts as contexts
    from mas.schema.registry.registry_capnp.types import enums as enums
    ...
    from mas.schema.registry.registry_capnp.types import results as results

...
class ErrorInfoBuilder(_DynamicStructBuilder):
    @property
    def hasError(self) -> bool: ...
    @hasError.setter
    def hasError(self, value: bool) -> None: ...
    @property
    ...
    @property
    def phase(self) -> enums.ProcessErrorInfoPhaseEnum: ...
    @phase.setter
    def phase(self, value: enums.ProcessErrorInfoPhaseEnum) -> None: ...
    @property
    def port(self) -> str: ...
    @port.setter
    def port(self, value: str) -> None: ...
    ...
    @errorType.setter
    def errorType(self, value: str) -> None: ...
    @property
    ...
    @override
    def as_reader(self) -> readers.ErrorInfoReader: ...

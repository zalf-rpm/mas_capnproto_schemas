...
class EventBuilder(_DynamicStructBuilder):
    ...
    @sizeInWords.setter
    def sizeInWords(self, value: int) -> None: ...
    @property
    def content(self) -> _DynamicObjectBuilder: ...
    @content.setter
    def content(self, value: common.AnyPointer) -> None: ...
...
class ChannelObserverParamsBuilder(_DynamicStructBuilder):
    @property
    def everyNth(self) -> int: ...
    @everyNth.setter
    def everyNth(self, value: int) -> None: ...
    @property
    def withContent(self) -> bool: ...
    @withContent.setter
    def withContent(self, value: bool) -> None: ...
    @property
    def gate(self) -> bool: ...
    @gate.setter
    def gate(self, value: bool) -> None: ...
    @override
    def as_reader(self) -> readers.ChannelObserverParamsReader: ...

class StartChannelsServiceParamsBuilder(_DynamicStructBuilder):
    @property
    def name(self) -> str: ...
    @name.setter
    ...
    @registerAtGateway.setter
    def registerAtGateway(self, value: bool) -> None: ...
    @override
    @overload
    def init(
        self,
    ...
    def init(self, field: str, size: int | None = None) -> Any: ...
    @override
    def as_reader(self) -> readers.StartChannelsServiceParamsReader: ...
...
class ActivityInfoBuilder(_DynamicStructBuilder):
    @property
    def state(self) -> enums.ProcessActivityStateEnum: ...
    @state.setter
    def state(self, value: enums.ProcessActivityStateEnum) -> None: ...
    @property
    def port(self) -> str: ...
    @port.setter
    def port(self, value: str) -> None: ...
    @override
    def as_reader(self) -> readers.ActivityInfoReader: ...

class RunInfoBuilder(_DynamicStructBuilder):
    @property
    def hasRunInfo(self) -> bool: ...
    @hasRunInfo.setter
    def hasRunInfo(self, value: bool) -> None: ...
    @property
    def processId(self) -> str: ...
    @processId.setter
    def processId(self, value: str) -> None: ...
    @property
    ...
    @outcome.setter
    def outcome(self, value: enums.ProcessRunInfoOutcomeEnum) -> None: ...
    @property
    def phase(self) -> enums.ProcessRunInfoPhaseEnum: ...
    @phase.setter
    def phase(self, value: enums.ProcessRunInfoPhaseEnum) -> None: ...
    @property
    def port(self) -> str: ...
    @port.setter
    def port(self, value: str) -> None: ...
    ...
    @detailType.setter
    def detailType(self, value: str) -> None: ...
    @property
    ...
    @causeType.setter
    def causeType(self, value: str) -> None: ...
    @property
    def causeMessage(self) -> str: ...
    @causeMessage.setter
    def causeMessage(self, value: str) -> None: ...
    @property
    def traceback(self) -> TextListBuilder: ...
    @traceback.setter
    def traceback(
        self,
        value: TextListBuilder | readers.TextListReader | Sequence[str],
    ...
    def init(
        self,
        field: Literal["traceback"],
        size: int | None = None,
    ) -> TextListBuilder: ...
    @override
    def as_reader(self) -> readers.RunInfoReader: ...

...
class LeaseClient(_DynamicCapabilityClient):
    def ack(self) -> results_client.AckResult: ...
    def ack_request(self) -> requests.AckRequest: ...
...
class ReaderClient(IdentifiableClient, PersistentClient):
    ...
    def readLeased(self) -> results_client.ReadleasedResult: ...
    ...
    def readLeased_request(self) -> requests.ReadleasedRequest: ...
...
class ChannelStatsCallbackUnregisterClient(_DynamicCapabilityClient):
    def unreg(self) -> results_client.ChannelStatsCallbackUnregisterUnregResult: ...
    def unreg_request(self) -> requests.ChannelStatsCallbackUnregisterUnregRequest: ...
...
class ChannelObserverUnregisterClient(_DynamicCapabilityClient):
    def unreg(self) -> results_client.ChannelObserverUnregisterUnregResult: ...
    def unreg_request(self) -> requests.ChannelObserverUnregisterUnregRequest: ...

class ObserverClient(_DynamicCapabilityClient):
    def saw(
        self,
        ...
        | dict[str, Any]
        | None = None,
    ) -> results_client.SawResult: ...
    def saw_request(
        self,
        event: builders.EventBuilder | None = None,
    ) -> requests.SawRequest: ...
...
class ChannelClient(IdentifiableClient, PersistentClient):
    ...
    def observe(
        self,
        callback: ObserverClient
        | modules._ChannelInterfaceModule._ObserverInterfaceModule.Server
        | None = None,
        params: modules._ChannelInterfaceModule._ObserverInterfaceModule._ParamsStructModule
        | dict[str, Any]
        | None = None,
    ) -> results_client.ObserveResult: ...
    def pause(self) -> results_client.PauseResult: ...
    def resume(self) -> results_client.ResumeResult: ...
    def step(self, count: int | None = None) -> results_client.StepResult: ...
    ...
    def pause_request(self) -> requests.PauseRequest: ...
    def resume_request(self) -> requests.ResumeRequest: ...
    def step_request(self, count: int | None = None) -> requests.StepRequest: ...
...
class ProcessClient(IdentifiableClient, GatewayRegistrableClient):
    ...
    def lastRun(self) -> results_client.LastrunResult: ...
    def activity(
        self,
    ...
    def lastRun_request(self) -> requests.LastrunRequest: ...

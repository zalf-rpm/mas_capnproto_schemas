"""Runtime placeholder package for typing helpers of `management.capnp`."""
...
if TYPE_CHECKING:
    ...
    from mas.schema.management.management_capnp.types import results as results
    from mas.schema.management.management_capnp.types import schemas as schemas
    from mas.schema.management.management_capnp.types import servers as servers

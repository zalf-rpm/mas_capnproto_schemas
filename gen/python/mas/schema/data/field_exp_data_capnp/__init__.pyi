...
class _MixedTypeStructModule(_StructModule):
    ...
    class Builder(_DynamicStructBuilder):
        ...
        def init(self, field: str, size: int | None = None) -> Any: ...
        @override
        def as_reader(self) -> MixedTypeReader: ...
    ...
    def from_bytes(
        ...
        traversal_limit_in_words: int | None = None,
        nesting_limit: int | None = None,
    ) -> AbstractContextManager[MixedTypeReader]: ...
    @overload
    def from_bytes(
        self,
        buf: bytes,
    ...
    def from_bytes(
        ...
        *,
        builder: Literal[True],
    ) -> AbstractContextManager[MixedTypeBuilder]: ...
    @override
    def from_bytes_packed(
        self,
        buf: bytes,
...
MixedType: _MixedTypeStructModule
...
type MixedTypeBuilder = _MixedTypeStructModule.Builder
type MixedTypeReader = _MixedTypeStructModule.Reader

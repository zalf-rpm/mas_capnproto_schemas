...
class _MixedTypeStructModule(_StructModule):
    class Reader(_DynamicStructReader): ...
    class Builder(_DynamicStructBuilder): ...

    class _MixedTypeSchema(_StructSchema):
        ...
        class _Fields(dict[str, _StructSchemaField]):
            ...
            ) -> _MixedTypeStructModule._MixedTypeSchema._SoilProfileField: ...
            @overload
            def __getitem__(
                self,
                key: Literal["soil"],
            ) -> _MixedTypeStructModule._MixedTypeSchema._SoilField: ...
            @overload
            def __getitem__(
                self,
                key: Literal["plot"],
            ) -> _MixedTypeStructModule._MixedTypeSchema._PlotField: ...
            @overload
            def __getitem__(
                self,
                key: Literal["timeseries"],
            ) -> _MixedTypeStructModule._MixedTypeSchema._TimeseriesField: ...
            @overload
            def __getitem__(
                self,
                key: Literal["treatment"],
            ) -> _MixedTypeStructModule._MixedTypeSchema._TreatmentField: ...
            @overload
            def __getitem__(
                self,
                key: Literal["experiment"],
            ) -> _MixedTypeStructModule._MixedTypeSchema._ExperimentField: ...
            @overload
            def __getitem__(self, key: str) -> _StructSchemaField: ...

        @property
        @override
        def fields(self) -> _MixedTypeStructModule._MixedTypeSchema._Fields: ...

    @property
    @override
    def schema(self) -> schemas._MixedTypeSchema: ...
    @override
    def new_message(
        self,
        num_first_segment_words: int | None = None,
    ...
    def from_bytes(
        ...
        traversal_limit_in_words: int | None = None,
        nesting_limit: int | None = None,
    ) -> AbstractContextManager[readers.MixedTypeReader]: ...
    @overload
    def from_bytes(
        self,
        buf: bytes,
    ...
    def from_bytes(
        ...
        *,
        builder: Literal[True],
    ) -> AbstractContextManager[builders.MixedTypeBuilder]: ...
    @override
    def from_bytes_packed(
        self,
        buf: bytes,

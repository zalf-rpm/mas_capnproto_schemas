...
_SCHEMA_NODES = [
    ...
    "",  # persistence/persistence.capnp:Gateway
    "",  # persistence/persistence.capnp:Gateway.RegResults
    "ECRQBgb/q6tErykVjMcAESYBAAAFAQcAATEVsgEAARElPwAB/3BlcnNpc3RlBW5jZS9wZXJzaXN0ZW5jZS5jYXBucDpHYXRld2F5LnJlZ2lzdGVyJFAfYXJhbXNRBAMEAAAEAQAAEQ0iAABRCAMBURQCAQdjYXABEgQDAAEBEgAB",  # persistence/persistence.capnp:Gateway.register$Params
    "ECNQBgb/jWA33y8iU4IAER4D/yZrX0fT/l6FAAABM+cdMB8xFYoBES0HAAARKUcRWQcAAP9wZXJzaXN0ZQVuY2UvcGVyc2lzdGVuY2UuY2FwbnA6R2F0ZXdheVJlZ2lzdHJhYmxlAABQAQFRBAMFAAD/RJ230nhdTLYBtvDueoawuPcREZoAAhENB/9zdHVyZHlSZQFmQXRHYXRldwNheUABUAEB",  # persistence/persistence.capnp:GatewayRegistrable

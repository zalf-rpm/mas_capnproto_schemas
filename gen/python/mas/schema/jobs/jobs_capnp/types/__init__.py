"""Runtime placeholder package for typing helpers of `jobs.capnp`."""
...
if TYPE_CHECKING:
    ...
    from mas.schema.jobs.jobs_capnp.types import enums as enums
    from mas.schema.jobs.jobs_capnp.types import lists as lists
    ...
    from mas.schema.jobs.jobs_capnp.types import results as results
    from mas.schema.jobs.jobs_capnp.types import schemas as schemas
    from mas.schema.jobs.jobs_capnp.types import servers as servers

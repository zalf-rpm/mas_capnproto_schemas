"""Runtime placeholder package for typing helpers of `x.capnp`."""
...
if TYPE_CHECKING:
    ...
    from mas.schema.test.x_capnp.types import common as common
    from mas.schema.test.x_capnp.types import contexts as contexts
    from mas.schema.test.x_capnp.types import enums as enums
    from mas.schema.test.x_capnp.types import lists as lists
    ...
    from mas.schema.test.x_capnp.types import results as results
    from mas.schema.test.x_capnp.types import schemas as schemas
    from mas.schema.test.x_capnp.types import servers as servers

...
namespace Mas.Schema.Soil
{
    ...
    public class Layer : ICapnpSerializable
    {
        ...
        void ICapnpSerializable.Deserialize(DeserializerState arg_)
        {
            ...
            Properties = reader.Properties?.ToReadOnlyList(_ =>
                CapnpSerializable.Create<Mas.Schema.Soil.Layer.Property>(_)
            );
            Size = reader.Size;
        ...
        public struct READER
        {
            ...
            public IReadOnlyList<Mas.Schema.Soil.Layer.Property.READER> Properties =>
                ctx.ReadList(0).Cast(Mas.Schema.Soil.Layer.Property.READER.create);
        ...
        public class Property : ICapnpSerializable
        {
            ...
            public struct READER
            {
                ...
                public Mas.Schema.Soil.PropertyName Name =>
                    (Mas.Schema.Soil.PropertyName)ctx.ReadDataUShort(0UL, (ushort)0);
                public float F32Value =>
                    which == WHICH.F32Value ? ctx.ReadDataFloat(32UL, 0F) : default;
                public bool BValue =>
                    which == WHICH.BValue ? ctx.ReadDataBool(32UL, false) : default;
    ...
    public class Query : ICapnpSerializable
    {
        ...
        public struct READER
        {
            ...
            public IReadOnlyList<Mas.Schema.Soil.PropertyName> Mandatory =>
                ctx.ReadList(0).CastEnums(_0 => (Mas.Schema.Soil.PropertyName)_0);
            public bool HasMandatory => ctx.IsStructFieldNonNull(0);
            public IReadOnlyList<Mas.Schema.Soil.PropertyName> Optional =>
                ctx.ReadList(1).CastEnums(_0 => (Mas.Schema.Soil.PropertyName)_0);
        ...
        public class Result : ICapnpSerializable
        {
            ...
            public class WRITER : SerializerState
            {
                ...
                {
                    get =>
                        BuildPointer<ListOfPrimitivesSerializer<Mas.Schema.Soil.PropertyName>>(1);
                    set => Link(1, value);
                }
            }
        }
    ...
    public class ProfileData : ICapnpSerializable
    {
        ...
        void ICapnpSerializable.Deserialize(DeserializerState arg_)
        {
            ...
            Layers = reader.Layers?.ToReadOnlyList(_ =>
                CapnpSerializable.Create<Mas.Schema.Soil.Layer>(_)
            );
        ...
        public struct READER
        {
            ...
            public IReadOnlyList<Mas.Schema.Soil.Layer.READER> Layers =>
                ctx.ReadList(0).Cast(Mas.Schema.Soil.Layer.READER.create);
    ...
    public interface IProfile : Mas.Schema.Common.IIdentifiable, Mas.Schema.Persistence.IPersistent
    {
        ...
        Task<Mas.Schema.Geo.LatLonCoord> GeoLocation(
    ...
    {
        public async Task<Mas.Schema.Soil.ProfileData> Data(
            CancellationToken cancellationToken_ = default
        )
        {
        ...
        public async Task<Mas.Schema.Geo.LatLonCoord> GeoLocation(
            CancellationToken cancellationToken_ = default
        )
        {
            var in_ =
                SerializerState.CreateForRpc<Mas.Schema.Soil.Profile.Params_GeoLocation.WRITER>();
    ...
    public class Profile_Skeleton : Skeleton<IProfile>
    {
        ...
        Task<AnswerOrCounterquestion> GeoLocation(
            DeserializerState d_,
            CancellationToken cancellationToken_
        )
        {
            ...
            {
                return Impatient.MaybeTailCall(
                    Impl.GeoLocation(cancellationToken_),
                    r_ =>
                    {
    ...
    {
        Task<Mas.Schema.Soil.Query.Result> CheckAvailableParameters(
            Mas.Schema.Soil.Query arg_,
            CancellationToken cancellationToken_ = default
        );
        Task<(
            IReadOnlyList<Mas.Schema.Soil.PropertyName>,
            IReadOnlyList<Mas.Schema.Soil.PropertyName>
        )> GetAllAvailableParameters(
            bool onlyRawData,
            CancellationToken cancellationToken_ = default
        );
        Task<IReadOnlyList<Mas.Schema.Soil.IProfile>> ClosestProfilesAt(
            Mas.Schema.Geo.LatLonCoord coord,
            Mas.Schema.Soil.Query query,
            CancellationToken cancellationToken_ = default
        );
        Task<Mas.Schema.Soil.Service.IStream> StreamAllProfiles(
            Mas.Schema.Soil.Query arg_,
            CancellationToken cancellationToken_ = default
        );
    }
    ...
    {
        public async Task<Mas.Schema.Soil.Query.Result> CheckAvailableParameters(
            Mas.Schema.Soil.Query arg_,
            CancellationToken cancellationToken_ = default
        )
        {
        ...
        {
            var in_ =
                SerializerState.CreateForRpc<Mas.Schema.Soil.Service.Params_GetAllAvailableParameters.WRITER>();
            ...
            {
                var r_ =
                    CapnpSerializable.Create<Mas.Schema.Soil.Service.Result_GetAllAvailableParameters>(
                        d_
                    );
        ...
        public Task<IReadOnlyList<Mas.Schema.Soil.IProfile>> ClosestProfilesAt(
            Mas.Schema.Geo.LatLonCoord coord,
            Mas.Schema.Soil.Query query,
            CancellationToken cancellationToken_ = default
        )
        {
            var in_ =
                SerializerState.CreateForRpc<Mas.Schema.Soil.Service.Params_ClosestProfilesAt.WRITER>();
            ...
            return Impatient.MakePipelineAware(
                ...
                d_ =>
                {
                    ...
                    {
                        var r_ =
                            CapnpSerializable.Create<Mas.Schema.Soil.Service.Result_ClosestProfilesAt>(
                                d_
                            );
                        return (r_.Profiles);
                    }
        ...
        public Task<Mas.Schema.Soil.Service.IStream> StreamAllProfiles(
            Mas.Schema.Soil.Query arg_,
            CancellationToken cancellationToken_ = default
        )
        {
            ...
            return Impatient.MakePipelineAware(
                ...
                d_ =>
                {
                    ...
                    {
                        var r_ =
                            CapnpSerializable.Create<Mas.Schema.Soil.Service.Result_StreamAllProfiles>(
                                d_
                            );
    ...
    public class Service_Skeleton : Skeleton<IService>
    {
        ...
        Task<AnswerOrCounterquestion> CheckAvailableParameters(
            DeserializerState d_,
            CancellationToken cancellationToken_
        )
        {
            ...
            {
                return Impatient.MaybeTailCall(
                    Impl.CheckAvailableParameters(
                        CapnpSerializable.Create<Mas.Schema.Soil.Query>(d_),
                        cancellationToken_
                    ),
                    r_ =>
                    {
                        var s_ =
                            SerializerState.CreateForRpc<Mas.Schema.Soil.Query.Result.WRITER>();
                        r_.serialize(s_);
                        return s_;
                    }
                );
        ...
        Task<AnswerOrCounterquestion> GetAllAvailableParameters(
            DeserializerState d_,
            CancellationToken cancellationToken_
        )
        {
            ...
            {
                var in_ =
                    CapnpSerializable.Create<Mas.Schema.Soil.Service.Params_GetAllAvailableParameters>(
                        d_
                    );
                return Impatient.MaybeTailCall(
                    Impl.GetAllAvailableParameters(in_.OnlyRawData, cancellationToken_),
                    (mandatory, optional) =>
                    {
                        var s_ =
                            SerializerState.CreateForRpc<Mas.Schema.Soil.Service.Result_GetAllAvailableParameters.WRITER>();
        ...
        Task<AnswerOrCounterquestion> ClosestProfilesAt(
            DeserializerState d_,
            CancellationToken cancellationToken_
        )
        {
            ...
            {
                var in_ =
                    CapnpSerializable.Create<Mas.Schema.Soil.Service.Params_ClosestProfilesAt>(d_);
                return Impatient.MaybeTailCall(
                    Impl.ClosestProfilesAt(in_.Coord, in_.Query, cancellationToken_),
                    profiles =>
                    {
                        var s_ =
                            SerializerState.CreateForRpc<Mas.Schema.Soil.Service.Result_ClosestProfilesAt.WRITER>();
        ...
        Task<AnswerOrCounterquestion> StreamAllProfiles(
            DeserializerState d_,
            CancellationToken cancellationToken_
        )
        {
            using (d_)
            {
                return Impatient.MaybeTailCall(
                    ...
                    {
                        var s_ =
                            SerializerState.CreateForRpc<Mas.Schema.Soil.Service.Result_StreamAllProfiles.WRITER>();
    ...
    public static class Service
    {
        ...
        {
            Task<IReadOnlyList<Mas.Schema.Soil.IProfile>> NextProfiles(
                long maxCount,
                CancellationToken cancellationToken_ = default
            );
        }
        ...
        {
            public Task<IReadOnlyList<Mas.Schema.Soil.IProfile>> NextProfiles(
                long maxCount,
                CancellationToken cancellationToken_ = default
            )
            {
                var in_ =
                    SerializerState.CreateForRpc<Mas.Schema.Soil.Service.Stream.Params_NextProfiles.WRITER>();
                ...
                return Impatient.MakePipelineAware(
                    ...
                    d_ =>
                    {
                        ...
                        {
                            var r_ =
                                CapnpSerializable.Create<Mas.Schema.Soil.Service.Stream.Result_NextProfiles>(
                                    d_
                                );
                            return (r_.Profiles);
                        }
        ...
        public class Stream_Skeleton : Skeleton<IStream>
        {
            ...
            Task<AnswerOrCounterquestion> NextProfiles(
                DeserializerState d_,
                CancellationToken cancellationToken_
            )
            {
                ...
                {
                    var in_ =
                        CapnpSerializable.Create<Mas.Schema.Soil.Service.Stream.Params_NextProfiles>(
                            d_
                        );
                    return Impatient.MaybeTailCall(
                        Impl.NextProfiles(in_.MaxCount, cancellationToken_),
                        profiles =>
                        {
                            var s_ =
                                SerializerState.CreateForRpc<Mas.Schema.Soil.Service.Stream.Result_NextProfiles.WRITER>();
            ...
            public class Result_NextProfiles : ICapnpSerializable
            {
                ...
                public struct READER
                {
                    ...
                    public IReadOnlyList<Mas.Schema.Soil.IProfile> Profiles =>
                        ctx.ReadCapList<Mas.Schema.Soil.IProfile>(0);
        ...
        public class Params_ClosestProfilesAt : ICapnpSerializable
        {
            ...
            public struct READER
            {
                ...
                public Mas.Schema.Geo.LatLonCoord.READER Coord =>
                    ctx.ReadStruct(0, Mas.Schema.Geo.LatLonCoord.READER.create);
                public bool HasCoord => ctx.IsStructFieldNonNull(0);
                public Mas.Schema.Soil.Query.READER Query =>
                    ctx.ReadStruct(1, Mas.Schema.Soil.Query.READER.create);
        ...
        public class Result_StreamAllProfiles : ICapnpSerializable
        {
            ...
            public struct READER
            {
                ...
                public Mas.Schema.Soil.Service.IStream AllProfiles =>
                    ctx.ReadCap<Mas.Schema.Soil.Service.IStream>(0);
            }

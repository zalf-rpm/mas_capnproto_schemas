...
namespace Mas.Schema.Jobs
{
    [
        ...
        TypeId(0xa05b60b71ca38848UL)
    ]
    public class Job<TPayload> : ICapnpSerializable
    ...
    {
        public Task<Mas.Schema.Jobs.Job<object>> NextJob(
        ...
        )
        {
            ...
            return Impatient.MakePipelineAware(
                ...
                d_ =>
                {
                    using (d_)
                    {
                        var r_ = CapnpSerializable.Create<Mas.Schema.Jobs.Service.Result_NextJob>(
                            d_
                        );
                        return (r_.Job);
                    }
    ...
    public class Service_Skeleton : Skeleton<IService>
    {
        ...
        Task<AnswerOrCounterquestion> NextJob(
        ...
        )
        {
            using (d_)
            {
                return Impatient.MaybeTailCall(
                    Impl.NextJob(cancellationToken_),
                    job =>
                    {
                        var s_ =
                            SerializerState.CreateForRpc<Mas.Schema.Jobs.Service.Result_NextJob.WRITER>();
    ...
    public static class Service
    {
        ...
        public class Result_NextJob : ICapnpSerializable
        {
            ...
            public struct READER
            {
                ...
                public Mas.Schema.Jobs.Job<object>.READER Job =>
                    ctx.ReadStruct(0, Mas.Schema.Jobs.Job<object>.READER.create);

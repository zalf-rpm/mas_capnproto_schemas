...
namespace Mas.Schema.Cluster
{
    ...
    public class Cluster : ICapnpSerializable
    {
        ...
        public class Unregister_Proxy : Proxy, IUnregister
        {
            ...
            {
                var in_ =
                    SerializerState.CreateForRpc<Mas.Schema.Cluster.Cluster.Unregister.Params_Unregister.WRITER>();
                var arg_ = new Mas.Schema.Cluster.Cluster.Unregister.Params_Unregister() { };
                arg_?.serialize(in_);
                using (
                    var d_ = await Call(
                        16767455160994962366UL,
                        0,
                ...
                {
                    var r_ =
                        CapnpSerializable.Create<Mas.Schema.Cluster.Cluster.Unregister.Result_Unregister>(
                            d_
                        );
                    return (r_.Success);
                }
        ...
        public class Unregister_Skeleton : Skeleton<IUnregister>
        {
            ...
            Task<AnswerOrCounterquestion> Unregister(
            ...
            )
            {
                using (d_)
                {
                    return Impatient.MaybeTailCall(
                        Impl.Unregister(cancellationToken_),
                        success =>
                        {
                            var s_ =
                                SerializerState.CreateForRpc<Mas.Schema.Cluster.Cluster.Unregister.Result_Unregister.WRITER>();
        ...
        {
            Task<Mas.Schema.Cluster.Cluster.IUnregister> RegisterModelInstanceFactory(
                string aModelId,
                Mas.Schema.Cluster.Cluster.IModelInstanceFactory aFactory,
                CancellationToken cancellationToken_ = default
            );
            Task<IReadOnlyList<Mas.Schema.Cluster.Cluster.IModelInstanceFactory>> AvailableModels(
                CancellationToken cancellationToken_ = default
            );
        }
        ...
        {
            public Task<Mas.Schema.Cluster.Cluster.IUnregister> RegisterModelInstanceFactory(
                string aModelId,
                Mas.Schema.Cluster.Cluster.IModelInstanceFactory aFactory,
                CancellationToken cancellationToken_ = default
            )
            {
                var in_ =
                    SerializerState.CreateForRpc<Mas.Schema.Cluster.Cluster.AdminMaster.Params_RegisterModelInstanceFactory.WRITER>();
                var arg_ =
                    new Mas.Schema.Cluster.Cluster.AdminMaster.Params_RegisterModelInstanceFactory()
                    {
                        AModelId = aModelId,
                        AFactory = aFactory,
                    };
                ...
                return Impatient.MakePipelineAware(
                    ...
                    d_ =>
                    {
                        ...
                        {
                            var r_ =
                                CapnpSerializable.Create<Mas.Schema.Cluster.Cluster.AdminMaster.Result_RegisterModelInstanceFactory>(
                                    d_
                                );
            ...
            public Task<
                IReadOnlyList<Mas.Schema.Cluster.Cluster.IModelInstanceFactory>
            > AvailableModels(CancellationToken cancellationToken_ = default)
            {
                var in_ =
                    SerializerState.CreateForRpc<Mas.Schema.Cluster.Cluster.AdminMaster.Params_AvailableModels.WRITER>();
                ...
                return Impatient.MakePipelineAware(
                    ...
                    d_ =>
                    {
                        ...
                        {
                            var r_ =
                                CapnpSerializable.Create<Mas.Schema.Cluster.Cluster.AdminMaster.Result_AvailableModels>(
                                    d_
                                );
                            return (r_.Factories);
                        }
        ...
        public class AdminMaster_Skeleton : Skeleton<IAdminMaster>
        {
            ...
            Task<AnswerOrCounterquestion> RegisterModelInstanceFactory(
                DeserializerState d_,
                CancellationToken cancellationToken_
            )
            {
                ...
                {
                    var in_ =
                        CapnpSerializable.Create<Mas.Schema.Cluster.Cluster.AdminMaster.Params_RegisterModelInstanceFactory>(
                            d_
                        );
                    return Impatient.MaybeTailCall(
                        Impl.RegisterModelInstanceFactory(
                            in_.AModelId,
                            in_.AFactory,
                            cancellationToken_
                        ),
                        ...
                        {
                            var s_ =
                                SerializerState.CreateForRpc<Mas.Schema.Cluster.Cluster.AdminMaster.Result_RegisterModelInstanceFactory.WRITER>();
                            var r_ =
                                new Mas.Schema.Cluster.Cluster.AdminMaster.Result_RegisterModelInstanceFactory
                                {
            ...
            Task<AnswerOrCounterquestion> AvailableModels(
                DeserializerState d_,
                CancellationToken cancellationToken_
            )
            {
                ...
                {
                    return Impatient.MaybeTailCall(
                        Impl.AvailableModels(cancellationToken_),
                        factories =>
                        {
                            var s_ =
                                SerializerState.CreateForRpc<Mas.Schema.Cluster.Cluster.AdminMaster.Result_AvailableModels.WRITER>();
                            var r_ =
                                new Mas.Schema.Cluster.Cluster.AdminMaster.Result_AvailableModels
                                {
                                    Factories = factories,
                                };
                            r_.serialize(s_);
            ...
            public class Params_RegisterModelInstanceFactory : ICapnpSerializable
            {
                ...
                public struct READER
                {
                    ...
                    public Mas.Schema.Cluster.Cluster.IModelInstanceFactory AFactory =>
                        ctx.ReadCap<Mas.Schema.Cluster.Cluster.IModelInstanceFactory>(1);
                }
            ...
            public class Result_RegisterModelInstanceFactory : ICapnpSerializable
            {
                ...
                public struct READER
                {
                    ...
                    public Mas.Schema.Cluster.Cluster.IUnregister Unregister =>
                        ctx.ReadCap<Mas.Schema.Cluster.Cluster.IUnregister>(0);
                }
            ...
            public class Result_AvailableModels : ICapnpSerializable
            {
                ...
                public struct READER
                {
                    ...
                    public IReadOnlyList<Mas.Schema.Cluster.Cluster.IModelInstanceFactory> Factories =>
                        ctx.ReadCapList<Mas.Schema.Cluster.Cluster.IModelInstanceFactory>(0);
                ...
                public class WRITER : SerializerState
                {
                    ...
                    public ListOfCapsSerializer<Mas.Schema.Cluster.Cluster.IModelInstanceFactory> Factories
                    {
                        get =>
                            BuildPointer<
                                ListOfCapsSerializer<Mas.Schema.Cluster.Cluster.IModelInstanceFactory>
                            >(0);
                        set => Link(0, value);
                    }
                }
        ...
        public class UserMaster_Proxy : Proxy, IUserMaster
        {
            ...
            {
                var in_ =
                    SerializerState.CreateForRpc<Mas.Schema.Cluster.Cluster.UserMaster.Params_AvailableModels.WRITER>();
                var arg_ = new Mas.Schema.Cluster.Cluster.UserMaster.Params_AvailableModels() { };
                arg_?.serialize(in_);
                return Impatient.MakePipelineAware(
                    Call(
                        17024388203168484192UL,
                        0,
                        in_.Rewrap<DynamicSerializerState>(),
                        false,
                        cancellationToken_
                    ...
                    d_ =>
                    {
                        ...
                        {
                            var r_ =
                                CapnpSerializable.Create<Mas.Schema.Cluster.Cluster.UserMaster.Result_AvailableModels>(
                                    d_
                                );
                            return (r_.Factories);
                        }
            ...
            )
            {
                using (d_)
                {
                    return Impatient.MaybeTailCall(
                        ...
                        {
                            var s_ =
                                SerializerState.CreateForRpc<Mas.Schema.Cluster.Cluster.UserMaster.Result_AvailableModels.WRITER>();
                            var r_ =
                                new Mas.Schema.Cluster.Cluster.UserMaster.Result_AvailableModels
                                {
                                    Factories = factories,
                                };
                            r_.serialize(s_);
        ...
        public interface IRuntime : Mas.Schema.Common.IIdentifiable
        {
            ...
            Task<short> ReserveNumberOfCores(
                short reserveCores,
                string aModelId,
                CancellationToken cancellationToken_ = default
            );
        ...
        public class Runtime_Proxy : Proxy, IRuntime
        {
            ...
            {
                var in_ =
                    SerializerState.CreateForRpc<Mas.Schema.Cluster.Cluster.Runtime.Params_RegisterModelInstanceFactory.WRITER>();
                var arg_ =
                    new Mas.Schema.Cluster.Cluster.Runtime.Params_RegisterModelInstanceFactory()
                    {
                        AModelId = aModelId,
                        AFactory = aFactory,
                    };
                ...
                return Impatient.MakePipelineAware(
                    ...
                    d_ =>
                    {
                        ...
                        {
                            var r_ =
                                CapnpSerializable.Create<Mas.Schema.Cluster.Cluster.Runtime.Result_RegisterModelInstanceFactory>(
                                    d_
                                );
                            return (r_.Unregister);
                        }
            ...
            {
                var in_ =
                    SerializerState.CreateForRpc<Mas.Schema.Cluster.Cluster.Runtime.Params_AvailableModels.WRITER>();
                ...
                return Impatient.MakePipelineAware(
                    ...
                    d_ =>
                    {
                        ...
                        {
                            var r_ =
                                CapnpSerializable.Create<Mas.Schema.Cluster.Cluster.Runtime.Result_AvailableModels>(
                                    d_
                                );
                            return (r_.Factories);
                        }
            ...
            {
                var in_ =
                    SerializerState.CreateForRpc<Mas.Schema.Cluster.Cluster.Runtime.Params_NumberOfCores.WRITER>();
                ...
                {
                    var r_ =
                        CapnpSerializable.Create<Mas.Schema.Cluster.Cluster.Runtime.Result_NumberOfCores>(
                            d_
                        );
                    return (r_.Cores);
                }
            ...
            public async Task<short> FreeNumberOfCores(
                CancellationToken cancellationToken_ = default
            )
            {
                var in_ =
                    SerializerState.CreateForRpc<Mas.Schema.Cluster.Cluster.Runtime.Params_FreeNumberOfCores.WRITER>();
                ...
                {
                    var r_ =
                        CapnpSerializable.Create<Mas.Schema.Cluster.Cluster.Runtime.Result_FreeNumberOfCores>(
                            d_
                        );
                    return (r_.Cores);
                }
            ...
            public async Task<short> ReserveNumberOfCores(
                short reserveCores,
                string aModelId,
                CancellationToken cancellationToken_ = default
            )
            {
                var in_ =
                    SerializerState.CreateForRpc<Mas.Schema.Cluster.Cluster.Runtime.Params_ReserveNumberOfCores.WRITER>();
                ...
                {
                    var r_ =
                        CapnpSerializable.Create<Mas.Schema.Cluster.Cluster.Runtime.Result_ReserveNumberOfCores>(
                            d_
                        );
        ...
        public class Runtime_Skeleton : Skeleton<IRuntime>
        {
            ...
            {
                SetMethodTable(
                    RegisterModelInstanceFactory,
                    AvailableModels,
                    NumberOfCores,
                    FreeNumberOfCores,
                    ReserveNumberOfCores
                );
            }
            ...
            )
            {
                ...
                {
                    var in_ =
                        CapnpSerializable.Create<Mas.Schema.Cluster.Cluster.Runtime.Params_RegisterModelInstanceFactory>(
                            d_
                        );
                    return Impatient.MaybeTailCall(
                        Impl.RegisterModelInstanceFactory(
                        ...
                        {
                            var s_ =
                                SerializerState.CreateForRpc<Mas.Schema.Cluster.Cluster.Runtime.Result_RegisterModelInstanceFactory.WRITER>();
                            var r_ =
                                new Mas.Schema.Cluster.Cluster.Runtime.Result_RegisterModelInstanceFactory
                                {
                                    Unregister = unregister,
                                };
                            r_.serialize(s_);
            ...
            )
            {
                using (d_)
                {
                    return Impatient.MaybeTailCall(
                        ...
                        {
                            var s_ =
                                SerializerState.CreateForRpc<Mas.Schema.Cluster.Cluster.Runtime.Result_AvailableModels.WRITER>();
            ...
            Task<AnswerOrCounterquestion> NumberOfCores(
                DeserializerState d_,
                CancellationToken cancellationToken_
            )
            {
                ...
                {
                    return Impatient.MaybeTailCall(
                        Impl.NumberOfCores(cancellationToken_),
                        cores =>
                        {
                            var s_ =
                                SerializerState.CreateForRpc<Mas.Schema.Cluster.Cluster.Runtime.Result_NumberOfCores.WRITER>();
            ...
            Task<AnswerOrCounterquestion> FreeNumberOfCores(
                DeserializerState d_,
                CancellationToken cancellationToken_
            )
            {
                ...
                {
                    return Impatient.MaybeTailCall(
                        Impl.FreeNumberOfCores(cancellationToken_),
                        cores =>
                        {
                            var s_ =
                                SerializerState.CreateForRpc<Mas.Schema.Cluster.Cluster.Runtime.Result_FreeNumberOfCores.WRITER>();
            ...
            Task<AnswerOrCounterquestion> ReserveNumberOfCores(
                DeserializerState d_,
                CancellationToken cancellationToken_
            )
            {
                ...
                {
                    var in_ =
                        CapnpSerializable.Create<Mas.Schema.Cluster.Cluster.Runtime.Params_ReserveNumberOfCores>(
                            d_
                        );
                    return Impatient.MaybeTailCall(
                        Impl.ReserveNumberOfCores(
                            in_.ReserveCores,
                            in_.AModelId,
                            cancellationToken_
                        ),
                        ...
                        {
                            var s_ =
                                SerializerState.CreateForRpc<Mas.Schema.Cluster.Cluster.Runtime.Result_ReserveNumberOfCores.WRITER>();
                            var r_ =
                                new Mas.Schema.Cluster.Cluster.Runtime.Result_ReserveNumberOfCores
                                {
        ...
        public class ValueHolder_Proxy<TT> : Proxy, IValueHolder<TT>
            where TT : class
        {
            public Task<TT> Value(CancellationToken cancellationToken_ = default)
            {
                var in_ =
                    SerializerState.CreateForRpc<Mas.Schema.Cluster.Cluster.ValueHolder<TT>.Params_Value.WRITER>();
                var arg_ = new Mas.Schema.Cluster.Cluster.ValueHolder<TT>.Params_Value() { };
                arg_?.serialize(in_);
                return Impatient.MakePipelineAware(
                    Call(
                        15469003256364184776UL,
                        0,
                        in_.Rewrap<DynamicSerializerState>(),
                        false,
                        cancellationToken_
                    ...
                    d_ =>
                    {
                        ...
                        {
                            var r_ =
                                CapnpSerializable.Create<Mas.Schema.Cluster.Cluster.ValueHolder<TT>.Result_Value>(
                                    d_
                                );
                            return (r_.Val);
                        }
            ...
            {
                var in_ =
                    SerializerState.CreateForRpc<Mas.Schema.Cluster.Cluster.ValueHolder<TT>.Params_Release.WRITER>();
                ...
                {
                    var r_ =
                        CapnpSerializable.Create<Mas.Schema.Cluster.Cluster.ValueHolder<TT>.Result_Release>(
                            d_
                        );
                    return;
                }
        ...
        public class ValueHolder_Skeleton<TT> : Skeleton<IValueHolder<TT>>
            where TT : class
        {
            ...
            )
            {
                using (d_)
                {
                    return Impatient.MaybeTailCall(
                        ...
                        {
                            var s_ =
                                SerializerState.CreateForRpc<Mas.Schema.Cluster.Cluster.ValueHolder<TT>.Result_Value.WRITER>();
            ...
            async Task<AnswerOrCounterquestion> Release(
                DeserializerState d_,
                CancellationToken cancellationToken_
            )
            {
                using (d_)
                {
                    ...
                    var s_ =
                        SerializerState.CreateForRpc<Mas.Schema.Cluster.Cluster.ValueHolder<TT>.Result_Release.WRITER>();
                    return s_;
                }
            }
        }
        ...
        {
            Task<Mas.Schema.Cluster.Cluster.IValueHolder<object>> NewInstance(
                CancellationToken cancellationToken_ = default
            );
            Task<Mas.Schema.Cluster.Cluster.IValueHolder<
                IReadOnlyList<Mas.Schema.Cluster.Cluster.IValueHolder<object>>
            >> NewInstances(
                short numberOfInstances,
                CancellationToken cancellationToken_ = default
            );
            Task<Mas.Schema.Cluster.Cluster.IValueHolder<Mas.Schema.Cluster.Cluster.ZmqPipelineAddresses>> NewCloudViaZmqPipelineProxies(
                short numberOfInstances,
                CancellationToken cancellationToken_ = default
            );
            Task<Mas.Schema.Cluster.Cluster.IValueHolder<object>> NewCloudViaProxy(
                short numberOfInstances,
                CancellationToken cancellationToken_ = default
            );
            Task<string> ModelId(CancellationToken cancellationToken_ = default);
            Task<Mas.Schema.Cluster.Cluster.IUnregister> RegisterModelInstance(
                BareProxy instance,
                string registrationToken,
                CancellationToken cancellationToken_ = default
            );
            Task<Mas.Schema.Cluster.Cluster.IValueHolder<object>> RestoreSturdyRef(
                string sturdyRef,
                CancellationToken cancellationToken_ = default
            );
        }
        ...
        {
            public Task<Mas.Schema.Cluster.Cluster.IValueHolder<object>> NewInstance(
                CancellationToken cancellationToken_ = default
            )
            {
                var in_ =
                    SerializerState.CreateForRpc<Mas.Schema.Cluster.Cluster.ModelInstanceFactory.Params_NewInstance.WRITER>();
                var arg_ = new Mas.Schema.Cluster.Cluster.ModelInstanceFactory.Params_NewInstance()
                { };
                arg_?.serialize(in_);
                return Impatient.MakePipelineAware(
                    Call(
                        18273735479106932414UL,
                        0,
                        in_.Rewrap<DynamicSerializerState>(),
                        false,
                        cancellationToken_
                    ...
                    d_ =>
                    {
                        ...
                        {
                            var r_ =
                                CapnpSerializable.Create<Mas.Schema.Cluster.Cluster.ModelInstanceFactory.Result_NewInstance>(
                                    d_
                                );
                            return (r_.Instance);
                        }
            ...
            public Task<Mas.Schema.Cluster.Cluster.IValueHolder<
                IReadOnlyList<Mas.Schema.Cluster.Cluster.IValueHolder<object>>
            >> NewInstances(short numberOfInstances, CancellationToken cancellationToken_ = default)
            {
                var in_ =
                    SerializerState.CreateForRpc<Mas.Schema.Cluster.Cluster.ModelInstanceFactory.Params_NewInstances.WRITER>();
                ...
                return Impatient.MakePipelineAware(
                    ...
                    d_ =>
                    {
                        ...
                        {
                            var r_ =
                                CapnpSerializable.Create<Mas.Schema.Cluster.Cluster.ModelInstanceFactory.Result_NewInstances>(
                                    d_
                                );
                            return (r_.Instances);
                        }
            ...
            public Task<Mas.Schema.Cluster.Cluster.IValueHolder<Mas.Schema.Cluster.Cluster.ZmqPipelineAddresses>> NewCloudViaZmqPipelineProxies(
                short numberOfInstances,
                CancellationToken cancellationToken_ = default
            )
            {
                var in_ =
                    SerializerState.CreateForRpc<Mas.Schema.Cluster.Cluster.ModelInstanceFactory.Params_NewCloudViaZmqPipelineProxies.WRITER>();
                var arg_ =
                    new Mas.Schema.Cluster.Cluster.ModelInstanceFactory.Params_NewCloudViaZmqPipelineProxies()
                    {
                        NumberOfInstances = numberOfInstances,
                    };
                arg_?.serialize(in_);
                return Impatient.MakePipelineAware(
                    ...
                    d_ =>
                    {
                        ...
                        {
                            var r_ =
                                CapnpSerializable.Create<Mas.Schema.Cluster.Cluster.ModelInstanceFactory.Result_NewCloudViaZmqPipelineProxies>(
                                    d_
                                );
            ...
            public Task<Mas.Schema.Cluster.Cluster.IValueHolder<object>> NewCloudViaProxy(
                short numberOfInstances,
                CancellationToken cancellationToken_ = default
            )
            {
                var in_ =
                    SerializerState.CreateForRpc<Mas.Schema.Cluster.Cluster.ModelInstanceFactory.Params_NewCloudViaProxy.WRITER>();
                var arg_ =
                    new Mas.Schema.Cluster.Cluster.ModelInstanceFactory.Params_NewCloudViaProxy()
                    {
                        NumberOfInstances = numberOfInstances,
                    };
                arg_?.serialize(in_);
                return Impatient.MakePipelineAware(
                    ...
                    d_ =>
                    {
                        ...
                        {
                            var r_ =
                                CapnpSerializable.Create<Mas.Schema.Cluster.Cluster.ModelInstanceFactory.Result_NewCloudViaProxy>(
                                    d_
                                );
                            return (r_.Proxy);
                        }
            ...
            {
                var in_ =
                    SerializerState.CreateForRpc<Mas.Schema.Cluster.Cluster.ModelInstanceFactory.Params_ModelId.WRITER>();
                ...
                {
                    var r_ =
                        CapnpSerializable.Create<Mas.Schema.Cluster.Cluster.ModelInstanceFactory.Result_ModelId>(
                            d_
                        );
                    return (r_.Id);
                }
            ...
            public Task<Mas.Schema.Cluster.Cluster.IUnregister> RegisterModelInstance(
                BareProxy instance,
                string registrationToken,
                CancellationToken cancellationToken_ = default
            )
            {
                var in_ =
                    SerializerState.CreateForRpc<Mas.Schema.Cluster.Cluster.ModelInstanceFactory.Params_RegisterModelInstance.WRITER>();
                var arg_ =
                    new Mas.Schema.Cluster.Cluster.ModelInstanceFactory.Params_RegisterModelInstance()
                    {
                        Instance = instance,
                ...
                return Impatient.MakePipelineAware(
                    ...
                    d_ =>
                    {
                        ...
                        {
                            var r_ =
                                CapnpSerializable.Create<Mas.Schema.Cluster.Cluster.ModelInstanceFactory.Result_RegisterModelInstance>(
                                    d_
                                );
                            return (r_.Unregister);
                        }
            ...
            public Task<Mas.Schema.Cluster.Cluster.IValueHolder<object>> RestoreSturdyRef(
                string sturdyRef,
                CancellationToken cancellationToken_ = default
            )
            {
                var in_ =
                    SerializerState.CreateForRpc<Mas.Schema.Cluster.Cluster.ModelInstanceFactory.Params_RestoreSturdyRef.WRITER>();
                var arg_ =
                    new Mas.Schema.Cluster.Cluster.ModelInstanceFactory.Params_RestoreSturdyRef()
                    {
                        SturdyRef = sturdyRef,
                    };
                arg_?.serialize(in_);
                return Impatient.MakePipelineAware(
                    ...
                    d_ =>
                    {
                        ...
                        {
                            var r_ =
                                CapnpSerializable.Create<Mas.Schema.Cluster.Cluster.ModelInstanceFactory.Result_RestoreSturdyRef>(
                                    d_
                                );
                            return (r_.Cap);
                        }
        ...
        public class ModelInstanceFactory_Skeleton : Skeleton<IModelInstanceFactory>
        {
            ...
            Task<AnswerOrCounterquestion> NewInstance(
                DeserializerState d_,
                CancellationToken cancellationToken_
            )
            {
                ...
                {
                    return Impatient.MaybeTailCall(
                        Impl.NewInstance(cancellationToken_),
                        instance =>
                        {
                            var s_ =
                                SerializerState.CreateForRpc<Mas.Schema.Cluster.Cluster.ModelInstanceFactory.Result_NewInstance.WRITER>();
                            var r_ =
                                new Mas.Schema.Cluster.Cluster.ModelInstanceFactory.Result_NewInstance
                                {
                                    Instance = instance,
                                };
                            r_.serialize(s_);
            ...
            Task<AnswerOrCounterquestion> NewInstances(
                DeserializerState d_,
                CancellationToken cancellationToken_
            )
            {
                ...
                {
                    var in_ =
                        CapnpSerializable.Create<Mas.Schema.Cluster.Cluster.ModelInstanceFactory.Params_NewInstances>(
                            d_
                        );
                    return Impatient.MaybeTailCall(
                        Impl.NewInstances(in_.NumberOfInstances, cancellationToken_),
                        instances =>
                        {
                            var s_ =
                                SerializerState.CreateForRpc<Mas.Schema.Cluster.Cluster.ModelInstanceFactory.Result_NewInstances.WRITER>();
                            var r_ =
                                new Mas.Schema.Cluster.Cluster.ModelInstanceFactory.Result_NewInstances
                                {
                                    Instances = instances,
                                };
                            r_.serialize(s_);
            ...
            Task<AnswerOrCounterquestion> NewCloudViaZmqPipelineProxies(
                DeserializerState d_,
                CancellationToken cancellationToken_
            )
            {
                ...
                {
                    var in_ =
                        CapnpSerializable.Create<Mas.Schema.Cluster.Cluster.ModelInstanceFactory.Params_NewCloudViaZmqPipelineProxies>(
                            d_
                        );
                    return Impatient.MaybeTailCall(
                        Impl.NewCloudViaZmqPipelineProxies(
                            in_.NumberOfInstances,
                            cancellationToken_
                        ),
                        proxyAddresses =>
                        {
                            var s_ =
                                SerializerState.CreateForRpc<Mas.Schema.Cluster.Cluster.ModelInstanceFactory.Result_NewCloudViaZmqPipelineProxies.WRITER>();
                            var r_ =
                                new Mas.Schema.Cluster.Cluster.ModelInstanceFactory.Result_NewCloudViaZmqPipelineProxies
                                {
            ...
            Task<AnswerOrCounterquestion> NewCloudViaProxy(
                DeserializerState d_,
                CancellationToken cancellationToken_
            )
            {
                ...
                {
                    var in_ =
                        CapnpSerializable.Create<Mas.Schema.Cluster.Cluster.ModelInstanceFactory.Params_NewCloudViaProxy>(
                            d_
                        );
                    return Impatient.MaybeTailCall(
                        Impl.NewCloudViaProxy(in_.NumberOfInstances, cancellationToken_),
                        proxy =>
                        {
                            var s_ =
                                SerializerState.CreateForRpc<Mas.Schema.Cluster.Cluster.ModelInstanceFactory.Result_NewCloudViaProxy.WRITER>();
                            var r_ =
                                new Mas.Schema.Cluster.Cluster.ModelInstanceFactory.Result_NewCloudViaProxy
                                {
                                    Proxy = proxy,
                                };
                            r_.serialize(s_);
            ...
            Task<AnswerOrCounterquestion> ModelId(
                DeserializerState d_,
                CancellationToken cancellationToken_
            )
            {
                ...
                {
                    return Impatient.MaybeTailCall(
                        Impl.ModelId(cancellationToken_),
                        id =>
                        {
                            var s_ =
                                SerializerState.CreateForRpc<Mas.Schema.Cluster.Cluster.ModelInstanceFactory.Result_ModelId.WRITER>();
                            var r_ =
                                new Mas.Schema.Cluster.Cluster.ModelInstanceFactory.Result_ModelId
                                {
                                    Id = id,
                                };
                            r_.serialize(s_);
            ...
            Task<AnswerOrCounterquestion> RegisterModelInstance(
                DeserializerState d_,
                CancellationToken cancellationToken_
            )
            {
                ...
                {
                    var in_ =
                        CapnpSerializable.Create<Mas.Schema.Cluster.Cluster.ModelInstanceFactory.Params_RegisterModelInstance>(
                            d_
                        );
                    return Impatient.MaybeTailCall(
                        Impl.RegisterModelInstance(
                            in_.Instance,
                            in_.RegistrationToken,
                            cancellationToken_
                        ),
                        unregister =>
                        {
                            var s_ =
                                SerializerState.CreateForRpc<Mas.Schema.Cluster.Cluster.ModelInstanceFactory.Result_RegisterModelInstance.WRITER>();
                            var r_ =
                                new Mas.Schema.Cluster.Cluster.ModelInstanceFactory.Result_RegisterModelInstance
                                {
                                    Unregister = unregister,
                                };
                            r_.serialize(s_);
            ...
            Task<AnswerOrCounterquestion> RestoreSturdyRef(
                DeserializerState d_,
                CancellationToken cancellationToken_
            )
            {
                ...
                {
                    var in_ =
                        CapnpSerializable.Create<Mas.Schema.Cluster.Cluster.ModelInstanceFactory.Params_RestoreSturdyRef>(
                            d_
                        );
                    return Impatient.MaybeTailCall(
                        Impl.RestoreSturdyRef(in_.SturdyRef, cancellationToken_),
                        cap =>
                        {
                            var s_ =
                                SerializerState.CreateForRpc<Mas.Schema.Cluster.Cluster.ModelInstanceFactory.Result_RestoreSturdyRef.WRITER>();
                            var r_ =
                                new Mas.Schema.Cluster.Cluster.ModelInstanceFactory.Result_RestoreSturdyRef
                                {
                                    Cap = cap,
                                };
                            r_.serialize(s_);
        ...
        public static class ModelInstanceFactory
        {
            ...
            public class Result_NewInstance : ICapnpSerializable
            {
                ...
                public struct READER
                {
                    ...
                    public Mas.Schema.Cluster.Cluster.IValueHolder<object> Instance =>
                        ctx.ReadCap<Mas.Schema.Cluster.Cluster.IValueHolder<object>>(0);
                }
            ...
            public class Result_NewInstances : ICapnpSerializable
            {
                ...
                public Mas.Schema.Cluster.Cluster.IValueHolder<
                    IReadOnlyList<Mas.Schema.Cluster.Cluster.IValueHolder<object>>
                > Instances { get; set; }
                ...
                public struct READER
                {
                    ...
                    public Mas.Schema.Cluster.Cluster.IValueHolder<
                        IReadOnlyList<Mas.Schema.Cluster.Cluster.IValueHolder<object>>
                    > Instances =>
                        ctx.ReadCap<Mas.Schema.Cluster.Cluster.IValueHolder<
                            IReadOnlyList<Mas.Schema.Cluster.Cluster.IValueHolder<object>>
                        >>(0);
                }
                ...
                public class WRITER : SerializerState
                {
                    ...
                    {
                        get =>
                            ReadCap<Mas.Schema.Cluster.Cluster.IValueHolder<
                                IReadOnlyList<Mas.Schema.Cluster.Cluster.IValueHolder<object>>
                            >>(0);
                        set => LinkObject(0, value);
                    }
            ...
            public class Result_NewCloudViaZmqPipelineProxies : ICapnpSerializable
            {
                ...
                public struct READER
                {
                    ...
                    public Mas.Schema.Cluster.Cluster.IValueHolder<Mas.Schema.Cluster.Cluster.ZmqPipelineAddresses> ProxyAddresses =>
                        ctx.ReadCap<Mas.Schema.Cluster.Cluster.IValueHolder<Mas.Schema.Cluster.Cluster.ZmqPipelineAddresses>>(
                            0
                        );
                }
                ...
                public class WRITER : SerializerState
                {
                    ...
                    {
                        get =>
                            ReadCap<Mas.Schema.Cluster.Cluster.IValueHolder<Mas.Schema.Cluster.Cluster.ZmqPipelineAddresses>>(
                                0
                            );
                        set => LinkObject(0, value);
                    }

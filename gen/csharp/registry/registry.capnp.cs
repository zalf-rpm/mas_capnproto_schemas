...
namespace Mas.Schema.Registry
{
    ...
    public interface IAdmin : Mas.Schema.Common.IIdentifiable
    {
        Task<bool> AddCategory(
            Mas.Schema.Common.IdInformation category,
            bool upsert,
            CancellationToken cancellationToken_ = default
        );
        Task<IReadOnlyList<Mas.Schema.Common.IIdentifiable>> RemoveCategory(
            string categoryId,
            string moveObjectsToCategoryId,
            CancellationToken cancellationToken_ = default
        );
        Task<IReadOnlyList<string>> MoveObjects(
            IReadOnlyList<string> objectIds,
            string toCatId,
            CancellationToken cancellationToken_ = default
        );
        Task<IReadOnlyList<Mas.Schema.Common.IIdentifiable>> RemoveObjects(
            IReadOnlyList<string> objectIds,
            CancellationToken cancellationToken_ = default
        );
        Task<Mas.Schema.Registry.IRegistry> Registry(
            CancellationToken cancellationToken_ = default
        );
    }
    ...
    public class Admin_Proxy : Proxy, IAdmin
    {
        ...
        {
            var in_ =
                SerializerState.CreateForRpc<Mas.Schema.Registry.Admin.Params_AddCategory.WRITER>();
        ...
        public Task<IReadOnlyList<Mas.Schema.Common.IIdentifiable>> RemoveCategory(
            string categoryId,
            string moveObjectsToCategoryId,
            CancellationToken cancellationToken_ = default
        )
        {
            var in_ =
                SerializerState.CreateForRpc<Mas.Schema.Registry.Admin.Params_RemoveCategory.WRITER>();
            ...
            return Impatient.MakePipelineAware(
                ...
                d_ =>
                {
                    ...
                    {
                        var r_ =
                            CapnpSerializable.Create<Mas.Schema.Registry.Admin.Result_RemoveCategory>(
                                d_
                            );
        ...
        public async Task<IReadOnlyList<string>> MoveObjects(
            IReadOnlyList<string> objectIds,
            string toCatId,
            CancellationToken cancellationToken_ = default
        )
        {
            var in_ =
                SerializerState.CreateForRpc<Mas.Schema.Registry.Admin.Params_MoveObjects.WRITER>();
        ...
        public Task<IReadOnlyList<Mas.Schema.Common.IIdentifiable>> RemoveObjects(
            IReadOnlyList<string> objectIds,
            CancellationToken cancellationToken_ = default
        )
        {
            var in_ =
                SerializerState.CreateForRpc<Mas.Schema.Registry.Admin.Params_RemoveObjects.WRITER>();
            ...
            return Impatient.MakePipelineAware(
                ...
                d_ =>
                {
                    ...
                    {
                        var r_ =
                            CapnpSerializable.Create<Mas.Schema.Registry.Admin.Result_RemoveObjects>(
                                d_
                            );
                        return (r_.RemovedObjects);
                    }
        ...
        public Task<Mas.Schema.Registry.IRegistry> Registry(
            CancellationToken cancellationToken_ = default
        )
        {
            var in_ =
                SerializerState.CreateForRpc<Mas.Schema.Registry.Admin.Params_Registry.WRITER>();
            ...
            return Impatient.MakePipelineAware(
                ...
                d_ =>
                {
                    ...
                    {
                        var r_ =
                            CapnpSerializable.Create<Mas.Schema.Registry.Admin.Result_Registry>(d_);
                        return (r_.Registry);
                    }
                }
            );
    ...
    public class Admin_Skeleton : Skeleton<IAdmin>
    {
        ...
        Task<AnswerOrCounterquestion> AddCategory(
        ...
        )
        {
            using (d_)
            {
                var in_ = CapnpSerializable.Create<Mas.Schema.Registry.Admin.Params_AddCategory>(
                    d_
                );
                return Impatient.MaybeTailCall(
                    Impl.AddCategory(in_.Category, in_.Upsert, cancellationToken_),
                    success =>
                    {
                        var s_ =
                            SerializerState.CreateForRpc<Mas.Schema.Registry.Admin.Result_AddCategory.WRITER>();
        ...
        Task<AnswerOrCounterquestion> RemoveCategory(
            DeserializerState d_,
            CancellationToken cancellationToken_
        )
        {
            using (d_)
            {
                var in_ = CapnpSerializable.Create<Mas.Schema.Registry.Admin.Params_RemoveCategory>(
                    d_
                );
                return Impatient.MaybeTailCall(
                    Impl.RemoveCategory(
                        in_.CategoryId,
                        in_.MoveObjectsToCategoryId,
                        cancellationToken_
                    ),
                    removedObjects =>
                    {
                        var s_ =
                            SerializerState.CreateForRpc<Mas.Schema.Registry.Admin.Result_RemoveCategory.WRITER>();
        ...
        Task<AnswerOrCounterquestion> MoveObjects(
            DeserializerState d_,
            CancellationToken cancellationToken_
        )
        {
            using (d_)
            {
                var in_ = CapnpSerializable.Create<Mas.Schema.Registry.Admin.Params_MoveObjects>(
                    d_
                );
                return Impatient.MaybeTailCall(
                    Impl.MoveObjects(in_.ObjectIds, in_.ToCatId, cancellationToken_),
                    movedObjectIds =>
                    {
                        var s_ =
                            SerializerState.CreateForRpc<Mas.Schema.Registry.Admin.Result_MoveObjects.WRITER>();
        ...
        Task<AnswerOrCounterquestion> RemoveObjects(
            DeserializerState d_,
            CancellationToken cancellationToken_
        )
        {
            using (d_)
            {
                var in_ = CapnpSerializable.Create<Mas.Schema.Registry.Admin.Params_RemoveObjects>(
                    d_
                );
                return Impatient.MaybeTailCall(
                    Impl.RemoveObjects(in_.ObjectIds, cancellationToken_),
                    removedObjects =>
                    {
                        var s_ =
                            SerializerState.CreateForRpc<Mas.Schema.Registry.Admin.Result_RemoveObjects.WRITER>();
        ...
        Task<AnswerOrCounterquestion> Registry(
            DeserializerState d_,
            CancellationToken cancellationToken_
        )
        {
            ...
            {
                return Impatient.MaybeTailCall(
                    Impl.Registry(cancellationToken_),
                    registry =>
                    {
                        var s_ =
                            SerializerState.CreateForRpc<Mas.Schema.Registry.Admin.Result_Registry.WRITER>();
    ...
    public static class Admin
    {
        ...
        public class Params_AddCategory : ICapnpSerializable
        {
            ...
            void ICapnpSerializable.Deserialize(DeserializerState arg_)
            {
                ...
                Category = CapnpSerializable.Create<Mas.Schema.Common.IdInformation>(
                    reader.Category
                );
            ...
            public struct READER
            {
                ...
                public Mas.Schema.Common.IdInformation.READER Category =>
        ...
        public class Result_Registry : ICapnpSerializable
        {
            ...
            public struct READER
            {
                ...
                public Mas.Schema.Registry.IRegistry Registry =>
                    ctx.ReadCap<Mas.Schema.Registry.IRegistry>(0);
            }
    ...
    {
        Task<IReadOnlyList<Mas.Schema.Common.IdInformation>> SupportedCategories(
            CancellationToken cancellationToken_ = default
        );
        Task<Mas.Schema.Common.IdInformation> CategoryInfo(
            string categoryId,
            CancellationToken cancellationToken_ = default
        );
        Task<IReadOnlyList<Mas.Schema.Registry.Registry.Entry>> Entries(
            string categoryId,
            CancellationToken cancellationToken_ = default
        );
    }
    ...
    public class Registry_Skeleton : Skeleton<IRegistry>
    {
        ...
        Task<AnswerOrCounterquestion> SupportedCategories(
            DeserializerState d_,
            CancellationToken cancellationToken_
        )
        {
            ...
            {
                return Impatient.MaybeTailCall(
                    Impl.SupportedCategories(cancellationToken_),
                    cats =>
                    {
                        var s_ =
                            SerializerState.CreateForRpc<Mas.Schema.Registry.Registry.Result_SupportedCategories.WRITER>();
        ...
        Task<AnswerOrCounterquestion> CategoryInfo(
            DeserializerState d_,
            CancellationToken cancellationToken_
        )
        {
            ...
            {
                var in_ =
                    CapnpSerializable.Create<Mas.Schema.Registry.Registry.Params_CategoryInfo>(d_);
                return Impatient.MaybeTailCall(
                    Impl.CategoryInfo(in_.CategoryId, cancellationToken_),
                    r_ =>
                    {
                        var s_ =
        ...
        Task<AnswerOrCounterquestion> Entries(
            DeserializerState d_,
            CancellationToken cancellationToken_
        )
        {
            using (d_)
            {
                ...
                return Impatient.MaybeTailCall(
                    Impl.Entries(in_.CategoryId, cancellationToken_),
                    entries =>
                    {
                        var s_ =
                            SerializerState.CreateForRpc<Mas.Schema.Registry.Registry.Result_Entries.WRITER>();
    ...
    public static class Registry
    {
        ...
        public class Entry : ICapnpSerializable
        {
            ...
            public struct READER
            {
                ...
                public Mas.Schema.Common.IIdentifiable Ref =>
                    ctx.ReadCap<Mas.Schema.Common.IIdentifiable>(1);
        ...
        public class Result_SupportedCategories : ICapnpSerializable
        {
            ...
            {
                var reader = READER.create(arg_);
                Cats = reader.Cats?.ToReadOnlyList(_ =>
            ...
            public struct READER
            {
                ...
                public IReadOnlyList<Mas.Schema.Common.IdInformation.READER> Cats =>
        ...
        public class Result_Entries : ICapnpSerializable
        {
            ...
            void ICapnpSerializable.Deserialize(DeserializerState arg_)
            {
                ...
                Entries = reader.Entries?.ToReadOnlyList(_ =>
                    CapnpSerializable.Create<Mas.Schema.Registry.Registry.Entry>(_)
                );
                applyDefaults();
            }
            ...
            public struct READER
            {
                ...
                public IReadOnlyList<Mas.Schema.Registry.Registry.Entry.READER> Entries =>
                    ctx.ReadList(0).Cast(Mas.Schema.Registry.Registry.Entry.READER.create);
            ...
            public class WRITER : SerializerState
            {
                ...
                public ListOfStructsSerializer<Mas.Schema.Registry.Registry.Entry.WRITER> Entries
                {
                    get =>
                        BuildPointer<
                            ListOfStructsSerializer<Mas.Schema.Registry.Registry.Entry.WRITER>
                        >(0);
                    set => Link(0, value);
                }
            }
    ...
    {
        Task<(
            Mas.Schema.Registry.Registrar.IUnregister,
            Mas.Schema.Persistence.SturdyRef
        )> Register(
            Mas.Schema.Registry.Registrar.RegParams arg_,
            CancellationToken cancellationToken_ = default
        );
    }
    ...
    public class Registrar_Proxy : Proxy, IRegistrar
    {
        ...
        {
            var in_ =
                SerializerState.CreateForRpc<Mas.Schema.Registry.Registrar.RegParams.WRITER>();
            arg_?.serialize(in_);
            return Impatient.MakePipelineAware(
                Call(
                    12371099263448568298UL,
                    0,
                    in_.Rewrap<DynamicSerializerState>(),
                    false,
                    cancellationToken_
                ...
                d_ =>
                {
                    ...
                    {
                        var r_ =
                            CapnpSerializable.Create<Mas.Schema.Registry.Registrar.Result_Register>(
                                d_
                            );
    ...
    public class Registrar_Skeleton : Skeleton<IRegistrar>
    {
        ...
        )
        {
            using (d_)
            {
                return Impatient.MaybeTailCall(
                    Impl.Register(
                        CapnpSerializable.Create<Mas.Schema.Registry.Registrar.RegParams>(d_),
                        cancellationToken_
                    ),
                    (unreg, reregSR) =>
                    {
                        var s_ =
                            SerializerState.CreateForRpc<Mas.Schema.Registry.Registrar.Result_Register.WRITER>();
    ...
    public static class Registrar
    {
        ...
        public class CrossDomainRestore : ICapnpSerializable
        {
            ...
            public struct READER
            {
                ...
                public Mas.Schema.Persistence.VatId.READER VatId =>
                ...
                public Mas.Schema.Persistence.IRestorer Restorer =>
                    ctx.ReadCap<Mas.Schema.Persistence.IRestorer>(1);
            }
        ...
        public class RegParams : ICapnpSerializable
        {
            ...
            void ICapnpSerializable.Deserialize(DeserializerState arg_)
            {
                ...
                CategoryId = reader.CategoryId;
                XDomain =
                    CapnpSerializable.Create<Mas.Schema.Registry.Registrar.CrossDomainRestore>(
                        reader.XDomain
                    );
                applyDefaults();
            }
            ...
            public struct READER
            {
                ...
                public Mas.Schema.Registry.Registrar.CrossDomainRestore.READER XDomain =>
                    ctx.ReadStruct(
                        3,
                        Mas.Schema.Registry.Registrar.CrossDomainRestore.READER.create
                    );
        ...
        public class Unregister_Proxy : Proxy, IUnregister
        {
            ...
            {
                var in_ =
                    SerializerState.CreateForRpc<Mas.Schema.Registry.Registrar.Unregister.Params_Unregister.WRITER>();
                var arg_ = new Mas.Schema.Registry.Registrar.Unregister.Params_Unregister() { };
                arg_?.serialize(in_);
                using (
                    var d_ = await Call(
                        14364651318647358601UL,
                        0,
                        in_.Rewrap<DynamicSerializerState>(),
                        false,
                        cancellationToken_
                ...
                {
                    var r_ =
                        CapnpSerializable.Create<Mas.Schema.Registry.Registrar.Unregister.Result_Unregister>(
                            d_
                        );
                    return (r_.Success);
                }
            ...
            )
            {
                using (d_)
                {
                    return Impatient.MaybeTailCall(
                        ...
                        {
                            var s_ =
                                SerializerState.CreateForRpc<Mas.Schema.Registry.Registrar.Unregister.Result_Unregister.WRITER>();
        ...
        public class Result_Register : ICapnpSerializable
        {
            ...
            void ICapnpSerializable.Deserialize(DeserializerState arg_)
            {
                var reader = READER.create(arg_);
                Unreg = reader.Unreg;
                ReregSR = CapnpSerializable.Create<Mas.Schema.Persistence.SturdyRef>(
                    reader.ReregSR
                );
                applyDefaults();
            }
            ...
            public struct READER
            {
                ...
                public Mas.Schema.Registry.Registrar.IUnregister Unreg =>
                    ctx.ReadCap<Mas.Schema.Registry.Registrar.IUnregister>(0);
                public Mas.Schema.Persistence.SturdyRef.READER ReregSR =>

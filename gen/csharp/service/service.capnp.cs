...
namespace Mas.Schema.Service
{
    ...
    public interface IAdmin : Mas.Schema.Common.IIdentifiable
    {
        ...
        Task<IReadOnlyList<Mas.Schema.Common.IdInformation>> Identities(
            CancellationToken cancellationToken_ = default
        );
        Task UpdateIdentity(
            string oldId,
            Mas.Schema.Common.IdInformation newInfo,
            CancellationToken cancellationToken_ = default
        );
    }
    ...
    public class Admin_Proxy : Proxy, IAdmin
    {
        ...
        {
            var in_ =
                SerializerState.CreateForRpc<Mas.Schema.Service.Admin.Params_Heartbeat.WRITER>();
            var arg_ = new Mas.Schema.Service.Admin.Params_Heartbeat() { };
            arg_?.serialize(in_);
            using (
                var d_ = await Call(
                    18357226832451728969UL,
                    0,
        ...
        {
            var in_ =
                SerializerState.CreateForRpc<Mas.Schema.Service.Admin.Params_SetTimeout.WRITER>();
            var arg_ = new Mas.Schema.Service.Admin.Params_SetTimeout() { Seconds = seconds };
            arg_?.serialize(in_);
            using (
                var d_ = await Call(
                    18357226832451728969UL,
        ...
        public async Task<IReadOnlyList<Mas.Schema.Common.IdInformation>> Identities(
            CancellationToken cancellationToken_ = default
        )
        {
            var in_ =
                SerializerState.CreateForRpc<Mas.Schema.Service.Admin.Params_Identities.WRITER>();
        ...
        {
            var in_ =
                SerializerState.CreateForRpc<Mas.Schema.Service.Admin.Params_UpdateIdentity.WRITER>();
            ...
            {
                var r_ = CapnpSerializable.Create<Mas.Schema.Service.Admin.Result_UpdateIdentity>(
                    d_
                );
                return;
            }
    ...
    public class Admin_Skeleton : Skeleton<IAdmin>
    {
        ...
        async Task<AnswerOrCounterquestion> Heartbeat(
        ...
        )
        {
            using (d_)
            {
                ...
                var s_ =
                    SerializerState.CreateForRpc<Mas.Schema.Service.Admin.Result_Heartbeat.WRITER>();
                return s_;
            }
        }

        async Task<AnswerOrCounterquestion> SetTimeout(
            DeserializerState d_,
            CancellationToken cancellationToken_
        )
        {
            using (d_)
            {
                ...
                var s_ =
                    SerializerState.CreateForRpc<Mas.Schema.Service.Admin.Result_SetTimeout.WRITER>();
                return s_;
            }
        }
        ...
        )
        {
            using (d_)
            {
                ...
                var s_ =
                    SerializerState.CreateForRpc<Mas.Schema.Service.Admin.Result_Stop.WRITER>();
                return s_;
            }
        }

        Task<AnswerOrCounterquestion> Identities(
            DeserializerState d_,
            CancellationToken cancellationToken_
        )
        {
            using (d_)
            {
                return Impatient.MaybeTailCall(
                    Impl.Identities(cancellationToken_),
                    infos =>
                    {
                        var s_ =
                            SerializerState.CreateForRpc<Mas.Schema.Service.Admin.Result_Identities.WRITER>();
        ...
        async Task<AnswerOrCounterquestion> UpdateIdentity(
            DeserializerState d_,
            CancellationToken cancellationToken_
        )
        {
            using (d_)
            {
                var in_ = CapnpSerializable.Create<Mas.Schema.Service.Admin.Params_UpdateIdentity>(
                    d_
                );
                await Impl.UpdateIdentity(in_.OldId, in_.NewInfo, cancellationToken_);
                var s_ =
                    SerializerState.CreateForRpc<Mas.Schema.Service.Admin.Result_UpdateIdentity.WRITER>();
                return s_;
            }
        }
    }
    ...
    public static class Admin
    {
        ...
        public class Result_Identities : ICapnpSerializable
        {
            ...
            {
                var reader = READER.create(arg_);
                Infos = reader.Infos?.ToReadOnlyList(_ =>
            ...
            public struct READER
            {
                ...
                public IReadOnlyList<Mas.Schema.Common.IdInformation.READER> Infos =>
        ...
        public class Params_UpdateIdentity : ICapnpSerializable
        {
            ...
            public struct READER
            {
                ...
                public Mas.Schema.Common.IdInformation.READER NewInfo =>
                    ctx.ReadStruct(1, Mas.Schema.Common.IdInformation.READER.create);
    ...
    {
        Task<IReadOnlyList<Mas.Schema.Common.IIdentifiable>> Create(
            CancellationToken cancellationToken_ = default
        );
    }
    ...
    {
        public Task<IReadOnlyList<Mas.Schema.Common.IIdentifiable>> Create(
            CancellationToken cancellationToken_ = default
        )
        {
            var in_ =
                SerializerState.CreateForRpc<Mas.Schema.Service.SimpleFactory.Params_Create.WRITER>();
            var arg_ = new Mas.Schema.Service.SimpleFactory.Params_Create() { };
            arg_?.serialize(in_);
            return Impatient.MakePipelineAware(
                Call(
                    12368435515802915787UL,
                    0,
                    in_.Rewrap<DynamicSerializerState>(),
                    false,
                    cancellationToken_
                ...
                d_ =>
                {
                    ...
                    {
                        var r_ =
                            CapnpSerializable.Create<Mas.Schema.Service.SimpleFactory.Result_Create>(
                                d_
                            );
                        return (r_.Caps);
                    }
        ...
        )
        {
            using (d_)
            {
                return Impatient.MaybeTailCall(
                    ...
                    {
                        var s_ =
                            SerializerState.CreateForRpc<Mas.Schema.Service.SimpleFactory.Result_Create.WRITER>();
    ...
    {
        Task<Mas.Schema.Service.Factory<TPayload>.AccessInfo> Create(
            Mas.Schema.Service.Factory<TPayload>.CreateParams arg_,
            CancellationToken cancellationToken_ = default
        );
        Task<IReadOnlyList<string>> ServiceInterfaceNames(
            CancellationToken cancellationToken_ = default
        );
    }
    ...
    public class Factory_Proxy<TPayload> : Proxy, IFactory<TPayload>
        where TPayload : class
    {
        public Task<Mas.Schema.Service.Factory<TPayload>.AccessInfo> Create(
            Mas.Schema.Service.Factory<TPayload>.CreateParams arg_,
            CancellationToken cancellationToken_ = default
        )
        {
            var in_ =
                SerializerState.CreateForRpc<Mas.Schema.Service.Factory<TPayload>.CreateParams.WRITER>();
            arg_?.serialize(in_);
            return Impatient.MakePipelineAware(
                Call(
                    9993747855068011647UL,
                    0,
                    in_.Rewrap<DynamicSerializerState>(),
                    false,
                    cancellationToken_
                ...
                d_ =>
                {
                    ...
                    {
                        var r_ =
                            CapnpSerializable.Create<Mas.Schema.Service.Factory<TPayload>.AccessInfo>(
                                d_
                            );
                        return r_;
                    }
        ...
        public async Task<IReadOnlyList<string>> ServiceInterfaceNames(
            CancellationToken cancellationToken_ = default
        )
        {
            var in_ =
                SerializerState.CreateForRpc<Mas.Schema.Service.Factory<TPayload>.Params_ServiceInterfaceNames.WRITER>();
            ...
            {
                var r_ =
                    CapnpSerializable.Create<Mas.Schema.Service.Factory<TPayload>.Result_ServiceInterfaceNames>(
                        d_
                    );
                return (r_.Names);
            }
    ...
    public class Factory_Skeleton<TPayload> : Skeleton<IFactory<TPayload>>
        where TPayload : class
    {
        ...
        )
        {
            using (d_)
            {
                return Impatient.MaybeTailCall(
                    Impl.Create(
                        CapnpSerializable.Create<Mas.Schema.Service.Factory<TPayload>.CreateParams>(
                            d_
                        ),
                        cancellationToken_
                    ),
                    ...
                    {
                        var s_ =
                            SerializerState.CreateForRpc<Mas.Schema.Service.Factory<TPayload>.AccessInfo.WRITER>();
                        r_.serialize(s_);
                        return s_;
                    }
                );
        ...
        Task<AnswerOrCounterquestion> ServiceInterfaceNames(
            DeserializerState d_,
            CancellationToken cancellationToken_
        )
        {
            ...
            {
                return Impatient.MaybeTailCall(
                    Impl.ServiceInterfaceNames(cancellationToken_),
                    names =>
                    {
                        var s_ =
                            SerializerState.CreateForRpc<Mas.Schema.Service.Factory<TPayload>.Result_ServiceInterfaceNames.WRITER>();
                        var r_ =
                            new Mas.Schema.Service.Factory<TPayload>.Result_ServiceInterfaceNames
                            {
                                Names = names,
                            };
                        r_.serialize(s_);
        ...
        where TPayload : class
    {
        ...
        public class CreateParams : ICapnpSerializable
        {
            ...
            void ICapnpSerializable.Deserialize(DeserializerState arg_)
            {
                ...
                InterfaceNameToRegistrySR = reader.InterfaceNameToRegistrySR?.ToReadOnlyList(_ =>
            ...
            public void serialize(WRITER writer)
            {
                ...
                writer.InterfaceNameToRegistrySR.Init(
            ...
            public struct READER
            {
                ...
                public IReadOnlyList<Mas.Schema.Common.Pair<
                    string,
                    string
                >.READER> InterfaceNameToRegistrySR =>
                    ctx.ReadList(0).Cast(Mas.Schema.Common.Pair<string, string>.READER.create);
            ...
            public class WRITER : SerializerState
            {
                ...
                public ListOfStructsSerializer<Mas.Schema.Common.Pair<
                    string,
                    string
                >.WRITER> InterfaceNameToRegistrySR
                {
                    get =>
                        BuildPointer<
        ...
        public class AccessInfo : ICapnpSerializable
        {
            ...
            public struct READER
            {
                ...
                public IReadOnlyList<Mas.Schema.Common.IIdentifiable> ServiceCaps =>
                    ctx.ReadCapList<Mas.Schema.Common.IIdentifiable>(1);
        ...
        )
        {
            using (d_)
            {
                return Impatient.MaybeTailCall(
                    ...
                    {
                        var s_ =
                            SerializerState.CreateForRpc<Mas.Schema.Service.Stoppable.Result_Stop.WRITER>();

...
namespace Mas.Schema.Model.Monica
{
    ...
    public class CropSpec : ICapnpSerializable
    {
        ...
        public class WRITER : SerializerState
        {
            ...
            public Mas.Schema.Model.Monica.CropParameters.WRITER CropParams { get => BuildPointer<Mas.Schema.Model.Monica.CropParameters.WRITER>(0); set => Link(0, value); }
            public Mas.Schema.Model.Monica.CropResidueParameters.WRITER ResidueParams { get => BuildPointer<Mas.Schema.Model.Monica.CropResidueParameters.WRITER>(1); set => Link(1, value); }
        }
    }
    ...
    public class CropParameters : ICapnpSerializable
    {
        ...
        public class WRITER : SerializerState
        {
            ...
            public Mas.Schema.Model.Monica.SpeciesParameters.WRITER SpeciesParams { get => BuildPointer<Mas.Schema.Model.Monica.SpeciesParameters.WRITER>(0); set => Link(0, value); }
            public Mas.Schema.Model.Monica.CultivarParameters.WRITER CultivarParams { get => BuildPointer<Mas.Schema.Model.Monica.CultivarParameters.WRITER>(1); set => Link(1, value); }
        }
    }
    ...
    public class SpeciesParameters : ICapnpSerializable
    {
        ...
        public class WRITER : SerializerState
        {
            ...
            public string SpeciesId { get => this.ReadText(0, null); set => this.WriteText(0, value, null); }
            public byte CarboxylationPathway { get => this.ReadDataByte(0UL, (byte)0); set => this.WriteData(0UL, value, (byte)0); }
            public double DefaultRadiationUseEfficiency { get => this.ReadDataDouble(64UL, 0); set => this.WriteData(64UL, value, 0); }
            public double PartBiologicalNFixation { get => this.ReadDataDouble(128UL, 0); set => this.WriteData(128UL, value, 0); }
            public double InitialKcFactor { get => this.ReadDataDouble(192UL, 0); set => this.WriteData(192UL, value, 0); }
            public double LuxuryNCoeff { get => this.ReadDataDouble(256UL, 0); set => this.WriteData(256UL, value, 0); }
            public double MaxCropDiameter { get => this.ReadDataDouble(320UL, 0); set => this.WriteData(320UL, value, 0); }
            public double StageAtMaxHeight { get => this.ReadDataDouble(384UL, 0); set => this.WriteData(384UL, value, 0); }
            public double StageAtMaxDiameter { get => this.ReadDataDouble(448UL, 0); set => this.WriteData(448UL, value, 0); }
            public double MinimumNConcentration { get => this.ReadDataDouble(512UL, 0); set => this.WriteData(512UL, value, 0); }
            public double MinimumTemperatureForAssimilation { get => this.ReadDataDouble(576UL, 0); set => this.WriteData(576UL, value, 0); }
            public double OptimumTemperatureForAssimilation { get => this.ReadDataDouble(640UL, 0); set => this.WriteData(640UL, value, 0); }
            public double MaximumTemperatureForAssimilation { get => this.ReadDataDouble(704UL, 0); set => this.WriteData(704UL, value, 0); }
            public double NConcentrationAbovegroundBiomass { get => this.ReadDataDouble(768UL, 0); set => this.WriteData(768UL, value, 0); }
            public double NConcentrationB0 { get => this.ReadDataDouble(832UL, 0); set => this.WriteData(832UL, value, 0); }
            public double NConcentrationPN { get => this.ReadDataDouble(896UL, 0); set => this.WriteData(896UL, value, 0); }
            public double NConcentrationRoot { get => this.ReadDataDouble(960UL, 0); set => this.WriteData(960UL, value, 0); }
            public ushort DevelopmentAccelerationByNitrogenStress { get => this.ReadDataUShort(16UL, (ushort)0); set => this.WriteData(16UL, value, (ushort)0); }
            public double FieldConditionModifier { get => this.ReadDataDouble(1024UL, 1); set => this.WriteData(1024UL, value, 1); }
            public double AssimilateReallocation { get => this.ReadDataDouble(1088UL, 0); set => this.WriteData(1088UL, value, 0); }
            public ListOfPrimitivesSerializer<double> BaseTemperature { get => BuildPointer<ListOfPrimitivesSerializer<double>>(1); set => Link(1, value); }
            public ListOfPrimitivesSerializer<double> OrganMaintenanceRespiration { get => BuildPointer<ListOfPrimitivesSerializer<double>>(2); set => Link(2, value); }
            public ListOfPrimitivesSerializer<double> OrganGrowthRespiration { get => BuildPointer<ListOfPrimitivesSerializer<double>>(3); set => Link(3, value); }
            public ListOfPrimitivesSerializer<double> StageMaxRootNConcentration { get => BuildPointer<ListOfPrimitivesSerializer<double>>(4); set => Link(4, value); }
            public ListOfPrimitivesSerializer<double> InitialOrganBiomass { get => BuildPointer<ListOfPrimitivesSerializer<double>>(5); set => Link(5, value); }
            public ListOfPrimitivesSerializer<double> CriticalOxygenContent { get => BuildPointer<ListOfPrimitivesSerializer<double>>(6); set => Link(6, value); }
            public ListOfPrimitivesSerializer<double> StageMobilFromStorageCoeff { get => BuildPointer<ListOfPrimitivesSerializer<double>>(7); set => Link(7, value); }
            public ListOfBitsSerializer AbovegroundOrgan { get => BuildPointer<ListOfBitsSerializer>(8); set => Link(8, value); }
            public ListOfBitsSerializer StorageOrgan { get => BuildPointer<ListOfBitsSerializer>(9); set => Link(9, value); }
            public double SamplingDepth { get => this.ReadDataDouble(1152UL, 0); set => this.WriteData(1152UL, value, 0); }
            public double TargetNSamplingDepth { get => this.ReadDataDouble(1216UL, 0); set => this.WriteData(1216UL, value, 0); }
            public double TargetN30 { get => this.ReadDataDouble(1280UL, 0); set => this.WriteData(1280UL, value, 0); }
            public double MaxNUptakeParam { get => this.ReadDataDouble(1344UL, 0); set => this.WriteData(1344UL, value, 0); }
            public double RootDistributionParam { get => this.ReadDataDouble(1408UL, 0); set => this.WriteData(1408UL, value, 0); }
            public ushort PlantDensity { get => this.ReadDataUShort(32UL, (ushort)0); set => this.WriteData(32UL, value, (ushort)0); }
            public double RootGrowthLag { get => this.ReadDataDouble(1472UL, 0); set => this.WriteData(1472UL, value, 0); }
            public double MinimumTemperatureRootGrowth { get => this.ReadDataDouble(1536UL, 0); set => this.WriteData(1536UL, value, 0); }
            public double InitialRootingDepth { get => this.ReadDataDouble(1600UL, 0); set => this.WriteData(1600UL, value, 0); }
            public double RootPenetrationRate { get => this.ReadDataDouble(1664UL, 0); set => this.WriteData(1664UL, value, 0); }
            public double RootFormFactor { get => this.ReadDataDouble(1728UL, 0); set => this.WriteData(1728UL, value, 0); }
            public double SpecificRootLength { get => this.ReadDataDouble(1792UL, 0); set => this.WriteData(1792UL, value, 0); }
            public ushort StageAfterCut { get => this.ReadDataUShort(48UL, (ushort)0); set => this.WriteData(48UL, value, (ushort)0); }
            public double LimitingTemperatureHeatStress { get => this.ReadDataDouble(1856UL, 0); set => this.WriteData(1856UL, value, 0); }
            public ushort CuttingDelayDays { get => this.ReadDataUShort(1920UL, (ushort)0); set => this.WriteData(1920UL, value, (ushort)0); }
            public double DroughtImpactOnFertilityFactor { get => this.ReadDataDouble(1984UL, 0); set => this.WriteData(1984UL, value, 0); }
            public double EfMono { get => this.ReadDataDouble(2048UL, 0.5); set => this.WriteData(2048UL, value, 0.5); }
            public double EfMonos { get => this.ReadDataDouble(2112UL, 0.5); set => this.WriteData(2112UL, value, 0.5); }
            public double EfIso { get => this.ReadDataDouble(2176UL, 0); set => this.WriteData(2176UL, value, 0); }
            public double VcMax25 { get => this.ReadDataDouble(2240UL, 0); set => this.WriteData(2240UL, value, 0); }
            public double Aekc { get => this.ReadDataDouble(2304UL, 65800); set => this.WriteData(2304UL, value, 65800); }
            public double Aeko { get => this.ReadDataDouble(2368UL, 1400); set => this.WriteData(2368UL, value, 1400); }
            public double Aevc { get => this.ReadDataDouble(2432UL, 68800); set => this.WriteData(2432UL, value, 68800); }
            public double Kc25 { get => this.ReadDataDouble(2496UL, 460); set => this.WriteData(2496UL, value, 460); }
            public double Ko25 { get => this.ReadDataDouble(2560UL, 330); set => this.WriteData(2560UL, value, 330); }
            public short TransitionStageLeafExp { get => this.ReadDataShort(1936UL, (short)-1); set => this.WriteData(1936UL, value, (short)-1); }
        }
    }
    ...
    public class CultivarParameters : ICapnpSerializable
    {
        ...
        public class WRITER : SerializerState
        {
            ...
            public string CultivarId { get => this.ReadText(0, null); set => this.WriteText(0, value, null); }
            public string Description { get => this.ReadText(1, null); set => this.WriteText(1, value, null); }
            public bool Perennial { get => this.ReadDataBool(0UL, false); set => this.WriteData(0UL, value, false); }
            public double MaxAssimilationRate { get => this.ReadDataDouble(64UL, 0); set => this.WriteData(64UL, value, 0); }
            public double MaxCropHeight { get => this.ReadDataDouble(128UL, 0); set => this.WriteData(128UL, value, 0); }
            public double ResidueNRatio { get => this.ReadDataDouble(192UL, 0); set => this.WriteData(192UL, value, 0); }
            public double Lt50cultivar { get => this.ReadDataDouble(256UL, 0); set => this.WriteData(256UL, value, 0); }
            public double CropHeightP1 { get => this.ReadDataDouble(320UL, 0); set => this.WriteData(320UL, value, 0); }
            public double CropHeightP2 { get => this.ReadDataDouble(384UL, 0); set => this.WriteData(384UL, value, 0); }
            public double CropSpecificMaxRootingDepth { get => this.ReadDataDouble(448UL, 0); set => this.WriteData(448UL, value, 0); }
            public ListOfPointersSerializer<ListOfPrimitivesSerializer<double>> AssimilatePartitioningCoeff { get => BuildPointer<ListOfPointersSerializer<ListOfPrimitivesSerializer<double>>>(2); set => Link(2, value); }
            public ListOfPointersSerializer<ListOfPrimitivesSerializer<double>> OrganSenescenceRate { get => BuildPointer<ListOfPointersSerializer<ListOfPrimitivesSerializer<double>>>(3); set => Link(3, value); }
            public ListOfPrimitivesSerializer<double> BaseDaylength { get => BuildPointer<ListOfPrimitivesSerializer<double>>(4); set => Link(4, value); }
            public ListOfPrimitivesSerializer<double> OptimumTemperature { get => BuildPointer<ListOfPrimitivesSerializer<double>>(5); set => Link(5, value); }
            public ListOfPrimitivesSerializer<double> DaylengthRequirement { get => BuildPointer<ListOfPrimitivesSerializer<double>>(6); set => Link(6, value); }
            public ListOfPrimitivesSerializer<double> DroughtStressThreshold { get => BuildPointer<ListOfPrimitivesSerializer<double>>(7); set => Link(7, value); }
            public ListOfPrimitivesSerializer<double> SpecificLeafArea { get => BuildPointer<ListOfPrimitivesSerializer<double>>(8); set => Link(8, value); }
            public ListOfPrimitivesSerializer<double> StageKcFactor { get => BuildPointer<ListOfPrimitivesSerializer<double>>(9); set => Link(9, value); }
            public ListOfPrimitivesSerializer<double> StageTemperatureSum { get => BuildPointer<ListOfPrimitivesSerializer<double>>(10); set => Link(10, value); }
            public ListOfPrimitivesSerializer<double> VernalisationRequirement { get => BuildPointer<ListOfPrimitivesSerializer<double>>(11); set => Link(11, value); }
            public double HeatSumIrrigationStart { get => this.ReadDataDouble(512UL, 0); set => this.WriteData(512UL, value, 0); }
            public double HeatSumIrrigationEnd { get => this.ReadDataDouble(576UL, 0); set => this.WriteData(576UL, value, 0); }
            public double CriticalTemperatureHeatStress { get => this.ReadDataDouble(640UL, 0); set => this.WriteData(640UL, value, 0); }
            public double BeginSensitivePhaseHeatStress { get => this.ReadDataDouble(704UL, 0); set => this.WriteData(704UL, value, 0); }
            public double EndSensitivePhaseHeatStress { get => this.ReadDataDouble(768UL, 0); set => this.WriteData(768UL, value, 0); }
            public double FrostHardening { get => this.ReadDataDouble(832UL, 0); set => this.WriteData(832UL, value, 0); }
            public double FrostDehardening { get => this.ReadDataDouble(896UL, 0); set => this.WriteData(896UL, value, 0); }
            public double LowTemperatureExposure { get => this.ReadDataDouble(960UL, 0); set => this.WriteData(960UL, value, 0); }
            public double RespiratoryStress { get => this.ReadDataDouble(1024UL, 0); set => this.WriteData(1024UL, value, 0); }
            public short LatestHarvestDoy { get => this.ReadDataShort(16UL, (short)-1); set => this.WriteData(16UL, value, (short)-1); }
            public ListOfStructsSerializer<Mas.Schema.Model.Monica.YieldComponent.WRITER> OrganIdsForPrimaryYield { get => BuildPointer<ListOfStructsSerializer<Mas.Schema.Model.Monica.YieldComponent.WRITER>>(12); set => Link(12, value); }
            public ListOfStructsSerializer<Mas.Schema.Model.Monica.YieldComponent.WRITER> OrganIdsForSecondaryYield { get => BuildPointer<ListOfStructsSerializer<Mas.Schema.Model.Monica.YieldComponent.WRITER>>(13); set => Link(13, value); }
            public ListOfStructsSerializer<Mas.Schema.Model.Monica.YieldComponent.WRITER> OrganIdsForCutting { get => BuildPointer<ListOfStructsSerializer<Mas.Schema.Model.Monica.YieldComponent.WRITER>>(14); set => Link(14, value); }
            public double EarlyRefLeafExp { get => this.ReadDataDouble(1088UL, 12); set => this.WriteData(1088UL, value, 12); }
            public double RefLeafExp { get => this.ReadDataDouble(1152UL, 20); set => this.WriteData(1152UL, value, 20); }
            public double MinTempDevWE { get => this.ReadDataDouble(1216UL, 0); set => this.WriteData(1216UL, value, 0); }
            public double OptTempDevWE { get => this.ReadDataDouble(1280UL, 0); set => this.WriteData(1280UL, value, 0); }
            public double MaxTempDevWE { get => this.ReadDataDouble(1344UL, 0); set => this.WriteData(1344UL, value, 0); }
            public bool WinterCrop { get => this.ReadDataBool(1UL, false); set => this.WriteData(1UL, value, false); }
        }
    }
    ...
    public class YieldComponent : ICapnpSerializable
    {
        ...
        public class WRITER : SerializerState
        {
            ...
            public long OrganId { get => this.ReadDataLong(0UL, -1L); set => this.WriteData(0UL, value, -1L); }
            public double YieldPercentage { get => this.ReadDataDouble(64UL, 0); set => this.WriteData(64UL, value, 0); }
            public double YieldDryMatter { get => this.ReadDataDouble(128UL, 0); set => this.WriteData(128UL, value, 0); }
        }
    }
    ...
    public class AutomaticHarvestParameters : ICapnpSerializable
    {
        ...
        public Mas.Schema.Model.Monica.AutomaticHarvestParameters.HarvestTime TheHarvestTime { get; set; } = Mas.Schema.Model.Monica.AutomaticHarvestParameters.HarvestTime.unknown;
        public short LatestHarvestDOY { get; set; } = -1;
        ...
        public class WRITER : SerializerState
        {
            ...
            public Mas.Schema.Model.Monica.AutomaticHarvestParameters.HarvestTime TheHarvestTime { get => (Mas.Schema.Model.Monica.AutomaticHarvestParameters.HarvestTime)this.ReadDataUShort(0UL, (ushort)1); set => this.WriteData(0UL, (ushort)value, (ushort)1); }
            public short LatestHarvestDOY { get => this.ReadDataShort(16UL, (short)-1); set => this.WriteData(16UL, value, (short)-1); }
        }
    ...
    public class NMinCropParameters : ICapnpSerializable
    {
        ...
        public class WRITER : SerializerState
        {
            ...
            public double NTarget { get => this.ReadDataDouble(64UL, 0); set => this.WriteData(64UL, value, 0); }
            public double NTarget30 { get => this.ReadDataDouble(128UL, 0); set => this.WriteData(128UL, value, 0); }
        }
    }
    ...
    public class NMinApplicationParameters : ICapnpSerializable
    {
        ...
        public class WRITER : SerializerState
        {
            ...
            public double Min { get => this.ReadDataDouble(0UL, 0); set => this.WriteData(0UL, value, 0); }
            public double Max { get => this.ReadDataDouble(64UL, 0); set => this.WriteData(64UL, value, 0); }
            public ushort DelayInDays { get => this.ReadDataUShort(128UL, (ushort)0); set => this.WriteData(128UL, value, (ushort)0); }
        }
    }
    ...
    public class CropResidueParameters : ICapnpSerializable
    {
        ...
        public class WRITER : SerializerState
        {
            ...
            public Mas.Schema.Model.Monica.Params.OrganicFertilization.OrganicMatterParameters.WRITER Params { get => BuildPointer<Mas.Schema.Model.Monica.Params.OrganicFertilization.OrganicMatterParameters.WRITER>(0); set => Link(0, value); }
            public string Species { get => this.ReadText(1, null); set => this.WriteText(1, value, null); }
            public string ResidueType { get => this.ReadText(2, null); set => this.WriteText(2, value, null); }
        }
    }
    ...
    public class SoilParameters : ICapnpSerializable
    {
        ...
        public class WRITER : SerializerState
        {
            ...
            public double SoilSandContent { get => this.ReadDataDouble(0UL, -1); set => this.WriteData(0UL, value, -1); }
            public double SoilClayContent { get => this.ReadDataDouble(64UL, -1); set => this.WriteData(64UL, value, -1); }
            public double SoilpH { get => this.ReadDataDouble(128UL, 6.9); set => this.WriteData(128UL, value, 6.9); }
            public double SoilStoneContent { get => this.ReadDataDouble(192UL, 0); set => this.WriteData(192UL, value, 0); }
            public double Lambda { get => this.ReadDataDouble(256UL, -1); set => this.WriteData(256UL, value, -1); }
            public double FieldCapacity { get => this.ReadDataDouble(320UL, -1); set => this.WriteData(320UL, value, -1); }
            public double Saturation { get => this.ReadDataDouble(384UL, -1); set => this.WriteData(384UL, value, -1); }
            public double PermanentWiltingPoint { get => this.ReadDataDouble(448UL, -1); set => this.WriteData(448UL, value, -1); }
            public string SoilTexture { get => this.ReadText(0, null); set => this.WriteText(0, value, null); }
            public double SoilAmmonium { get => this.ReadDataDouble(512UL, 0.0005); set => this.WriteData(512UL, value, 0.0005); }
            public double SoilNitrate { get => this.ReadDataDouble(576UL, 0.005); set => this.WriteData(576UL, value, 0.005); }
            public double SoilCNRatio { get => this.ReadDataDouble(640UL, 10); set => this.WriteData(640UL, value, 10); }
            public double SoilMoisturePercentFC { get => this.ReadDataDouble(704UL, 100); set => this.WriteData(704UL, value, 100); }
            public double SoilRawDensity { get => this.ReadDataDouble(768UL, -1); set => this.WriteData(768UL, value, -1); }
            public double SoilBulkDensity { get => this.ReadDataDouble(832UL, -1); set => this.WriteData(832UL, value, -1); }
            public double SoilOrganicCarbon { get => this.ReadDataDouble(896UL, -1); set => this.WriteData(896UL, value, -1); }
            public double SoilOrganicMatter { get => this.ReadDataDouble(960UL, -1); set => this.WriteData(960UL, value, -1); }
        }
    }
    ...
    public class AutomaticIrrigationParameters : ICapnpSerializable
    {
        ...
        public class WRITER : SerializerState
        {
            ...
            public Mas.Schema.Model.Monica.Params.Irrigation.Parameters.WRITER Params { get => BuildPointer<Mas.Schema.Model.Monica.Params.Irrigation.Parameters.WRITER>(0); set => Link(0, value); }
            public double Amount { get => this.ReadDataDouble(0UL, 17); set => this.WriteData(0UL, value, 17); }
            public double Threshold { get => this.ReadDataDouble(64UL, 0.35); set => this.WriteData(64UL, value, 0.35); }
        }
    }
    ...
    public class SiteParameters : ICapnpSerializable
    {
        ...
        public class WRITER : SerializerState
        {
            ...
            public double Latitude { get => this.ReadDataDouble(0UL, 52.5); set => this.WriteData(0UL, value, 52.5); }
            public double Slope { get => this.ReadDataDouble(64UL, 0.01); set => this.WriteData(64UL, value, 0.01); }
            public double HeightNN { get => this.ReadDataDouble(128UL, 50); set => this.WriteData(128UL, value, 50); }
            public double GroundwaterDepth { get => this.ReadDataDouble(192UL, 70); set => this.WriteData(192UL, value, 70); }
            public double SoilCNRatio { get => this.ReadDataDouble(256UL, 10); set => this.WriteData(256UL, value, 10); }
            public double DrainageCoeff { get => this.ReadDataDouble(320UL, 1); set => this.WriteData(320UL, value, 1); }
            public double VqNDeposition { get => this.ReadDataDouble(384UL, 30); set => this.WriteData(384UL, value, 30); }
            public double MaxEffectiveRootingDepth { get => this.ReadDataDouble(448UL, 2); set => this.WriteData(448UL, value, 2); }
            public double ImpenetrableLayerDepth { get => this.ReadDataDouble(512UL, -1); set => this.WriteData(512UL, value, -1); }
            public double SoilSpecificHumusBalanceCorrection { get => this.ReadDataDouble(576UL, 0); set => this.WriteData(576UL, value, 0); }
            public ListOfStructsSerializer<Mas.Schema.Model.Monica.SoilParameters.WRITER> SoilParameters { get => BuildPointer<ListOfStructsSerializer<Mas.Schema.Model.Monica.SoilParameters.WRITER>>(0); set => Link(0, value); }
        }
    }
    ...
    public class EnvironmentParameters : ICapnpSerializable
    {
        ...
        public class WRITER : SerializerState
        {
            ...
            public double Albedo { get => this.ReadDataDouble(0UL, 0.23); set => this.WriteData(0UL, value, 0.23); }
            public double AtmosphericCO2 { get => this.ReadDataDouble(64UL, 0); set => this.WriteData(64UL, value, 0); }
            public ListOfStructsSerializer<Mas.Schema.Model.Monica.EnvironmentParameters.YearToValue.WRITER> AtmosphericCO2s { get => BuildPointer<ListOfStructsSerializer<Mas.Schema.Model.Monica.EnvironmentParameters.YearToValue.WRITER>>(0); set => Link(0, value); }
            public double AtmosphericO3 { get => this.ReadDataDouble(128UL, 0); set => this.WriteData(128UL, value, 0); }
            public ListOfStructsSerializer<Mas.Schema.Model.Monica.EnvironmentParameters.YearToValue.WRITER> AtmosphericO3s { get => BuildPointer<ListOfStructsSerializer<Mas.Schema.Model.Monica.EnvironmentParameters.YearToValue.WRITER>>(1); set => Link(1, value); }
            public double WindSpeedHeight { get => this.ReadDataDouble(192UL, 2); set => this.WriteData(192UL, value, 2); }
            public double LeachingDepth { get => this.ReadDataDouble(256UL, 0); set => this.WriteData(256UL, value, 0); }
            public double TimeStep { get => this.ReadDataDouble(320UL, 0); set => this.WriteData(320UL, value, 0); }
            public double MaxGroundwaterDepth { get => this.ReadDataDouble(384UL, 18); set => this.WriteData(384UL, value, 18); }
            public double MinGroundwaterDepth { get => this.ReadDataDouble(448UL, 20); set => this.WriteData(448UL, value, 20); }
            public byte MinGroundwaterDepthMonth { get => this.ReadDataByte(512UL, (byte)3); set => this.WriteData(512UL, value, (byte)3); }
            public Mas.Schema.Climate.RCP Rcp { get => (Mas.Schema.Climate.RCP)this.ReadDataUShort(528UL, (ushort)0); set => this.WriteData(528UL, (ushort)value, (ushort)0); }
        }
        ...
        public class YearToValue : ICapnpSerializable
        {
            ...
            public class WRITER : SerializerState
            {
                ...
                public ushort Year { get => this.ReadDataUShort(0UL, (ushort)0); set => this.WriteData(0UL, value, (ushort)0); }
    ...
    public class MeasuredGroundwaterTableInformation : ICapnpSerializable
    {
        ...
        public class WRITER : SerializerState
        {
            ...
            public bool GroundwaterInformationAvailable { get => this.ReadDataBool(0UL, false); set => this.WriteData(0UL, value, false); }
            public ListOfStructsSerializer<Mas.Schema.Model.Monica.MeasuredGroundwaterTableInformation.DateToValue.WRITER> GroundwaterInfo { get => BuildPointer<ListOfStructsSerializer<Mas.Schema.Model.Monica.MeasuredGroundwaterTableInformation.DateToValue.WRITER>>(0); set => Link(0, value); }
        }
        ...
        public class DateToValue : ICapnpSerializable
        {
            ...
            public class WRITER : SerializerState
            {
                ...
                public Mas.Schema.Common.Date.WRITER Date { get => BuildPointer<Mas.Schema.Common.Date.WRITER>(0); set => Link(0, value); }
                public double Value { get => this.ReadDataDouble(0UL, 0); set => this.WriteData(0UL, value, 0); }
            }
        }
    }
    ...
    public class SimulationParameters : ICapnpSerializable
    {
        ...
        public class WRITER : SerializerState
        {
            ...
            public bool NitrogenResponseOn { get => this.ReadDataBool(0UL, true); set => this.WriteData(0UL, value, true); }
            public bool WaterDeficitResponseOn { get => this.ReadDataBool(1UL, true); set => this.WriteData(1UL, value, true); }
            public bool EmergenceFloodingControlOn { get => this.ReadDataBool(2UL, true); set => this.WriteData(2UL, value, true); }
            public bool EmergenceMoistureControlOn { get => this.ReadDataBool(3UL, true); set => this.WriteData(3UL, value, true); }
            public bool FrostKillOn { get => this.ReadDataBool(4UL, true); set => this.WriteData(4UL, value, true); }
            public bool UseAutomaticIrrigation { get => this.ReadDataBool(5UL, false); set => this.WriteData(5UL, value, false); }
            public Mas.Schema.Model.Monica.AutomaticIrrigationParameters.WRITER AutoIrrigationParams { get => BuildPointer<Mas.Schema.Model.Monica.AutomaticIrrigationParameters.WRITER>(2); set => Link(2, value); }
            public bool UseNMinMineralFertilisingMethod { get => this.ReadDataBool(6UL, false); set => this.WriteData(6UL, value, false); }
            public Mas.Schema.Model.Monica.Params.MineralFertilization.Parameters.WRITER NMinFertiliserPartition { get => BuildPointer<Mas.Schema.Model.Monica.Params.MineralFertilization.Parameters.WRITER>(3); set => Link(3, value); }
            public Mas.Schema.Model.Monica.NMinApplicationParameters.WRITER NMinApplicationParams { get => BuildPointer<Mas.Schema.Model.Monica.NMinApplicationParameters.WRITER>(4); set => Link(4, value); }
            public bool UseSecondaryYields { get => this.ReadDataBool(7UL, true); set => this.WriteData(7UL, value, true); }
            public bool UseAutomaticHarvestTrigger { get => this.ReadDataBool(8UL, false); set => this.WriteData(8UL, value, false); }
            public ushort NumberOfLayers { get => this.ReadDataUShort(16UL, (ushort)20); set => this.WriteData(16UL, value, (ushort)20); }
            public double LayerThickness { get => this.ReadDataDouble(64UL, 0.1); set => this.WriteData(64UL, value, 0.1); }
            public ushort StartPVIndex { get => this.ReadDataUShort(32UL, (ushort)0); set => this.WriteData(32UL, value, (ushort)0); }
            public ushort JulianDayAutomaticFertilising { get => this.ReadDataUShort(48UL, (ushort)0); set => this.WriteData(48UL, value, (ushort)0); }
        }
    }
    ...
    public class CropModuleParameters : ICapnpSerializable
    {
        ...
        public class WRITER : SerializerState
        {
            ...
            public double CanopyReflectionCoefficient { get => this.ReadDataDouble(0UL, 0); set => this.WriteData(0UL, value, 0); }
            public double ReferenceMaxAssimilationRate { get => this.ReadDataDouble(64UL, 0); set => this.WriteData(64UL, value, 0); }
            public double ReferenceLeafAreaIndex { get => this.ReadDataDouble(128UL, 0); set => this.WriteData(128UL, value, 0); }
            public double MaintenanceRespirationParameter1 { get => this.ReadDataDouble(192UL, 0); set => this.WriteData(192UL, value, 0); }
            public double MaintenanceRespirationParameter2 { get => this.ReadDataDouble(256UL, 0); set => this.WriteData(256UL, value, 0); }
            public double MinimumNConcentrationRoot { get => this.ReadDataDouble(320UL, 0); set => this.WriteData(320UL, value, 0); }
            public double MinimumAvailableN { get => this.ReadDataDouble(384UL, 0); set => this.WriteData(384UL, value, 0); }
            public double ReferenceAlbedo { get => this.ReadDataDouble(448UL, 0); set => this.WriteData(448UL, value, 0); }
            public double StomataConductanceAlpha { get => this.ReadDataDouble(512UL, 0); set => this.WriteData(512UL, value, 0); }
            public double SaturationBeta { get => this.ReadDataDouble(576UL, 0); set => this.WriteData(576UL, value, 0); }
            public double GrowthRespirationRedux { get => this.ReadDataDouble(640UL, 0); set => this.WriteData(640UL, value, 0); }
            public double MaxCropNDemand { get => this.ReadDataDouble(704UL, 0); set => this.WriteData(704UL, value, 0); }
            public double GrowthRespirationParameter1 { get => this.ReadDataDouble(768UL, 0); set => this.WriteData(768UL, value, 0); }
            public double GrowthRespirationParameter2 { get => this.ReadDataDouble(832UL, 0); set => this.WriteData(832UL, value, 0); }
            public double Tortuosity { get => this.ReadDataDouble(896UL, 0); set => this.WriteData(896UL, value, 0); }
            public bool AdjustRootDepthForSoilProps { get => this.ReadDataBool(960UL, false); set => this.WriteData(960UL, value, false); }
            public bool ExperimentalEnablePhenologyWangEngelTemperatureResponse { get => this.ReadDataBool(961UL, false); set => this.WriteData(961UL, value, false); }
            public bool ExperimentalEnablePhotosynthesisWangEngelTemperatureResponse { get => this.ReadDataBool(962UL, false); set => this.WriteData(962UL, value, false); }
            public bool ExperimentalEnableHourlyFvCBPhotosynthesis { get => this.ReadDataBool(963UL, false); set => this.WriteData(963UL, value, false); }
            public bool ExperimentalEnableTResponseLeafExpansion { get => this.ReadDataBool(964UL, false); set => this.WriteData(964UL, value, false); }
            public bool ExperimentalDisableDailyRootBiomassToSoil { get => this.ReadDataBool(965UL, false); set => this.WriteData(965UL, value, false); }
            public bool EnableVernalisationFactorFix { get => this.ReadDataBool(966UL, false); set => this.WriteData(966UL, value, false); }
        }
    }
    ...
    public class SoilMoistureModuleParameters : ICapnpSerializable
    {
        ...
        public class WRITER : SerializerState
        {
            ...
            public double CriticalMoistureDepth { get => this.ReadDataDouble(0UL, 0); set => this.WriteData(0UL, value, 0); }
            public double SaturatedHydraulicConductivity { get => this.ReadDataDouble(64UL, 0); set => this.WriteData(64UL, value, 0); }
            public double SurfaceRoughness { get => this.ReadDataDouble(128UL, 0); set => this.WriteData(128UL, value, 0); }
            public double GroundwaterDischarge { get => this.ReadDataDouble(192UL, 0); set => this.WriteData(192UL, value, 0); }
            public double HydraulicConductivityRedux { get => this.ReadDataDouble(256UL, 0); set => this.WriteData(256UL, value, 0); }
            public double SnowAccumulationTresholdTemperature { get => this.ReadDataDouble(320UL, 0); set => this.WriteData(320UL, value, 0); }
            public double KcFactor { get => this.ReadDataDouble(384UL, 0); set => this.WriteData(384UL, value, 0); }
            public double TemperatureLimitForLiquidWater { get => this.ReadDataDouble(448UL, 0); set => this.WriteData(448UL, value, 0); }
            public double CorrectionSnow { get => this.ReadDataDouble(512UL, 0); set => this.WriteData(512UL, value, 0); }
            public double CorrectionRain { get => this.ReadDataDouble(576UL, 0); set => this.WriteData(576UL, value, 0); }
            public double SnowMaxAdditionalDensity { get => this.ReadDataDouble(640UL, 0); set => this.WriteData(640UL, value, 0); }
            public double NewSnowDensityMin { get => this.ReadDataDouble(704UL, 0); set => this.WriteData(704UL, value, 0); }
            public double SnowRetentionCapacityMin { get => this.ReadDataDouble(768UL, 0); set => this.WriteData(768UL, value, 0); }
            public double RefreezeParameter1 { get => this.ReadDataDouble(832UL, 0); set => this.WriteData(832UL, value, 0); }
            public double RefreezeParameter2 { get => this.ReadDataDouble(896UL, 0); set => this.WriteData(896UL, value, 0); }
            public double RefreezeTemperature { get => this.ReadDataDouble(960UL, 0); set => this.WriteData(960UL, value, 0); }
            public double SnowMeltTemperature { get => this.ReadDataDouble(1024UL, 0); set => this.WriteData(1024UL, value, 0); }
            public double SnowPacking { get => this.ReadDataDouble(1088UL, 0); set => this.WriteData(1088UL, value, 0); }
            public double SnowRetentionCapacityMax { get => this.ReadDataDouble(1152UL, 0); set => this.WriteData(1152UL, value, 0); }
            public double EvaporationZeta { get => this.ReadDataDouble(1216UL, 0); set => this.WriteData(1216UL, value, 0); }
            public double XsaCriticalSoilMoisture { get => this.ReadDataDouble(1280UL, 0); set => this.WriteData(1280UL, value, 0); }
            public double MaximumEvaporationImpactDepth { get => this.ReadDataDouble(1344UL, 0); set => this.WriteData(1344UL, value, 0); }
            public double MaxPercolationRate { get => this.ReadDataDouble(1408UL, 0); set => this.WriteData(1408UL, value, 0); }
            public double MoistureInitValue { get => this.ReadDataDouble(1472UL, 0); set => this.WriteData(1472UL, value, 0); }
        }
    }
    ...
    public class SoilOrganicModuleParameters : ICapnpSerializable
    {
        ...
        public class WRITER : SerializerState
        {
            ...
            public double SomSlowDecCoeffStandard { get => this.ReadDataDouble(0UL, 4.3E-05); set => this.WriteData(0UL, value, 4.3E-05); }
            public double SomFastDecCoeffStandard { get => this.ReadDataDouble(64UL, 0.00014); set => this.WriteData(64UL, value, 0.00014); }
            public double SmbSlowMaintRateStandard { get => this.ReadDataDouble(128UL, 0.001); set => this.WriteData(128UL, value, 0.001); }
            public double SmbFastMaintRateStandard { get => this.ReadDataDouble(192UL, 0.01); set => this.WriteData(192UL, value, 0.01); }
            public double SmbSlowDeathRateStandard { get => this.ReadDataDouble(256UL, 0.001); set => this.WriteData(256UL, value, 0.001); }
            public double SmbFastDeathRateStandard { get => this.ReadDataDouble(320UL, 0.01); set => this.WriteData(320UL, value, 0.01); }
            public double SmbUtilizationEfficiency { get => this.ReadDataDouble(384UL, 0.6); set => this.WriteData(384UL, value, 0.6); }
            public double SomSlowUtilizationEfficiency { get => this.ReadDataDouble(448UL, 0.4); set => this.WriteData(448UL, value, 0.4); }
            public double SomFastUtilizationEfficiency { get => this.ReadDataDouble(512UL, 0.5); set => this.WriteData(512UL, value, 0.5); }
            public double AomSlowUtilizationEfficiency { get => this.ReadDataDouble(576UL, 0.4); set => this.WriteData(576UL, value, 0.4); }
            public double AomFastUtilizationEfficiency { get => this.ReadDataDouble(640UL, 0.1); set => this.WriteData(640UL, value, 0.1); }
            public double AomFastMaxCtoN { get => this.ReadDataDouble(704UL, 1000); set => this.WriteData(704UL, value, 1000); }
            public double PartSOMFastToSOMSlow { get => this.ReadDataDouble(768UL, 0.3); set => this.WriteData(768UL, value, 0.3); }
            public double PartSMBSlowToSOMFast { get => this.ReadDataDouble(832UL, 0.6); set => this.WriteData(832UL, value, 0.6); }
            public double PartSMBFastToSOMFast { get => this.ReadDataDouble(896UL, 0.6); set => this.WriteData(896UL, value, 0.6); }
            public double PartSOMToSMBSlow { get => this.ReadDataDouble(960UL, 0.015); set => this.WriteData(960UL, value, 0.015); }
            public double PartSOMToSMBFast { get => this.ReadDataDouble(1024UL, 0.0002); set => this.WriteData(1024UL, value, 0.0002); }
            public double CnRatioSMB { get => this.ReadDataDouble(1088UL, 6.7); set => this.WriteData(1088UL, value, 6.7); }
            public double LimitClayEffect { get => this.ReadDataDouble(1152UL, 0.25); set => this.WriteData(1152UL, value, 0.25); }
            public double AmmoniaOxidationRateCoeffStandard { get => this.ReadDataDouble(1216UL, 0.1); set => this.WriteData(1216UL, value, 0.1); }
            public double NitriteOxidationRateCoeffStandard { get => this.ReadDataDouble(1280UL, 0.9); set => this.WriteData(1280UL, value, 0.9); }
            public double TransportRateCoeff { get => this.ReadDataDouble(1344UL, 0.1); set => this.WriteData(1344UL, value, 0.1); }
            public double SpecAnaerobDenitrification { get => this.ReadDataDouble(1408UL, 0.1); set => this.WriteData(1408UL, value, 0.1); }
            public double ImmobilisationRateCoeffNO3 { get => this.ReadDataDouble(1472UL, 0.5); set => this.WriteData(1472UL, value, 0.5); }
            public double ImmobilisationRateCoeffNH4 { get => this.ReadDataDouble(1536UL, 0.5); set => this.WriteData(1536UL, value, 0.5); }
            public double Denit1 { get => this.ReadDataDouble(1600UL, 0.2); set => this.WriteData(1600UL, value, 0.2); }
            public double Denit2 { get => this.ReadDataDouble(1664UL, 0.8); set => this.WriteData(1664UL, value, 0.8); }
            public double Denit3 { get => this.ReadDataDouble(1728UL, 0.9); set => this.WriteData(1728UL, value, 0.9); }
            public double HydrolysisKM { get => this.ReadDataDouble(1792UL, 0.00334); set => this.WriteData(1792UL, value, 0.00334); }
            public double ActivationEnergy { get => this.ReadDataDouble(1856UL, 41000); set => this.WriteData(1856UL, value, 41000); }
            public double HydrolysisP1 { get => this.ReadDataDouble(1920UL, 4.259E-12); set => this.WriteData(1920UL, value, 4.259E-12); }
            public double HydrolysisP2 { get => this.ReadDataDouble(1984UL, 1.408E-12); set => this.WriteData(1984UL, value, 1.408E-12); }
            public double AtmosphericResistance { get => this.ReadDataDouble(2048UL, 0.0025); set => this.WriteData(2048UL, value, 0.0025); }
            public double N2oProductionRate { get => this.ReadDataDouble(2112UL, 0.5); set => this.WriteData(2112UL, value, 0.5); }
            public double InhibitorNH3 { get => this.ReadDataDouble(2176UL, 1); set => this.WriteData(2176UL, value, 1); }
            public double PsMaxMineralisationDepth { get => this.ReadDataDouble(2240UL, 0.4); set => this.WriteData(2240UL, value, 0.4); }
            public Mas.Schema.Model.Monica.SticsParameters.WRITER SticsParams { get => BuildPointer<Mas.Schema.Model.Monica.SticsParameters.WRITER>(0); set => Link(0, value); }
        }
    }
    ...
    public class SoilTemperatureModuleParameters : ICapnpSerializable
    {
        ...
        public class WRITER : SerializerState
        {
            ...
            public double NTau { get => this.ReadDataDouble(0UL, 0); set => this.WriteData(0UL, value, 0); }
            public double InitialSurfaceTemperature { get => this.ReadDataDouble(64UL, 0); set => this.WriteData(64UL, value, 0); }
            public double BaseTemperature { get => this.ReadDataDouble(128UL, 0); set => this.WriteData(128UL, value, 0); }
            public double QuartzRawDensity { get => this.ReadDataDouble(192UL, 0); set => this.WriteData(192UL, value, 0); }
            public double DensityAir { get => this.ReadDataDouble(256UL, 0); set => this.WriteData(256UL, value, 0); }
            public double DensityWater { get => this.ReadDataDouble(320UL, 0); set => this.WriteData(320UL, value, 0); }
            public double DensityHumus { get => this.ReadDataDouble(384UL, 0); set => this.WriteData(384UL, value, 0); }
            public double SpecificHeatCapacityAir { get => this.ReadDataDouble(448UL, 0); set => this.WriteData(448UL, value, 0); }
            public double SpecificHeatCapacityQuartz { get => this.ReadDataDouble(512UL, 0); set => this.WriteData(512UL, value, 0); }
            public double SpecificHeatCapacityWater { get => this.ReadDataDouble(576UL, 0); set => this.WriteData(576UL, value, 0); }
            public double SpecificHeatCapacityHumus { get => this.ReadDataDouble(640UL, 0); set => this.WriteData(640UL, value, 0); }
            public double SoilAlbedo { get => this.ReadDataDouble(704UL, 0); set => this.WriteData(704UL, value, 0); }
            public double SoilMoisture { get => this.ReadDataDouble(768UL, 0.25); set => this.WriteData(768UL, value, 0.25); }
        }
    }
    ...
    public class SoilTransportModuleParameters : ICapnpSerializable
    {
        ...
        public class WRITER : SerializerState
        {
            ...
            public double DispersionLength { get => this.ReadDataDouble(0UL, 0); set => this.WriteData(0UL, value, 0); }
            public double Ad { get => this.ReadDataDouble(64UL, 0); set => this.WriteData(64UL, value, 0); }
            public double DiffusionCoefficientStandard { get => this.ReadDataDouble(128UL, 0); set => this.WriteData(128UL, value, 0); }
            public double NDeposition { get => this.ReadDataDouble(192UL, 0); set => this.WriteData(192UL, value, 0); }
        }
    }
    ...
    public class Voc : ICapnpSerializable
    {
        ...
        public class Emissions : ICapnpSerializable
        {
            ...
            public class WRITER : SerializerState
            {
                ...
                public ListOfStructsSerializer<Mas.Schema.Model.Monica.Voc.Emissions.SpeciesIdToEmission.WRITER> SpeciesIdToIsopreneEmission { get => BuildPointer<ListOfStructsSerializer<Mas.Schema.Model.Monica.Voc.Emissions.SpeciesIdToEmission.WRITER>>(0); set => Link(0, value); }
                public ListOfStructsSerializer<Mas.Schema.Model.Monica.Voc.Emissions.SpeciesIdToEmission.WRITER> SpeciesIdToMonoterpeneEmission { get => BuildPointer<ListOfStructsSerializer<Mas.Schema.Model.Monica.Voc.Emissions.SpeciesIdToEmission.WRITER>>(1); set => Link(1, value); }
                public double IsopreneEmission { get => this.ReadDataDouble(0UL, 0); set => this.WriteData(0UL, value, 0); }
                public double MonoterpeneEmission { get => this.ReadDataDouble(64UL, 0); set => this.WriteData(64UL, value, 0); }
            }
            ...
            public class SpeciesIdToEmission : ICapnpSerializable
            {
                ...
                public class WRITER : SerializerState
                {
                    ...
                    public ulong SpeciesId { get => this.ReadDataULong(0UL, 0UL); set => this.WriteData(0UL, value, 0UL); }
                    public double Emission { get => this.ReadDataDouble(64UL, 0); set => this.WriteData(64UL, value, 0); }
                }
            }
        }
        ...
        public class SpeciesData : ICapnpSerializable
        {
            ...
            public class WRITER : SerializerState
            {
                ...
                public ulong Id { get => this.ReadDataULong(0UL, 0UL); set => this.WriteData(0UL, value, 0UL); }
                public double EfMonos { get => this.ReadDataDouble(64UL, 0); set => this.WriteData(64UL, value, 0); }
                public double EfMono { get => this.ReadDataDouble(128UL, 0); set => this.WriteData(128UL, value, 0); }
                public double EfIso { get => this.ReadDataDouble(192UL, 0); set => this.WriteData(192UL, value, 0); }
                public double Theta { get => this.ReadDataDouble(256UL, 0.9); set => this.WriteData(256UL, value, 0.9); }
                public double Fage { get => this.ReadDataDouble(320UL, 1); set => this.WriteData(320UL, value, 1); }
                public double CtIs { get => this.ReadDataDouble(384UL, 0); set => this.WriteData(384UL, value, 0); }
                public double CtMt { get => this.ReadDataDouble(448UL, 0); set => this.WriteData(448UL, value, 0); }
                public double HaIs { get => this.ReadDataDouble(512UL, 0); set => this.WriteData(512UL, value, 0); }
                public double HaMt { get => this.ReadDataDouble(576UL, 0); set => this.WriteData(576UL, value, 0); }
                public double DsIs { get => this.ReadDataDouble(640UL, 0); set => this.WriteData(640UL, value, 0); }
                public double DsMt { get => this.ReadDataDouble(704UL, 0); set => this.WriteData(704UL, value, 0); }
                public double HdIs { get => this.ReadDataDouble(768UL, 284600); set => this.WriteData(768UL, value, 284600); }
                public double HdMt { get => this.ReadDataDouble(832UL, 284600); set => this.WriteData(832UL, value, 284600); }
                public double Hdj { get => this.ReadDataDouble(896UL, 220000); set => this.WriteData(896UL, value, 220000); }
                public double Sdj { get => this.ReadDataDouble(960UL, 703); set => this.WriteData(960UL, value, 703); }
                public double Kc25 { get => this.ReadDataDouble(1024UL, 260); set => this.WriteData(1024UL, value, 260); }
                public double Ko25 { get => this.ReadDataDouble(1088UL, 179); set => this.WriteData(1088UL, value, 179); }
                public double VcMax25 { get => this.ReadDataDouble(1152UL, 80); set => this.WriteData(1152UL, value, 80); }
                public double Qjvc { get => this.ReadDataDouble(1216UL, 2); set => this.WriteData(1216UL, value, 2); }
                public double Aekc { get => this.ReadDataDouble(1280UL, 59356); set => this.WriteData(1280UL, value, 59356); }
                public double Aeko { get => this.ReadDataDouble(1344UL, 35948); set => this.WriteData(1344UL, value, 35948); }
                public double Aejm { get => this.ReadDataDouble(1408UL, 37000); set => this.WriteData(1408UL, value, 37000); }
                public double Aevc { get => this.ReadDataDouble(1472UL, 58520); set => this.WriteData(1472UL, value, 58520); }
                public double SlaMin { get => this.ReadDataDouble(1536UL, 20); set => this.WriteData(1536UL, value, 20); }
                public double ScaleI { get => this.ReadDataDouble(1600UL, 1); set => this.WriteData(1600UL, value, 1); }
                public double ScaleM { get => this.ReadDataDouble(1664UL, 1); set => this.WriteData(1664UL, value, 1); }
                public double MFol { get => this.ReadDataDouble(1728UL, 0); set => this.WriteData(1728UL, value, 0); }
                public double Lai { get => this.ReadDataDouble(1792UL, 0); set => this.WriteData(1792UL, value, 0); }
                public double Sla { get => this.ReadDataDouble(1856UL, 0); set => this.WriteData(1856UL, value, 0); }
            }
        }
        ...
        public class CPData : ICapnpSerializable
        {
            ...
            public class WRITER : SerializerState
            {
                ...
                public double Kc { get => this.ReadDataDouble(0UL, 0); set => this.WriteData(0UL, value, 0); }
                public double Ko { get => this.ReadDataDouble(64UL, 0); set => this.WriteData(64UL, value, 0); }
                public double Oi { get => this.ReadDataDouble(128UL, 0); set => this.WriteData(128UL, value, 0); }
                public double Ci { get => this.ReadDataDouble(192UL, 0); set => this.WriteData(192UL, value, 0); }
                public double Comp { get => this.ReadDataDouble(256UL, 0); set => this.WriteData(256UL, value, 0); }
                public double VcMax { get => this.ReadDataDouble(320UL, 0); set => this.WriteData(320UL, value, 0); }
                public double JMax { get => this.ReadDataDouble(384UL, 0); set => this.WriteData(384UL, value, 0); }
                public double Jj { get => this.ReadDataDouble(448UL, 0); set => this.WriteData(448UL, value, 0); }
                public double Jj1000 { get => this.ReadDataDouble(512UL, 0); set => this.WriteData(512UL, value, 0); }
                public double Jv { get => this.ReadDataDouble(576UL, 0); set => this.WriteData(576UL, value, 0); }
            }
        }
        ...
        public class MicroClimateData : ICapnpSerializable
        {
            ...
            public class WRITER : SerializerState
            {
                ...
                public double Rad { get => this.ReadDataDouble(0UL, 0); set => this.WriteData(0UL, value, 0); }
                public double Rad24 { get => this.ReadDataDouble(64UL, 0); set => this.WriteData(64UL, value, 0); }
                public double Rad240 { get => this.ReadDataDouble(128UL, 0); set => this.WriteData(128UL, value, 0); }
                public double TFol { get => this.ReadDataDouble(192UL, 0); set => this.WriteData(192UL, value, 0); }
                public double TFol24 { get => this.ReadDataDouble(256UL, 0); set => this.WriteData(256UL, value, 0); }
                public double TFol240 { get => this.ReadDataDouble(320UL, 0); set => this.WriteData(320UL, value, 0); }
                public double Sunlitfoliagefraction { get => this.ReadDataDouble(384UL, 0); set => this.WriteData(384UL, value, 0); }
                public double Sunlitfoliagefraction24 { get => this.ReadDataDouble(448UL, 0); set => this.WriteData(448UL, value, 0); }
                public double Co2concentration { get => this.ReadDataDouble(512UL, 0); set => this.WriteData(512UL, value, 0); }
            }
        }
        ...
        public class PhotosynthT : ICapnpSerializable
        {
            ...
            public class WRITER : SerializerState
            {
                ...
                public double Par { get => this.ReadDataDouble(0UL, 0); set => this.WriteData(0UL, value, 0); }
                public double Par24 { get => this.ReadDataDouble(64UL, 0); set => this.WriteData(64UL, value, 0); }
                public double Par240 { get => this.ReadDataDouble(128UL, 0); set => this.WriteData(128UL, value, 0); }
            }
        }
        ...
        public class FoliageT : ICapnpSerializable
        {
            ...
            public class WRITER : SerializerState
            {
                ...
                public double TempK { get => this.ReadDataDouble(0UL, 0); set => this.WriteData(0UL, value, 0); }
                public double TempK24 { get => this.ReadDataDouble(64UL, 0); set => this.WriteData(64UL, value, 0); }
                public double TempK240 { get => this.ReadDataDouble(128UL, 0); set => this.WriteData(128UL, value, 0); }
            }
        }
        ...
        public class EnzymeActivityT : ICapnpSerializable
        {
            ...
            public class WRITER : SerializerState
            {
                ...
                public double EfIso { get => this.ReadDataDouble(0UL, 0); set => this.WriteData(0UL, value, 0); }
                public double EfMono { get => this.ReadDataDouble(64UL, 0); set => this.WriteData(64UL, value, 0); }
            }
        }
        ...
        public class LeafEmissionT : ICapnpSerializable
        {
            ...
            public class WRITER : SerializerState
            {
                ...
                public ushort FoliageLayer { get => this.ReadDataUShort(0UL, (ushort)0); set => this.WriteData(0UL, value, (ushort)0); }
                public Mas.Schema.Model.Monica.Voc.PhotosynthT.WRITER Pho { get => BuildPointer<Mas.Schema.Model.Monica.Voc.PhotosynthT.WRITER>(0); set => Link(0, value); }
                public Mas.Schema.Model.Monica.Voc.FoliageT.WRITER Fol { get => BuildPointer<Mas.Schema.Model.Monica.Voc.FoliageT.WRITER>(1); set => Link(1, value); }
                public Mas.Schema.Model.Monica.Voc.EnzymeActivityT.WRITER EnzAct { get => BuildPointer<Mas.Schema.Model.Monica.Voc.EnzymeActivityT.WRITER>(2); set => Link(2, value); }
            }
        }
        ...
        public class LeafEmissions : ICapnpSerializable
        {
            ...
            public class WRITER : SerializerState
            {
                ...
                public double Isoprene { get => this.ReadDataDouble(0UL, 0); set => this.WriteData(0UL, value, 0); }
                public double Monoterp { get => this.ReadDataDouble(64UL, 0); set => this.WriteData(64UL, value, 0); }
            }
        }
    }
    ...
    public class SticsParameters : ICapnpSerializable
    {
        ...
        public class WRITER : SerializerState
        {
            ...
            public bool UseN2O { get => this.ReadDataBool(0UL, false); set => this.WriteData(0UL, value, false); }
            public bool UseNit { get => this.ReadDataBool(1UL, false); set => this.WriteData(1UL, value, false); }
            public bool UseDenit { get => this.ReadDataBool(2UL, false); set => this.WriteData(2UL, value, false); }
            public byte CodeVnit { get => this.ReadDataByte(8UL, (byte)1); set => this.WriteData(8UL, value, (byte)1); }
            public byte CodeTnit { get => this.ReadDataByte(16UL, (byte)2); set => this.WriteData(16UL, value, (byte)2); }
            public byte CodeRationit { get => this.ReadDataByte(24UL, (byte)2); set => this.WriteData(24UL, value, (byte)2); }
            public byte CodeHourlyWfpsNit { get => this.ReadDataByte(32UL, (byte)2); set => this.WriteData(32UL, value, (byte)2); }
            public byte CodePdenit { get => this.ReadDataByte(40UL, (byte)1); set => this.WriteData(40UL, value, (byte)1); }
            public byte CodeRatiodenit { get => this.ReadDataByte(48UL, (byte)2); set => this.WriteData(48UL, value, (byte)2); }
            public byte CodeHourlyWfpsDenit { get => this.ReadDataByte(56UL, (byte)2); set => this.WriteData(56UL, value, (byte)2); }
            public double Hminn { get => this.ReadDataDouble(64UL, 0.3); set => this.WriteData(64UL, value, 0.3); }
            public double Hoptn { get => this.ReadDataDouble(128UL, 0.9); set => this.WriteData(128UL, value, 0.9); }
            public double PHminnit { get => this.ReadDataDouble(192UL, 4); set => this.WriteData(192UL, value, 4); }
            public double PHmaxnit { get => this.ReadDataDouble(256UL, 7.2); set => this.WriteData(256UL, value, 7.2); }
            public double Nh4Min { get => this.ReadDataDouble(320UL, 1); set => this.WriteData(320UL, value, 1); }
            public double PHminden { get => this.ReadDataDouble(384UL, 7.2); set => this.WriteData(384UL, value, 7.2); }
            public double PHmaxden { get => this.ReadDataDouble(448UL, 9.2); set => this.WriteData(448UL, value, 9.2); }
            public double Wfpsc { get => this.ReadDataDouble(512UL, 0.62); set => this.WriteData(512UL, value, 0.62); }
            public double TdenitoptGauss { get => this.ReadDataDouble(576UL, 47); set => this.WriteData(576UL, value, 47); }
            public double ScaleTdenitopt { get => this.ReadDataDouble(640UL, 25); set => this.WriteData(640UL, value, 25); }
            public double Kd { get => this.ReadDataDouble(704UL, 148); set => this.WriteData(704UL, value, 148); }
            public double KDesat { get => this.ReadDataDouble(768UL, 3); set => this.WriteData(768UL, value, 3); }
            public double Fnx { get => this.ReadDataDouble(832UL, 0.8); set => this.WriteData(832UL, value, 0.8); }
            public double Vnitmax { get => this.ReadDataDouble(896UL, 27.3); set => this.WriteData(896UL, value, 27.3); }
            public double Kamm { get => this.ReadDataDouble(960UL, 24); set => this.WriteData(960UL, value, 24); }
            public double Tnitmin { get => this.ReadDataDouble(1024UL, 5); set => this.WriteData(1024UL, value, 5); }
            public double Tnitopt { get => this.ReadDataDouble(1088UL, 30); set => this.WriteData(1088UL, value, 30); }
            public double Tnitop2 { get => this.ReadDataDouble(1152UL, 35); set => this.WriteData(1152UL, value, 35); }
            public double Tnitmax { get => this.ReadDataDouble(1216UL, 58); set => this.WriteData(1216UL, value, 58); }
            public double TnitoptGauss { get => this.ReadDataDouble(1280UL, 32.5); set => this.WriteData(1280UL, value, 32.5); }
            public double ScaleTnitopt { get => this.ReadDataDouble(1344UL, 16); set => this.WriteData(1344UL, value, 16); }
            public double Rationit { get => this.ReadDataDouble(1408UL, 0.0016); set => this.WriteData(1408UL, value, 0.0016); }
            public double CminPdenit { get => this.ReadDataDouble(1472UL, 1); set => this.WriteData(1472UL, value, 1); }
            public double CmaxPdenit { get => this.ReadDataDouble(1536UL, 6); set => this.WriteData(1536UL, value, 6); }
            public double MinPdenit { get => this.ReadDataDouble(1600UL, 1); set => this.WriteData(1600UL, value, 1); }
            public double MaxPdenit { get => this.ReadDataDouble(1664UL, 20); set => this.WriteData(1664UL, value, 20); }
            public double Ratiodenit { get => this.ReadDataDouble(1728UL, 0.2); set => this.WriteData(1728UL, value, 0.2); }
            public double Profdenit { get => this.ReadDataDouble(1792UL, 20); set => this.WriteData(1792UL, value, 20); }
            public double Vpotdenit { get => this.ReadDataDouble(1856UL, 2); set => this.WriteData(1856UL, value, 2); }
        }
    }
}
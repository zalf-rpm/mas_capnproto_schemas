...
module_file = os.path.abspath(os.path.join(here, "../zalfmas_capnp_schemas/management.capnp"))
...
Fertilizer.Server.NutrientsResultTuple = NamedTuple("NutrientsResultTuple", [("nutrients", object)])
Fertilizer.Server.ParametersResultTuple = NamedTuple("ParametersResultTuple", [("params", object)])
Service.Server.ManagementatResultTuple = NamedTuple("ManagementatResultTuple", [("mgmt", object)])

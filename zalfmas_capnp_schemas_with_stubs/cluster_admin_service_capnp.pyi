...
class _ClusterModule(_StructModule):
    class _UnregisterModule(_InterfaceModule):
        ...
        @classmethod
        def _new_client(cls, server: _DynamicCapabilityServer) -> _ClusterModule._UnregisterModule.UnregisterClient: ...
    ...
    class _AdminMasterModule(_IdentifiableModule):
        ...
        @classmethod
        def _new_client(cls, server: _DynamicCapabilityServer) -> _ClusterModule._AdminMasterModule.AdminMasterClient: ...
    ...
    class _UserMasterModule(_IdentifiableModule):
        ...
        @classmethod
        def _new_client(cls, server: _DynamicCapabilityServer) -> _ClusterModule._UserMasterModule.UserMasterClient: ...
        class Server(_IdentifiableModule.Server):
            class AvailablemodelsResult(Awaitable[AvailablemodelsResult], Protocol):
                factories: Any
    ...
    class _RuntimeModule(_IdentifiableModule):
        ...
        @classmethod
        def _new_client(cls, server: _DynamicCapabilityServer) -> _ClusterModule._RuntimeModule.RuntimeClient: ...
        class Server(_IdentifiableModule.Server):
            class RegistermodelinstancefactoryResult(Awaitable[RegistermodelinstancefactoryResult], Protocol):
                unregister: _ClusterModule._UnregisterModule.UnregisterClient
    ...
    class _ZmqPipelineAddressesModule(_StructModule):
        ...
        @override
        def new_message(self, num_first_segment_words: int | None = None, allocate_seg_callable: Any = None, input: str | None = None, output: str | None = None, **kwargs: Any) -> ZmqPipelineAddressesBuilder: ...
        @overload
        def from_bytes(self, buf: bytes, traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ...) -> AbstractContextManager[ZmqPipelineAddressesReader]: ...
        @overload
        def from_bytes(self, buf: bytes, traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ..., *, builder: Literal[False]) -> AbstractContextManager[ZmqPipelineAddressesReader]: ...
        @overload
        def from_bytes(self, buf: bytes, traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ..., *, builder: Literal[True]) -> AbstractContextManager[ZmqPipelineAddressesBuilder]: ...
        def from_bytes_packed(self, buf: bytes, traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ...) -> _DynamicStructReader: ...
        @override
        def read(self, file: IO[str] | IO[bytes], traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ...) -> ZmqPipelineAddressesReader: ...
        @override
        def read_packed(self, file: IO[str] | IO[bytes], traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ...) -> ZmqPipelineAddressesReader: ...
    ...
    class _ValueHolderModule(_InterfaceModule):
        ...
        @classmethod
        def _new_client(cls, server: _DynamicCapabilityServer) -> _ClusterModule._ValueHolderModule.ValueHolderClient: ...
        class Server(_DynamicCapabilityServer):
    ...
    class _ModelInstanceFactoryModule(_IdentifiableModule):
        ...
        @classmethod
        def _new_client(cls, server: _DynamicCapabilityServer) -> _ClusterModule._ModelInstanceFactoryModule.ModelInstanceFactoryClient: ...
        class Server(_IdentifiableModule.Server):
    ...
    @override
    def new_message(self, num_first_segment_words: int | None = None, allocate_seg_callable: Any = None, **kwargs: Any) -> ClusterBuilder: ...
    @overload
    def from_bytes(self, buf: bytes, traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ...) -> AbstractContextManager[ClusterReader]: ...
    @overload
    def from_bytes(self, buf: bytes, traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ..., *, builder: Literal[False]) -> AbstractContextManager[ClusterReader]: ...
    @overload
    def from_bytes(self, buf: bytes, traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ..., *, builder: Literal[True]) -> AbstractContextManager[ClusterBuilder]: ...
    def from_bytes_packed(self, buf: bytes, traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ...) -> _DynamicStructReader: ...
    @override
    def read(self, file: IO[str] | IO[bytes], traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ...) -> ClusterReader: ...
    @override
    def read_packed(self, file: IO[str] | IO[bytes], traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ...) -> ClusterReader: ...

Cluster: _ClusterModule

# Top-level type aliases for use in type annotations
type AdminMasterClient = _ClusterModule._AdminMasterModule.AdminMasterClient
type AvailablemodelsResult = _ClusterModule._RuntimeModule.RuntimeClient.AvailablemodelsResult
type ClusterBuilder = _ClusterModule.Builder
type ClusterReader = _ClusterModule.Reader
type FreenumberofcoresResult = _ClusterModule._RuntimeModule.RuntimeClient.FreenumberofcoresResult
type ModelInstanceFactoryClient = _ClusterModule._ModelInstanceFactoryModule.ModelInstanceFactoryClient
type ModelidResult = _ClusterModule._ModelInstanceFactoryModule.ModelInstanceFactoryClient.ModelidResult
...
type NumberofcoresResult = _ClusterModule._RuntimeModule.RuntimeClient.NumberofcoresResult
...
type RegistermodelinstancefactoryResult = _ClusterModule._RuntimeModule.RuntimeClient.RegistermodelinstancefactoryResult
type ReleaseResult = _ClusterModule._ValueHolderModule.ValueHolderClient.ReleaseResult
type ReservenumberofcoresResult = _ClusterModule._RuntimeModule.RuntimeClient.ReservenumberofcoresResult
type RestoresturdyrefResult = _ClusterModule._ModelInstanceFactoryModule.ModelInstanceFactoryClient.RestoresturdyrefResult
type RuntimeClient = _ClusterModule._RuntimeModule.RuntimeClient
type UnregisterClient = _ClusterModule._UnregisterModule.UnregisterClient
type UnregisterResult = _ClusterModule._UnregisterModule.UnregisterClient.UnregisterResult
type UserMasterClient = _ClusterModule._UserMasterModule.UserMasterClient
type ValueHolderClient = _ClusterModule._ValueHolderModule.ValueHolderClient

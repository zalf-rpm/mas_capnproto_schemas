...
class _IPModule(_StructModule):
    class _KVModule(_StructModule):
        ...
        @override
        def new_message(self, num_first_segment_words: int | None = None, allocate_seg_callable: Any = None, key: str | None = None, desc: str | None = None, value: Any | None = None, **kwargs: Any) -> KVBuilder: ...
        @overload
    ...
    class Builder(_DynamicStructBuilder):
        ...
        def type(self) -> int: ...
        @type.setter
        def type(self, value: int | Literal["standard", "openBracket", "closeBracket"]) -> None: ...
        def init(self, field: Literal["attributes"], size: int | None = None) -> MutableSequence[KVBuilder]: ...
        @override
        def as_reader(self) -> IPReader: ...

    @override
    def new_message(self, num_first_segment_words: int | None = None, allocate_seg_callable: Any = None, attributes: Sequence[KVBuilder] | Sequence[dict[str, Any]] | None = None, content: Any | None = None, type: int | Literal["standard", "openBracket", "closeBracket"] | None = None, **kwargs: Any) -> IPBuilder: ...
    @overload
    def from_bytes(self, buf: bytes, traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ...) -> AbstractContextManager[IPReader]: ...
    @overload
    def from_bytes(self, buf: bytes, traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ..., *, builder: Literal[False]) -> AbstractContextManager[IPReader]: ...
    @overload
    def from_bytes(self, buf: bytes, traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ..., *, builder: Literal[True]) -> AbstractContextManager[IPBuilder]: ...
    def from_bytes_packed(self, buf: bytes, traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ...) -> _DynamicStructReader: ...
    @override
    def read(self, file: IO[str] | IO[bytes], traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ...) -> IPReader: ...
    @override
    def read_packed(self, file: IO[str] | IO[bytes], traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ...) -> IPReader: ...
...
class _IIPModule(_StructModule):
    ...
    @override
    def new_message(self, num_first_segment_words: int | None = None, allocate_seg_callable: Any = None, content: Any | None = None, **kwargs: Any) -> IIPBuilder: ...
    @overload
    def from_bytes(self, buf: bytes, traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ...) -> AbstractContextManager[IIPReader]: ...
    @overload
    def from_bytes(self, buf: bytes, traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ..., *, builder: Literal[False]) -> AbstractContextManager[IIPReader]: ...
    @overload
    def from_bytes(self, buf: bytes, traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ..., *, builder: Literal[True]) -> AbstractContextManager[IIPBuilder]: ...
    def from_bytes_packed(self, buf: bytes, traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ...) -> _DynamicStructReader: ...
    @override
    def read(self, file: IO[str] | IO[bytes], traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ...) -> IIPReader: ...
    @override
    def read_packed(self, file: IO[str] | IO[bytes], traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ...) -> IIPReader: ...
...
class _ChannelModule(_IdentifiableModule, _PersistentModule):
    ...
    class _MsgModule(_StructModule):
        ...
        @override
        def new_message(self, num_first_segment_words: int | None = None, allocate_seg_callable: Any = None, value: AnyPointer | None = None, done: None | None = None, noMsg: None | None = None, **kwargs: Any) -> MsgBuilder: ...
        @overload
        def from_bytes(self, buf: bytes, traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ...) -> AbstractContextManager[MsgReader]: ...
        @overload
        def from_bytes(self, buf: bytes, traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ..., *, builder: Literal[False]) -> AbstractContextManager[MsgReader]: ...
        @overload
        def from_bytes(self, buf: bytes, traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ..., *, builder: Literal[True]) -> AbstractContextManager[MsgBuilder]: ...
        def from_bytes_packed(self, buf: bytes, traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ...) -> _DynamicStructReader: ...
        @override
        def read(self, file: IO[str] | IO[bytes], traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ...) -> MsgReader: ...
        @override
        def read_packed(self, file: IO[str] | IO[bytes], traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ...) -> MsgReader: ...
    ...
    class _ReaderModule(_IdentifiableModule, _PersistentModule):
        ...
        @classmethod
        def _new_client(cls, server: _DynamicCapabilityServer) -> _ChannelModule._ReaderModule.ReaderClient: ...
    ...
    class _WriterModule(_IdentifiableModule, _PersistentModule):
        ...
        @classmethod
        def _new_client(cls, server: _DynamicCapabilityServer) -> _ChannelModule._WriterModule.WriterClient: ...
        class Server(_IdentifiableModule.Server, _PersistentModule.Server):
    ...
    class _StartupInfoModule(_StructModule):
        ...
        class Builder(_DynamicStructBuilder):
            ...
            def closeSemantics(self, value: int | Literal["fbp", "no"]) -> None: ...
            @property
            def channelSR(self) -> str: ...
            @channelSR.setter
        ...
        def new_message(
            ...
            closeSemantics: int | Literal["fbp", "no"] | None = None,
        ...
        @overload
        def from_bytes(self, buf: bytes, traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ...) -> AbstractContextManager[StartupInfoReader]: ...
        @overload
        def from_bytes(self, buf: bytes, traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ..., *, builder: Literal[False]) -> AbstractContextManager[StartupInfoReader]: ...
        @overload
        def from_bytes(self, buf: bytes, traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ..., *, builder: Literal[True]) -> AbstractContextManager[StartupInfoBuilder]: ...
        def from_bytes_packed(self, buf: bytes, traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ...) -> _DynamicStructReader: ...
        @override
        def read(self, file: IO[str] | IO[bytes], traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ...) -> StartupInfoReader: ...
        @override
        def read_packed(self, file: IO[str] | IO[bytes], traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ...) -> StartupInfoReader: ...
    ...
    @classmethod
    def _new_client(cls, server: _DynamicCapabilityServer) -> _ChannelModule.ChannelClient: ...
    class Server(_IdentifiableModule.Server, _PersistentModule.Server):
        ...
        def setAutoCloseSemantics(self, cs: int | Literal["fbp", "no"], _context: _ChannelModule.Server.SetautoclosesemanticsCallContext, **kwargs: Any) -> Awaitable[None]: ...
    ...
    class ChannelClient(_IdentifiableModule.IdentifiableClient, _PersistentModule.PersistentClient):
        ...
        def setAutoCloseSemantics(self, cs: int | Literal["fbp", "no"] | None = None) -> _ChannelModule.ChannelClient.SetautoclosesemanticsResult: ...
        ...
        def setAutoCloseSemantics_request(self, cs: int | Literal["fbp", "no"] | None = None) -> _ChannelModule.SetautoclosesemanticsRequest: ...
...
class _StartChannelsServiceModule(_IdentifiableModule):
    ...
    @classmethod
    def _new_client(cls, server: _DynamicCapabilityServer) -> _StartChannelsServiceModule.StartChannelsServiceClient: ...
...
class _PortInfosModule(_StructModule):
    class _NameAndSRModule(_StructModule):
        ...
        @override
        def new_message(self, num_first_segment_words: int | None = None, allocate_seg_callable: Any = None, name: str | None = None, sr: str | None = None, srs: Sequence[str] | None = None, **kwargs: Any) -> NameAndSRBuilder: ...
        @overload
        def from_bytes(self, buf: bytes, traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ...) -> AbstractContextManager[NameAndSRReader]: ...
        @overload
        def from_bytes(self, buf: bytes, traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ..., *, builder: Literal[False]) -> AbstractContextManager[NameAndSRReader]: ...
        @overload
        def from_bytes(self, buf: bytes, traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ..., *, builder: Literal[True]) -> AbstractContextManager[NameAndSRBuilder]: ...
        def from_bytes_packed(self, buf: bytes, traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ...) -> _DynamicStructReader: ...
        @override
        def read(self, file: IO[str] | IO[bytes], traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ...) -> NameAndSRReader: ...
        @override
        def read_packed(self, file: IO[str] | IO[bytes], traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ...) -> NameAndSRReader: ...
    ...
    class Builder(_DynamicStructBuilder):
        ...
        @overload
        def init(self, field: Literal["inPorts"], size: int | None = None) -> MutableSequence[NameAndSRBuilder]: ...
        @overload
        def init(self, field: Literal["outPorts"], size: int | None = None) -> MutableSequence[NameAndSRBuilder]: ...
        @overload
        def init(self, field: str, size: int | None = None) -> Any: ...
        @override
    ...
    @override
    def new_message(self, num_first_segment_words: int | None = None, allocate_seg_callable: Any = None, inPorts: Sequence[NameAndSRBuilder] | Sequence[dict[str, Any]] | None = None, outPorts: Sequence[NameAndSRBuilder] | Sequence[dict[str, Any]] | None = None, **kwargs: Any) -> PortInfosBuilder: ...
    @overload
    def from_bytes(self, buf: bytes, traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ...) -> AbstractContextManager[PortInfosReader]: ...
    @overload
    def from_bytes(self, buf: bytes, traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ..., *, builder: Literal[False]) -> AbstractContextManager[PortInfosReader]: ...
    @overload
    def from_bytes(self, buf: bytes, traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ..., *, builder: Literal[True]) -> AbstractContextManager[PortInfosBuilder]: ...
    def from_bytes_packed(self, buf: bytes, traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ...) -> _DynamicStructReader: ...
    @override
    def read(self, file: IO[str] | IO[bytes], traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ...) -> PortInfosReader: ...
    @override
    def read_packed(self, file: IO[str] | IO[bytes], traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ...) -> PortInfosReader: ...
...
class _ComponentModule(_StructModule):
    class _RunnableModule(_IdentifiableModule):
        ...
        @classmethod
        def _new_client(cls, server: _DynamicCapabilityServer) -> _ComponentModule._RunnableModule.RunnableClient: ...
        class Server(_IdentifiableModule.Server):
            class StartResult(Awaitable[StartResult], Protocol):
                success: bool
    ...
    class _PortModule(_StructModule):
        ...
        class Builder(_DynamicStructBuilder):
            ...
            def type(self) -> int: ...
            @type.setter
            def type(self, value: int | Literal["standard"]) -> None: ...
            @override
            def as_reader(self) -> PortReader: ...

        @override
        def new_message(self, num_first_segment_words: int | None = None, allocate_seg_callable: Any = None, name: str | None = None, contentType: str | None = None, type: int | Literal["standard"] | None = None, **kwargs: Any) -> PortBuilder: ...
        @overload
        def from_bytes(self, buf: bytes, traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ...) -> AbstractContextManager[PortReader]: ...
        @overload
        def from_bytes(self, buf: bytes, traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ..., *, builder: Literal[False]) -> AbstractContextManager[PortReader]: ...
        @overload
        def from_bytes(self, buf: bytes, traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ..., *, builder: Literal[True]) -> AbstractContextManager[PortBuilder]: ...
        def from_bytes_packed(self, buf: bytes, traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ...) -> _DynamicStructReader: ...
        @override
        def read(self, file: IO[str] | IO[bytes], traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ...) -> PortReader: ...
        @override
        def read_packed(self, file: IO[str] | IO[bytes], traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ...) -> PortReader: ...
    ...
    class Builder(_DynamicStructBuilder):
        ...
        def type(self) -> int: ...
        @type.setter
        def type(self, value: int | Literal["standard", "iip", "subflow", "view"]) -> None: ...
        @property
        ...
        @overload
        def init(self, field: Literal["inPorts"], size: int | None = None) -> MutableSequence[PortBuilder]: ...
        @overload
        def init(self, field: Literal["outPorts"], size: int | None = None) -> MutableSequence[PortBuilder]: ...
        @overload
        def init(self, field: str, size: int | None = None) -> Any: ...
        @override
    ...
    def new_message(
        ...
        type: int | Literal["standard", "iip", "subflow", "view"] | None = None,
    ...
    @overload
    def from_bytes(self, buf: bytes, traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ...) -> AbstractContextManager[ComponentReader]: ...
    @overload
    def from_bytes(self, buf: bytes, traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ..., *, builder: Literal[False]) -> AbstractContextManager[ComponentReader]: ...
    @overload
    def from_bytes(self, buf: bytes, traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ..., *, builder: Literal[True]) -> AbstractContextManager[ComponentBuilder]: ...
    def from_bytes_packed(self, buf: bytes, traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ...) -> _DynamicStructReader: ...
    @override
    def read(self, file: IO[str] | IO[bytes], traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ...) -> ComponentReader: ...
    @override
    def read_packed(self, file: IO[str] | IO[bytes], traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ...) -> ComponentReader: ...

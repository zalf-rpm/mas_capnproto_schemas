...
module_file = os.path.abspath(os.path.join(here, "../zalfmas_capnp_schemas/persistence.capnp"))
...
Gateway.Server.RegisterResultTuple = NamedTuple("RegisterResultTuple", [("sturdyRef", object), ("heartbeat", object), ("secsHeartbeatInterval", object)])
HostPortResolver.Server.ResolveResultTuple = NamedTuple("ResolveResultTuple", [("host", object), ("port", object)])
HostPortResolver.Registrar.Server.RegisterResultTuple = NamedTuple("RegisterResultTuple", [("heartbeat", object), ("secsHeartbeatInterval", object)])
Persistent.Server.SaveResultTuple = NamedTuple("SaveResultTuple", [("sturdyRef", object), ("unsaveSR", object)])
Persistent.ReleaseSturdyRef.Server.ReleaseResultTuple = NamedTuple("ReleaseResultTuple", [("success", object)])

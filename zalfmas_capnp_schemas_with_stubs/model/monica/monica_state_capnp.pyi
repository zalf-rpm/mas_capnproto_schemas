...
class MaybeBoolBuilder(MaybeBool):
    @property
    def value(self) -> bool: ...
    @value.setter
...
class CropModuleState:
    ...
    @property
    def pcOrganIdsForPrimaryYield(self) -> Sequence[YieldComponent]: ...
    @property
    def pcOrganIdsForSecondaryYield(self) -> Sequence[YieldComponent]: ...
    @property
    def pcOrganIdsForCutting(self) -> Sequence[YieldComponent]: ...
    @property
    ...
    @property
    def guentherEmissions(self) -> Voc.Emissions: ...
    @property
    def jjvEmissions(self) -> Voc.Emissions: ...
    @property
    def vocSpecies(self) -> Voc.SpeciesData: ...
    @property
    def cropPhotosynthesisResults(self) -> Voc.CPData: ...
    @property
    ...
    def from_bytes(
        ...
        traversal_limit_in_words: int | None = ...,
        nesting_limit: int | None = ...,
    ) -> Iterator[CropModuleStateReader]: ...
    @staticmethod
    def from_bytes_packed(
        data: bytes,
        traversal_limit_in_words: int | None = ...,
...
class CropModuleStateReader(CropModuleState):
    ...
    @property
    def guentherEmissions(self) -> Voc.EmissionsReader: ...
    @property
    def jjvEmissions(self) -> Voc.EmissionsReader: ...
    @property
    def vocSpecies(self) -> Voc.SpeciesDataReader: ...
    @property
    def cropPhotosynthesisResults(self) -> Voc.CPDataReader: ...
    @property
    ...
    def as_builder(self) -> CropModuleStateBuilder: ...

class CropModuleStateBuilder(CropModuleState):
    @property
    def frostKillOn(self) -> bool: ...
    @frostKillOn.setter
    ...
    @overload
    def init(self: Any, name: Literal["jjvEmissions"]) -> Voc.EmissionsBuilder: ...
    @overload
    def init(self: Any, name: Literal["vocSpecies"]) -> Voc.SpeciesDataBuilder: ...
    @overload
    def init(
    ...
    @overload
    def init(self: Any, name: Literal["rad24"], size: int = ...) -> Sequence[float]: ...
    @overload
    def init(
    ...
    def init(self: Any, name: str, size: int = ...) -> Any: ...
    def copy(self) -> CropModuleStateBuilder: ...
    def to_bytes(self) -> bytes: ...
    def to_bytes_packed(self) -> bytes: ...
    def to_segments(self) -> list[bytes]: ...
...
class AOMPropertiesBuilder(AOMProperties):
    @property
    def aomSlow(self) -> float: ...
    @aomSlow.setter
...
class SoilLayerState:
    ...
    @property
    def voAOMPool(self) -> Sequence[AOMProperties]: ...
    @property
...
class SoilLayerStateReader(SoilLayerState):
    ...
    def as_builder(self) -> SoilLayerStateBuilder: ...

class SoilLayerStateBuilder(SoilLayerState):
    @property
    def layerThickness(self) -> float: ...
    ...
    ) -> Sequence[AOMPropertiesBuilder]: ...
    def init(self: Any, name: str, size: int = ...) -> Any: ...
    def copy(self) -> SoilLayerStateBuilder: ...
    def to_bytes(self) -> bytes: ...
    def to_bytes_packed(self) -> bytes: ...
    def to_segments(self) -> list[bytes]: ...
...
class SoilColumnState:
    class DelayedNMinApplicationParams:
        @property
        def fp(self) -> Params.MineralFertilization.Parameters: ...
        @property
        ...
        def from_bytes(
            ...
            traversal_limit_in_words: int | None = ...,
            nesting_limit: int | None = ...,
        ) -> Iterator[SoilColumnState.DelayedNMinApplicationParamsReader]: ...
        @staticmethod
        def from_bytes_packed(
            data: bytes,
            traversal_limit_in_words: int | None = ...,
    ...
    class DelayedNMinApplicationParamsReader(
        ...
        @property
        def fp(self) -> Params.MineralFertilization.ParametersReader: ...
        def as_builder(self) -> SoilColumnState.DelayedNMinApplicationParamsBuilder: ...

    class DelayedNMinApplicationParamsBuilder(
        SoilColumnState.DelayedNMinApplicationParams
    ):
        @property
        def fp(self) -> Params.MineralFertilization.ParametersBuilder: ...
        @fp.setter
        def fp(
            self,
        ...
        def copy(self) -> SoilColumnState.DelayedNMinApplicationParamsBuilder: ...
        def to_bytes(self) -> bytes: ...
        def to_bytes_packed(self) -> bytes: ...
        def to_segments(self) -> list[bytes]: ...
        def as_reader(self) -> SoilColumnState.DelayedNMinApplicationParamsReader: ...
        @staticmethod
        def write(file: BufferedWriter) -> None: ...
        @staticmethod
        def write_packed(file: BufferedWriter) -> None: ...
    ...
    @property
    def vfTopDressingPartition(self) -> Params.MineralFertilization.Parameters: ...
    @property
    def vfTopDressingDelay(self) -> int: ...
    @property
    def cropModule(self) -> CropModuleState: ...
    @property
    def delayedNMinApplications(
        self,
    ) -> Sequence[SoilColumnState.DelayedNMinApplicationParams]: ...
    @property
    def pmCriticalMoistureDepth(self) -> float: ...
    @property
    def layers(self) -> Sequence[SoilLayerState]: ...
    @overload
    def init(
    ...
    def from_bytes(
        ...
        traversal_limit_in_words: int | None = ...,
        nesting_limit: int | None = ...,
    ) -> Iterator[SoilColumnStateReader]: ...
    @staticmethod
    def from_bytes_packed(
        data: bytes,
        traversal_limit_in_words: int | None = ...,
...
class SoilColumnStateReader(SoilColumnState):
    ...
    def delayedNMinApplications(
        self,
    ) -> Sequence[SoilColumnState.DelayedNMinApplicationParamsReader]: ...
    @property
    def layers(self) -> Sequence[SoilLayerStateReader]: ...
    def as_builder(self) -> SoilColumnStateBuilder: ...

class SoilColumnStateBuilder(SoilColumnState):
    @property
    def vsSurfaceWaterStorage(self) -> float: ...
    ...
    @overload
    def init(self: Any, name: Literal["cropModule"]) -> CropModuleStateBuilder: ...
    @overload
    def init(
    ...
    ) -> Sequence[SoilLayerStateBuilder]: ...
    def init(self: Any, name: str, size: int = ...) -> Any: ...
    def copy(self) -> SoilColumnStateBuilder: ...
    def to_bytes(self) -> bytes: ...
    def to_bytes_packed(self) -> bytes: ...
    def to_segments(self) -> list[bytes]: ...
...
class SoilTemperatureModuleState:
    ...
    @property
    def moduleParams(self) -> SoilTemperatureModuleParameters: ...
    @property
    def dampingFactor(self) -> float: ...
    @property
    def soilColumnVtGroundLayer(self) -> SoilLayerState: ...
    @property
    def soilColumnVtBottomLayer(self) -> SoilLayerState: ...
    @property
    ...
    def from_bytes(
        ...
        traversal_limit_in_words: int | None = ...,
        nesting_limit: int | None = ...,
    ) -> Iterator[SoilTemperatureModuleStateReader]: ...
    @staticmethod
    def from_bytes_packed(
        data: bytes,
        traversal_limit_in_words: int | None = ...,
...
class SoilTemperatureModuleStateReader(SoilTemperatureModuleState):
    ...
    def as_builder(self) -> SoilTemperatureModuleStateBuilder: ...

class SoilTemperatureModuleStateBuilder(SoilTemperatureModuleState):
    @property
    def soilSurfaceTemperature(self) -> float: ...
    ...
    def init(self: Any, name: str, size: int = ...) -> Any: ...
    def copy(self) -> SoilTemperatureModuleStateBuilder: ...
    def to_bytes(self) -> bytes: ...
    def to_bytes_packed(self) -> bytes: ...
    def to_segments(self) -> list[bytes]: ...
...
class FrostModuleState:
    ...
    def from_bytes(
        ...
        traversal_limit_in_words: int | None = ...,
        nesting_limit: int | None = ...,
    ) -> Iterator[FrostModuleStateReader]: ...
    @staticmethod
    def from_bytes_packed(
        data: bytes,
        traversal_limit_in_words: int | None = ...,
...
class FrostModuleStateBuilder(FrostModuleState):
    @property
    def pmHydraulicConductivityRedux(self) -> float: ...
    ...
    def copy(self) -> FrostModuleStateBuilder: ...
    def to_bytes(self) -> bytes: ...
    def to_bytes_packed(self) -> bytes: ...
    def to_segments(self) -> list[bytes]: ...
...
class SnowModuleState:
    ...
    def from_bytes(
        ...
        traversal_limit_in_words: int | None = ...,
        nesting_limit: int | None = ...,
    ) -> Iterator[SnowModuleStateReader]: ...
    @staticmethod
    def from_bytes_packed(
        data: bytes,
        traversal_limit_in_words: int | None = ...,
...
class SnowModuleStateBuilder(SnowModuleState):
    @property
    def snowRetentionCapacityMax(self) -> float: ...
...
class SoilMoistureModuleState:
    @property
    def frostComponent(self) -> FrostModuleState: ...
    @property
    def snowComponent(self) -> SnowModuleState: ...
    @property
    def xSACriticalSoilMoisture(self) -> float: ...
    @property
    def moduleParams(self) -> SoilMoistureModuleParameters: ...
    @property
    ...
    def from_bytes(
        ...
        traversal_limit_in_words: int | None = ...,
        nesting_limit: int | None = ...,
    ) -> Iterator[SoilMoistureModuleStateReader]: ...
    @staticmethod
    def from_bytes_packed(
        data: bytes,
        traversal_limit_in_words: int | None = ...,
...
class SoilMoistureModuleStateReader(SoilMoistureModuleState):
    ...
    def as_builder(self) -> SoilMoistureModuleStateBuilder: ...

class SoilMoistureModuleStateBuilder(SoilMoistureModuleState):
    @property
    ...
    @overload
    def init(self: Any, name: Literal["snowComponent"]) -> SnowModuleStateBuilder: ...
    @overload
    def init(
        self: Any, name: Literal["moduleParams"]
    ) -> SoilMoistureModuleParametersBuilder: ...
    ...
    def init(self: Any, name: str, size: int = ...) -> Any: ...
    def copy(self) -> SoilMoistureModuleStateBuilder: ...
    def to_bytes(self) -> bytes: ...
    def to_bytes_packed(self) -> bytes: ...
    def to_segments(self) -> list[bytes]: ...
...
class SoilOrganicModuleState:
    ...
    @property
    def moduleParams(self) -> SoilOrganicModuleParameters: ...
    @property
    def vsNumberOfLayers(self) -> int: ...
    @property
    ...
    def from_bytes(
        ...
        traversal_limit_in_words: int | None = ...,
        nesting_limit: int | None = ...,
    ) -> Iterator[SoilOrganicModuleStateReader]: ...
    @staticmethod
    def from_bytes_packed(
        data: bytes,
        traversal_limit_in_words: int | None = ...,
...
class SoilOrganicModuleStateReader(SoilOrganicModuleState):
    ...
    def as_builder(self) -> SoilOrganicModuleStateBuilder: ...

class SoilOrganicModuleStateBuilder(SoilOrganicModuleState):
    @property
    def incorporation(self) -> bool: ...
    @incorporation.setter
    def incorporation(self, value: bool) -> None: ...
    ...
    def init(self: Any, name: str, size: int = ...) -> Any: ...
    def copy(self) -> SoilOrganicModuleStateBuilder: ...
    def to_bytes(self) -> bytes: ...
    def to_bytes_packed(self) -> bytes: ...
    def to_segments(self) -> list[bytes]: ...
...
class SoilTransportModuleState:
    ...
    @property
    def moduleParams(self) -> SoilTransportModuleParameters: ...
    @property
    ...
    def from_bytes(
        ...
        traversal_limit_in_words: int | None = ...,
        nesting_limit: int | None = ...,
    ) -> Iterator[SoilTransportModuleStateReader]: ...
    @staticmethod
    def from_bytes_packed(
        data: bytes,
        traversal_limit_in_words: int | None = ...,
...
class SoilTransportModuleStateReader(SoilTransportModuleState):
    ...
    def as_builder(self) -> SoilTransportModuleStateBuilder: ...

class SoilTransportModuleStateBuilder(SoilTransportModuleState):
    @property
    def pcMinimumAvailableN(self) -> float: ...
    ...
    def init(self: Any, name: str, size: int = ...) -> Any: ...
    def copy(self) -> SoilTransportModuleStateBuilder: ...
    def to_bytes(self) -> bytes: ...
    def to_bytes_packed(self) -> bytes: ...
    def to_segments(self) -> list[bytes]: ...
...
class MonicaModelState:
    class ACDToValue:
        ...
        def from_bytes(
            ...
            traversal_limit_in_words: int | None = ...,
            nesting_limit: int | None = ...,
        ) -> Iterator[MonicaModelState.ACDToValueReader]: ...
        @staticmethod
        def from_bytes_packed(
            data: bytes,
            traversal_limit_in_words: int | None = ...,
    ...
    class ACDToValueBuilder(MonicaModelState.ACDToValue):
        @property
        def acd(self) -> int: ...
        @acd.setter
        ...
        def to_bytes_packed(self) -> bytes: ...
        def to_segments(self) -> list[bytes]: ...
        def as_reader(self) -> MonicaModelState.ACDToValueReader: ...
        @staticmethod
        def write(file: BufferedWriter) -> None: ...
        @staticmethod
        def write_packed(file: BufferedWriter) -> None: ...
    ...
    @property
    def sitePs(self) -> SiteParameters: ...
    @property
    def cultivationMethodCount(self) -> int: ...
    @property
    def envPs(self) -> EnvironmentParameters: ...
    @property
    def cropPs(self) -> CropModuleParameters: ...
    @property
    ...
    @property
    def simPs(self) -> SimulationParameters: ...
    @property
    def groundwaterInformation(self) -> MeasuredGroundwaterTableInformation: ...
    @property
    def soilColumn(self) -> SoilColumnState: ...
    @property
    def soilTemperature(self) -> SoilTemperatureModuleState: ...
    @property
    def soilMoisture(self) -> SoilMoistureModuleState: ...
    @property
    def soilOrganic(self) -> SoilOrganicModuleState: ...
    @property
    def soilTransport(self) -> SoilTransportModuleState: ...
    @property
    def accuOxygenStress(self) -> float: ...
    @property
    def currentCropModule(self) -> CropModuleState: ...
    @property
    ...
    @property
    def currentStepDate(self) -> Date: ...
    @property
    def climateData(self) -> Sequence[Sequence[MonicaModelState.ACDToValue]]: ...
    @property
    ...
    def from_bytes(
        ...
        traversal_limit_in_words: int | None = ...,
        nesting_limit: int | None = ...,
    ) -> Iterator[MonicaModelStateReader]: ...
    @staticmethod
    def from_bytes_packed(
        data: bytes,
        traversal_limit_in_words: int | None = ...,
...
class MonicaModelStateReader(MonicaModelState):
    ...
    @property
    def climateData(self) -> Sequence[Sequence[MonicaModelState.ACDToValueReader]]: ...
    def as_builder(self) -> MonicaModelStateBuilder: ...

class MonicaModelStateBuilder(MonicaModelState):
    @property
    ...
    @overload
    def init(self: Any, name: Literal["envPs"]) -> EnvironmentParametersBuilder: ...
    @overload
    def init(self: Any, name: Literal["cropPs"]) -> CropModuleParametersBuilder: ...
    @overload
    def init(self: Any, name: Literal["simPs"]) -> SimulationParametersBuilder: ...
    @overload
    def init(
        self: Any, name: Literal["groundwaterInformation"]
    ) -> MeasuredGroundwaterTableInformationBuilder: ...
    @overload
    def init(self: Any, name: Literal["soilColumn"]) -> SoilColumnStateBuilder: ...
    @overload
    def init(
    ...
    @overload
    def init(self: Any, name: Literal["currentStepDate"]) -> DateBuilder: ...
    @overload
    def init(
        self: Any, name: Literal["climateData"], size: int = ...
    ) -> Sequence[MonicaModelState.ACDToValueBuilder]: ...
    @overload
    def init(
    ...
    def init(self: Any, name: str, size: int = ...) -> Any: ...
    def copy(self) -> MonicaModelStateBuilder: ...
    def to_bytes(self) -> bytes: ...
    def to_bytes_packed(self) -> bytes: ...
    def to_segments(self) -> list[bytes]: ...
...
class RuntimeState:
    @property
    def modelState(self) -> MonicaModelState: ...
...
class RuntimeStateReader(RuntimeState):
    ...
    def as_builder(self) -> RuntimeStateBuilder: ...

class RuntimeStateBuilder(RuntimeState):
    @property
    ...
    def init(self, name: Literal["modelState"]) -> MonicaModelStateBuilder: ...
...
class CropState:
    @property
    def automaticHarvestParams(self) -> AutomaticHarvestParameters: ...
    @property
    def speciesName(self) -> str: ...
    @property
    def cultivarName(self) -> str: ...
    @property
    def seedDate(self) -> Date: ...
    @property
    def harvestDate(self) -> Date: ...
    @property
    def isWinterCrop(self) -> MaybeBool: ...
    @property
    def isPerennialCrop(self) -> MaybeBool: ...
    @property
    def cuttingDates(self) -> Sequence[Date]: ...
    @property
    def cropParams(self) -> CropParameters: ...
    @property
    def perennialCropParams(self) -> CropParameters: ...
    @property
    def residueParams(self) -> CropResidueParameters: ...
    @property
...
class CropStateReader(CropState):
    ...
    @property
    def residueParams(self) -> CropResidueParametersReader: ...
    def as_builder(self) -> CropStateBuilder: ...

class CropStateBuilder(CropState):
    @property
    ...
    @overload
    def init(self: Any, name: Literal["seedDate"]) -> DateBuilder: ...
    @overload
    def init(self: Any, name: Literal["harvestDate"]) -> DateBuilder: ...
    @overload
    def init(self: Any, name: Literal["isWinterCrop"]) -> MaybeBoolBuilder: ...
    @overload
    def init(self: Any, name: Literal["isPerennialCrop"]) -> MaybeBoolBuilder: ...
    @overload
    ...
    ) -> Sequence[DateBuilder]: ...
    def init(self: Any, name: str, size: int = ...) -> Any: ...
    def copy(self) -> CropStateBuilder: ...
    def to_bytes(self) -> bytes: ...
    def to_bytes_packed(self) -> bytes: ...
    def to_segments(self) -> list[bytes]: ...

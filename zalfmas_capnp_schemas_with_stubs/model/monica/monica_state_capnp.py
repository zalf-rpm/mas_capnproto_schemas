...
module_file = os.path.abspath(os.path.join(here, "../../../zalfmas_capnp_schemas/model/monica/monica_state.capnp"))
...
SoilTemperatureModuleState = capnp.load(module_file, imports=import_path).SoilTemperatureModuleState
SoilMoistureModuleState = capnp.load(module_file, imports=import_path).SoilMoistureModuleState
...
SoilOrganicModuleState = capnp.load(module_file, imports=import_path).SoilOrganicModuleState
SoilTransportModuleState = capnp.load(module_file, imports=import_path).SoilTransportModuleState

...
from .common_capnp import Pair, PairBuilder, PairReader
from contextlib import contextmanager
from capnp import _DynamicListBuilder
from io import BufferedWriter
from collections.abc import Iterator, Sequence, Awaitable
from typing import Literal, Generic, TypeVar, Protocol, Any, BinaryIO, NamedTuple
...
class Admin(Identifiable, Protocol):
    ...
    class SettimeoutRequest(Protocol):
        seconds: int
        def send(self) -> Awaitable[None]: ...
    def setTimeout_request(self, seconds: int = 0) -> SettimeoutRequest: ...
    ...
    class UpdateidentityRequest(Protocol):
        ...
        newInfo: Any
        def send(self) -> Awaitable[None]: ...
    def updateIdentity_request(self, oldId: str = "", newInfo: Any = ...) -> UpdateidentityRequest: ...
    @classmethod
    def _new_client(cls, server: Admin.Server | Identifiable.Server) -> Admin: ...
    class Server(Identifiable.Server):
        def heartbeat(self, _context: Admin.HeartbeatCallContext, **kwargs: Any) -> Awaitable[None]: ...
        def setTimeout(self, seconds: int, _context: Admin.SettimeoutCallContext, **kwargs: Any) -> Awaitable[None]: ...
        def stop(self, _context: Admin.StopCallContext, **kwargs: Any) -> Awaitable[None]: ...
        def identities(self, _context: Admin.IdentitiesCallContext, **kwargs: Any) -> Awaitable[Any | None]: ...
        def updateIdentity(self, oldId: str, newInfo: Any, _context: Admin.UpdateidentityCallContext, **kwargs: Any) -> Awaitable[None]: ...
class SimpleFactory(Identifiable, Protocol):
    ...
    @classmethod
    def _new_client(cls, server: SimpleFactory.Server | Identifiable.Server) -> SimpleFactory: ...
    class Server(Identifiable.Server):
        def create(self, _context: SimpleFactory.CreateCallContext, **kwargs: Any) -> Awaitable[Sequence[Identifiable] | None]: ...
class Factory(Identifiable, Protocol):
    class CreateParams(Generic[Factory_Payload]):
        ...
        @staticmethod
        @contextmanager
        def from_bytes(data: bytes, traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ...) -> Iterator[Factory.CreateParamsReader]: ...
        @staticmethod
        def from_bytes_packed(data: bytes, traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ...) -> Factory.CreateParamsReader: ...
        @staticmethod
        def new_message(num_first_segment_words: int | None = None, timeoutSeconds: int | None = None, interfaceNameToRegistrySR: Sequence[PairBuilder] | Sequence[dict[str, Any]] | None = None, msgPayload: Factory_Payload | None = None) -> Factory.CreateParamsBuilder: ...
        @staticmethod
        def read(file: BinaryIO, traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ...) -> Factory.CreateParamsReader: ...
        @staticmethod
        def read_packed(file: BinaryIO, traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ...) -> Factory.CreateParamsReader: ...
    ...
    class CreateParamsBuilder(Factory.CreateParams, Generic[Factory_Payload]):
        ...
        def interfaceNameToRegistrySR(self, value: Sequence[Pair | PairBuilder | PairReader] | Sequence[dict[str, Any]]) -> None: ...
        @property
        def msgPayload(self) -> Factory_Payload: ...
        @msgPayload.setter
        ...
        def init(self, name: Literal["interfaceNameToRegistrySR"], size: int = ...) -> _DynamicListBuilder[PairBuilder]: ...
    ...
    class AccessInfo:
        ...
        @staticmethod
        @contextmanager
        def from_bytes(data: bytes, traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ...) -> Iterator[Factory.AccessInfoReader]: ...
        @staticmethod
        def from_bytes_packed(data: bytes, traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ...) -> Factory.AccessInfoReader: ...
        @staticmethod
        def new_message(num_first_segment_words: int | None = None, adminCap: Any | None = None, serviceCaps: Sequence[Identifiable] | None = None, error: str | None = None) -> Factory.AccessInfoBuilder: ...
        @staticmethod
        def read(file: BinaryIO, traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ...) -> Factory.AccessInfoReader: ...
        @staticmethod
        def read_packed(file: BinaryIO, traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ...) -> Factory.AccessInfoReader: ...
        def to_dict(self) -> dict[str, Any]: ...
    ...
    class AccessInfoBuilder(Factory.AccessInfo):
        ...
        def init(self, name: Literal["serviceCaps"], size: int = ...) -> _DynamicListBuilder[Identifiable]: ...
    ...
    def create(self, timeoutSeconds: int = 0, interfaceNameToRegistrySR: Sequence[Pair[str, str]] = [], msgPayload: Any = ...) -> Awaitable[Factory.CreateResult]: ...
    class CreateRequest(Protocol):
        timeoutSeconds: int
        interfaceNameToRegistrySR: Sequence[Pair[str, str]]
        msgPayload: Any
        def send(self) -> Awaitable[Factory.CreateResult]: ...
        def init(self, name: Literal["interfaceNameToRegistrySR"], size: int) -> _DynamicListBuilder[Pair[str, str]Builder]: ...
    def create_request(self, timeoutSeconds: int = 0, interfaceNameToRegistrySR: Sequence[Pair[str, str]] = [], msgPayload: Any = ...) -> CreateRequest: ...
    ...
    class Server(Identifiable.Server):
        class CreateResult(NamedTuple):
            ...
            serviceCaps: Sequence[Identifiable]
            error: str
        def create(self, timeoutSeconds: int, interfaceNameToRegistrySR: Sequence[Pair[str, str]], msgPayload: Any, _context: Factory.CreateCallContext, **kwargs: Any) -> Awaitable[Factory.Server.CreateResult | None]: ...
        def serviceInterfaceNames(self, _context: Factory.ServiceinterfacenamesCallContext, **kwargs: Any) -> Awaitable[Sequence[str] | None]: ...
class Stoppable(Protocol):
    ...
    class Server:
        def stop(self, _context: Stoppable.StopCallContext, **kwargs: Any) -> Awaitable[bool | None]: ...
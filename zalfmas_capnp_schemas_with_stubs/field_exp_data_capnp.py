...
module_file = os.path.abspath(os.path.join(here, "../zalfmas_capnp_schemas/field_exp_data.capnp"))
...
ExperimentDescription = capnp.load(module_file, imports=import_path).ExperimentDescription
...
InitialConditionsLayer = capnp.load(module_file, imports=import_path).InitialConditionsLayer
...
EnvironmentModification = capnp.load(module_file, imports=import_path).EnvironmentModification

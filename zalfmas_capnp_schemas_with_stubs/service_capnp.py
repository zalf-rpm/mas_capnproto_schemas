...
module_file = os.path.abspath(os.path.join(here, "../zalfmas_capnp_schemas/service.capnp"))
...
Factory.Server.CreateResultTuple = NamedTuple("CreateResultTuple", [("adminCap", object), ("serviceCaps", object), ("error", object)])
Factory.Server.ServiceinterfacenamesResultTuple = NamedTuple("ServiceinterfacenamesResultTuple", [("names", object)])
SimpleFactory.Server.CreateResultTuple = NamedTuple("CreateResultTuple", [("caps", object)])

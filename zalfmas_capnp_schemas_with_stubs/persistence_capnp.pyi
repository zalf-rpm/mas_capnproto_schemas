...
class _VatIdModule(_StructModule):
    class Reader(_DynamicStructReader):
        ...
        @override
        def as_builder(self, num_first_segment_words: int | None = None, allocate_seg_callable: Any = None) -> VatIdBuilder: ...
    ...
    @override
    def new_message(self, num_first_segment_words: int | None = None, allocate_seg_callable: Any = None, publicKey0: int | None = None, publicKey1: int | None = None, publicKey2: int | None = None, publicKey3: int | None = None) -> VatIdBuilder: ...
...
class _AddressModule(_StructModule):
    class _Ip6Module(_StructModule):
        class Reader(_DynamicStructReader):
            ...
            @override
            def as_builder(self, num_first_segment_words: int | None = None, allocate_seg_callable: Any = None) -> Ip6Builder: ...
        ...
        @override
        def new_message(self, num_first_segment_words: int | None = None, allocate_seg_callable: Any = None, lower64: int | None = None, upper64: int | None = None) -> Ip6Builder: ...
    ...
    class Reader(_DynamicStructReader):
        ...
        @override
        def as_builder(self, num_first_segment_words: int | None = None, allocate_seg_callable: Any = None) -> AddressBuilder: ...
    ...
    @override
    def new_message(self, num_first_segment_words: int | None = None, allocate_seg_callable: Any = None, ip6: Ip6Builder | dict[str, Any] | None = None, port: int | None = None, host: str | None = None) -> AddressBuilder: ...
...
class _VatPathModule(_StructModule):
    class Reader(_DynamicStructReader):
        ...
        @override
        def as_builder(self, num_first_segment_words: int | None = None, allocate_seg_callable: Any = None) -> VatPathBuilder: ...
    ...
    class Builder(_DynamicStructBuilder):
        ...
        @address.setter
        def address(self, value: AddressBuilder | AddressReader | dict[str, Any]) -> None: ...
        @overload
    ...
    @override
    def new_message(self, num_first_segment_words: int | None = None, allocate_seg_callable: Any = None, id: VatIdBuilder | dict[str, Any] | None = None, address: AddressBuilder | dict[str, Any] | None = None) -> VatPathBuilder: ...
...
class _SturdyRefModule(_StructModule):
    class _OwnerModule(_StructModule):
        class Reader(_DynamicStructReader):
            ...
            def guid(self) -> str: ...
            @override
            def as_builder(self, num_first_segment_words: int | None = None, allocate_seg_callable: Any = None) -> OwnerBuilder: ...
        ...
        @override
        def new_message(self, num_first_segment_words: int | None = None, allocate_seg_callable: Any = None, guid: str | None = None) -> OwnerBuilder: ...
    ...
    class _TokenModule(_StructModule):
        class Reader(_DynamicStructReader):
            ...
            @override
            def as_builder(self, num_first_segment_words: int | None = None, allocate_seg_callable: Any = None) -> TokenBuilder: ...
        ...
        @override
        def new_message(self, num_first_segment_words: int | None = None, allocate_seg_callable: Any = None, text: str | None = None, data: bytes | None = None) -> TokenBuilder: ...
    ...
    class Reader(_DynamicStructReader):
        ...
        @override
        def as_builder(self, num_first_segment_words: int | None = None, allocate_seg_callable: Any = None) -> SturdyRefBuilder: ...
    ...
    @override
    def new_message(self, num_first_segment_words: int | None = None, allocate_seg_callable: Any = None, vat: VatPathBuilder | dict[str, Any] | None = None, localRef: TokenBuilder | dict[str, Any] | None = None) -> SturdyRefBuilder: ...
...
class _PersistentModule(_InterfaceModule):
    class _SaveParamsModule(_StructModule):
        ...
        @override
        def new_message(self, num_first_segment_words: int | None = None, allocate_seg_callable: Any = None, sealFor: OwnerBuilder | dict[str, Any] | None = None) -> SaveParamsBuilder: ...
    ...
    class _SaveResultsModule(_StructModule):
        ...
        class Builder(_DynamicStructBuilder):
            ...
            @sturdyRef.setter
            def sturdyRef(self, value: SturdyRefBuilder | SturdyRefReader | dict[str, Any]) -> None: ...
            @property
            def unsaveSR(self) -> SturdyRefBuilder: ...
            @unsaveSR.setter
            def unsaveSR(self, value: SturdyRefBuilder | SturdyRefReader | dict[str, Any]) -> None: ...
            @overload
        ...
        @override
        def new_message(self, num_first_segment_words: int | None = None, allocate_seg_callable: Any = None, sturdyRef: SturdyRefBuilder | dict[str, Any] | None = None, unsaveSR: SturdyRefBuilder | dict[str, Any] | None = None) -> SaveResultsBuilder: ...
...
class _RestorerModule(_InterfaceModule):
    class _RestoreParamsModule(_StructModule):
        class Reader(_DynamicStructReader):
            ...
            @override
            def as_builder(self, num_first_segment_words: int | None = None, allocate_seg_callable: Any = None) -> RestoreParamsBuilder: ...
        ...
        @override
        def new_message(self, num_first_segment_words: int | None = None, allocate_seg_callable: Any = None, localRef: TokenBuilder | dict[str, Any] | None = None, sealedBy: OwnerBuilder | dict[str, Any] | None = None) -> RestoreParamsBuilder: ...
    ...
    class _RegistrarModule(_InterfaceModule):
        class _RegisterParamsModule(_StructModule):
            class Reader(_DynamicStructReader):
                ...
                @override
                def as_builder(self, num_first_segment_words: int | None = None, allocate_seg_callable: Any = None) -> RegisterParamsBuilder: ...
            ...
            @override
            def new_message(self, num_first_segment_words: int | None = None, allocate_seg_callable: Any = None, base64VatId: str | None = None, host: str | None = None, port: int | None = None, alias: str | None = None, identityProof: bytes | None = None) -> RegisterParamsBuilder: ...
...
class _GatewayModule(_IdentifiableModule, _RestorerModule):
    class _RegResultsModule(_StructModule):
        class Reader(_DynamicStructReader):
            ...
            @override
            def as_builder(self, num_first_segment_words: int | None = None, allocate_seg_callable: Any = None) -> RegResultsBuilder: ...
        ...
        @override
        def new_message(
            self, num_first_segment_words: int | None = None, allocate_seg_callable: Any = None, sturdyRef: SturdyRefBuilder | dict[str, Any] | None = None, heartbeat: _HeartbeatModule.HeartbeatClient | _HeartbeatModule.Server | None = None, secsHeartbeatInterval: int | None = None
        ) -> RegResultsBuilder: ...
    ...
    class Server(_IdentifiableModule.Server, _RestorerModule.Server):
        ...
        def register(self, cap: AnyPointer, _context: _GatewayModule.Server.RegisterCallContext, **kwargs: Any) -> Awaitable[_GatewayModule.Server.RegisterResultTuple | None]: ...
    ...
    class GatewayClient(_IdentifiableModule.IdentifiableClient, _RestorerModule.RestorerClient):
        ...
        def register_request(self, cap: AnyPointer | None = None) -> _GatewayModule.RegisterRequest: ...

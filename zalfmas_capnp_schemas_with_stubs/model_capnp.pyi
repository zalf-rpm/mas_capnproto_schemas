...
class XYResultBuilder(XYResult):
    ...
    @overload
    def init(self: Any, name: Literal["xs"], size: int = ...) -> Sequence[float]: ...
    @overload
    def init(self: Any, name: Literal["ys"], size: int = ...) -> Sequence[float]: ...
...
class ClimateInstance(Identifiable, Protocol):
    ...
    def run(self, timeSeries: Any = None) -> RunResult: ...
    ...
    def runSet(self, dataset: Any = None) -> RunsetResult: ...

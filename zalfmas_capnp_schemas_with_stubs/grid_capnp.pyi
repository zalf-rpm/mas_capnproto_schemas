...
class Grid(Identifiable, Persistent, Protocol):
    ...
    class Callback(Protocol):
        ...
        def sendCells_request(self, maxCount: int = 0) -> SendcellsRequest: ...
        @classmethod
        ...
        class Server:
            def sendCells(
                ...
                **kwargs: Any,
            ) -> Awaitable[Sequence[Grid.Location] | None]: ...
    ...
    class ClosestvalueatRequest(Protocol):
        ...
        @overload
        def init(self, name: Literal["resolution"]) -> Grid.ResolutionBuilder: ...
    ...
    class StreamcellsRequest(Protocol):
        ...
        @overload
        def init(self, name: Literal["topLeft"]) -> Grid.RowColBuilder: ...
        @overload
        def init(self, name: Literal["bottomRight"]) -> Grid.RowColBuilder: ...
        def init(self, name: str, size: int = ...) -> Any: ...
    ...
    class Server(Identifiable.Server, Persistent.Server):
        ...
        ) -> Awaitable[Grid.Resolution | None]: ...
        def dimension(
        ...
        def valueAt(
            ...
            **kwargs: Any,
        ) -> Awaitable[tuple[Grid.Value, Sequence[Grid.AggregationPart]] | None]: ...
        def latLonBounds(
            self,
            useCellCenter: bool,
            ...
            **kwargs: Any,
            ...
            tuple[LatLonCoord, LatLonCoord, LatLonCoord, LatLonCoord] | None
        ]: ...
        def streamCells(
            self,
            ...
            **kwargs: Any,
        ) -> Awaitable[Grid.Callback | Grid.Callback.Server | None]: ...
        def unit(

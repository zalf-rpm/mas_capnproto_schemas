...
class X(Protocol):
    ...
    def m(self, i: int | None = None) -> MResult: ...
    class MRequest(Protocol):
        i: int
        def send(self) -> X.MResult: ...

    def m_request(self, i: int | None = None) -> MRequest: ...
    @classmethod
...
class Y(Protocol):
    ...
    def m(self, hello: str | None = None) -> Awaitable[None]: ...
    class MRequest(Protocol):
        hello: str
        def send(self) -> Awaitable[None]: ...

    def m_request(self, hello: str | None = None) -> MRequest: ...
    @classmethod
...
class Z(Protocol):
    ...
    def m(self, n: int | None = None) -> MResult: ...
    class MRequest(Protocol):
        n: int
        def send(self) -> Z.MResult: ...

    def m_request(self, n: int | None = None) -> MRequest: ...
    @classmethod

...
class X(Protocol):
    ...
    def m(self, i: int = 0) -> MResult: ...
    class MRequest(Protocol):
        i: int
        def send(self) -> X.MResult: ...

    def m_request(self, i: int = 0) -> MRequest: ...
    @classmethod
...
class S:
    ...
    @staticmethod
    def new_message(
        num_first_segment_words: int | None = None, c: X | X.Server | None = None
    ) -> SBuilder: ...
    @staticmethod
    def read(
        file: BinaryIO,
...
class Y(Protocol):
    ...
    def m_request(self, hello: str = "") -> MRequest: ...
    @classmethod
...
class Z(Protocol):
    ...
    def m(self, n: int = 0) -> MResult: ...
    class MRequest(Protocol):
        n: int
        def send(self) -> Z.MResult: ...

    def m_request(self, n: int = 0) -> MRequest: ...
    @classmethod
